...
class IFD(java.util.HashMap[int, typing.Any]):
    ...
    @typing.overload
    def getIFDValue(self, int: int, class_: type) -> typing.Any: ...
    ...
    def getRowsPerStrip(self) -> typing.MutableSequence[int]: ...
    def getSamplesPerPixel(self) -> int: ...
    def getStripByteCounts(self) -> typing.MutableSequence[int]: ...
    def getStripOffsets(self) -> typing.MutableSequence[int]: ...
...
class IFDType(java.lang.Enum["IFDType"], loci.common.enumeration.CodedEnum):
    ...
    @typing.overload
    @staticmethod
    def valueOf(string: java.lang.String | str) -> IFDType: ...
    @staticmethod
    def values() -> typing.MutableSequence[IFDType]: ...
...
class OnDemandLongArray:
    ...
    def getStream(self) -> loci.common.RandomAccessInputStream: ...
...
class PhotoInterp(java.lang.Enum["PhotoInterp"], loci.common.enumeration.CodedEnum):
    ...
    @typing.overload
    @staticmethod
    def valueOf(string: java.lang.String | str) -> PhotoInterp: ...
    @staticmethod
    def values() -> typing.MutableSequence[PhotoInterp]: ...

class TiffCompression(
    java.lang.Enum["TiffCompression"], loci.common.enumeration.CodedEnum
):
    ...
    ZSTD: typing.ClassVar[TiffCompression] = ...
    def compress(
        self,
    ...
    @staticmethod
    def difference(byteArray: list[int] | jpype.JArray | bytes, iFD: IFD) -> None: ...
    @staticmethod
    ...
    @typing.overload
    def getCompressionCodecOptions(
        self, iFD: IFD
    ...
    @staticmethod
    def undifference(byteArray: list[int] | jpype.JArray | bytes, iFD: IFD) -> None: ...
    _valueOf_0__T = typing.TypeVar("_valueOf_0__T", bound=java.lang.Enum)  # <T>
    @typing.overload
    @staticmethod
    def valueOf(
    ...
    @typing.overload
    @staticmethod
    def valueOf(string: java.lang.String | str) -> TiffCompression: ...
    @staticmethod
    def values() -> typing.MutableSequence[TiffCompression]: ...
...
class TiffConstants:
    ...
    BIG_TIFF_CUTOFF: typing.ClassVar[int] = ...
...
class TiffParser(java.io.Closeable):
    ...
    def getColorMap(self, iFD: IFD) -> typing.MutableSequence[int]: ...
    def getComment(self) -> java.lang.String: ...
    ...
    def getIFDOffsets(self) -> typing.MutableSequence[int]: ...
    ...
    @typing.overload
    def getSamples(
        self, iFD: IFD, byteArray: list[int] | jpype.JArray | bytes
    ) -> typing.MutableSequence[int]: ...
    @typing.overload
    def getSamples(
        self,
    ...
    def getTile(
        self, iFD: IFD, byteArray: list[int] | jpype.JArray | bytes, int: int, int2: int
    ) -> typing.MutableSequence[int]: ...
    def isBigTiff(self) -> bool: ...
...
class TiffSaver(java.io.Closeable):
    ...
    def close(self) -> None: ...
    def getStream(self) -> loci.common.RandomAccessOutputStream: ...
    def isBigTiff(self) -> bool: ...
    def isLittleEndian(self) -> bool: ...
    def makeValidIFD(self, iFD: IFD, int: int, int2: int) -> None: ...
    def overwriteComment(
        self,
        randomAccessInputStream: loci.common.RandomAccessInputStream,
        object: typing.Any,
    ) -> None: ...
    def overwriteIFDOffset(
        self,
        randomAccessInputStream: loci.common.RandomAccessInputStream,
        long: int,
        long2: int,
    ...
    @typing.overload
    def writeIFD(self, iFD: IFD, long: int, boolean: bool) -> None: ...
    def writeIFDValue(
        self,
        randomAccessOutputStream: loci.common.RandomAccessOutputStream,
        long: int,
...
class __module_protocol__(Protocol):
    ...
    IFD: type[IFD]
    IFDList: type[IFDList]
    IFDType: type[IFDType]
    OnDemandLongArray: type[OnDemandLongArray]
    PhotoInterp: type[PhotoInterp]
    TiffCompression: type[TiffCompression]
    TiffConstants: type[TiffConstants]
    TiffIFDEntry: type[TiffIFDEntry]
    TiffParser: type[TiffParser]
    TiffRational: type[TiffRational]
    TiffSaver: type[TiffSaver]
