...
class EscherPropertyFactory:
    ...
    def createProperties(
        self, byteArray: list[int] | jpype.JArray | bytes, int: int, short: int
    ) -> java.util.List: ...
...
class EscherPropertyMetaData:
    ...
    @typing.overload
    def __init__(self, string: java.lang.String | str, byte: int): ...
...
class EscherRecord:
    ...
    def fillFields(
        ...
        byteArray: list[int] | jpype.JArray | bytes,
        int: int,
        escherRecordFactory: EscherRecordFactory | typing.Callable,
    ) -> int: ...
    ...
    def serialize(
        ...
        int: int,
        byteArray: list[int] | jpype.JArray | bytes,
        escherSerializationListener: EscherSerializationListener,
    ) -> int: ...
    @typing.overload
...
class EscherSerializationListener:
    def afterRecordSerialize(
        self, int: int, short: int, int2: int, escherRecord: EscherRecord
    ) -> None: ...
    def beforeRecordSerialize(
        self, int: int, short: int, escherRecord: EscherRecord
    ) -> None: ...
...
class EscherBSERecord(EscherRecord):
    ...
    def getRecordSize(self) -> int: ...
    def getRef(self) -> int: ...
    def getRemainingData(self) -> typing.MutableSequence[int]: ...
    def getSize(self) -> int: ...
    def getTag(self) -> int: ...
    def getUid(self) -> typing.MutableSequence[int]: ...
    ...
    def setRemainingData(self, byteArray: list[int] | jpype.JArray | bytes) -> None: ...
    def setSize(self, int: int) -> None: ...
    def setTag(self, short: int) -> None: ...
    def setUid(self, byteArray: list[int] | jpype.JArray | bytes) -> None: ...
...
class EscherBlipRecord(EscherRecord):
    ...
    def getPicturedata(self) -> typing.MutableSequence[int]: ...
    def getRecordName(self) -> java.lang.String: ...
    def getRecordSize(self) -> int: ...
    @typing.overload
    def serialize(self) -> typing.MutableSequence[int]: ...
    ...
    def setPictureData(self, byteArray: list[int] | jpype.JArray | bytes) -> None: ...
    def toString(self) -> java.lang.String: ...
...
class EscherComplexProperty(EscherProperty):
    @typing.overload
    def __init__(
        self, short: int, boolean: bool, byteArray: list[int] | jpype.JArray | bytes
    ): ...
    @typing.overload
    def __init__(self, short: int, byteArray: list[int] | jpype.JArray | bytes): ...
    def equals(self, object: typing.Any) -> bool: ...
    def getComplexData(self) -> typing.MutableSequence[int]: ...
    def getPropertySize(self) -> int: ...
...
class EscherDggRecord(EscherRecord):
    ...
    def getFileIdClusters(
        self,
    ) -> typing.MutableSequence[EscherDggRecord.FileIdCluster]: ...
    ...
    def setFileIdClusters(
        self, fileIdClusterArray: list[EscherDggRecord.FileIdCluster] | jpype.JArray
    ) -> None: ...
...
class EscherArrayProperty(EscherComplexProperty):
    ...
    def getElement(self, int: int) -> typing.MutableSequence[int]: ...
...
class EscherBlipWMFRecord(EscherBlipRecord):
    ...
    def getRecordName(self) -> java.lang.String: ...
    def getRecordSize(self) -> int: ...
    def getSecondaryUID(self) -> typing.MutableSequence[int]: ...
    ...
    def setSecondaryUID(self, byteArray: list[int] | jpype.JArray | bytes) -> None: ...
...
class __module_protocol__(Protocol):
    ...
    DefaultEscherRecordFactory: type[DefaultEscherRecordFactory]
    EscherArrayProperty: type[EscherArrayProperty]
    EscherBSERecord: type[EscherBSERecord]
    EscherBitmapBlip: type[EscherBitmapBlip]
    EscherBlipRecord: type[EscherBlipRecord]
    EscherBlipWMFRecord: type[EscherBlipWMFRecord]
    EscherBoolProperty: type[EscherBoolProperty]
    EscherChildAnchorRecord: type[EscherChildAnchorRecord]
    EscherClientAnchorRecord: type[EscherClientAnchorRecord]
    EscherClientDataRecord: type[EscherClientDataRecord]
    EscherComplexProperty: type[EscherComplexProperty]
    EscherContainerRecord: type[EscherContainerRecord]
    EscherDgRecord: type[EscherDgRecord]
    EscherDggRecord: type[EscherDggRecord]
    EscherDump: type[EscherDump]
    EscherMetafileBlip: type[EscherMetafileBlip]
    EscherOptRecord: type[EscherOptRecord]
    EscherPictBlip: type[EscherPictBlip]
    EscherProperties: type[EscherProperties]
    EscherProperty: type[EscherProperty]
    EscherPropertyFactory: type[EscherPropertyFactory]
    EscherPropertyMetaData: type[EscherPropertyMetaData]
    EscherRGBProperty: type[EscherRGBProperty]
    EscherRecord: type[EscherRecord]
    EscherRecordFactory: type[EscherRecordFactory]
    EscherSerializationListener: type[EscherSerializationListener]
    EscherShapePathProperty: type[EscherShapePathProperty]
    EscherSimpleProperty: type[EscherSimpleProperty]
    EscherSpRecord: type[EscherSpRecord]
    EscherSpgrRecord: type[EscherSpgrRecord]
    EscherSplitMenuColorsRecord: type[EscherSplitMenuColorsRecord]
    EscherTextboxRecord: type[EscherTextboxRecord]
    NullEscherSerializationListener: type[NullEscherSerializationListener]
    UnknownEscherRecord: type[UnknownEscherRecord]
