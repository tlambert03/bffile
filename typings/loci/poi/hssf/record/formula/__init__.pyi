...
class Ptg:
    ...
    @staticmethod
    def createParsedExpressionTokens(
        short: int, recordInputStream: loci.poi.hssf.record.RecordInputStream
    ) -> java.util.Stack: ...
    @staticmethod
    def createPtg(recordInputStream: loci.poi.hssf.record.RecordInputStream) -> Ptg: ...
    def getBytes(self) -> typing.MutableSequence[int]: ...
    def getDefaultOperandClass(self) -> int: ...
    def getPtgClass(self) -> int: ...
    def getSize(self) -> int: ...
    @staticmethod
    def serializePtgStack(
        stack: java.util.Stack, byteArray: list[int] | jpype.JArray | bytes, int: int
    ) -> int: ...
...
class Area3DPtg(Ptg):
    ...
    def __init__(self): ...
    @typing.overload
    def __init__(self, string: java.lang.String | str, short: int): ...
    @typing.overload
    def __init__(self, recordInputStream: loci.poi.hssf.record.RecordInputStream): ...
    def clone(self) -> typing.Any: ...
    ...
    def setArea(self, string: java.lang.String | str) -> None: ...
...
class ArrayPtg(Ptg):
    ...
    def getSize(self) -> int: ...
    def readTokenValues(
        self, recordInputStream: loci.poi.hssf.record.RecordInputStream
    ) -> None: ...
...
class NamePtg(Ptg):
    ...
    @typing.overload
    def __init__(
        self, string: java.lang.String | str, workbook: loci.poi.hssf.model.Workbook
    ): ...
    @typing.overload
    def __init__(self, recordInputStream: loci.poi.hssf.record.RecordInputStream): ...
    def clone(self) -> typing.Any: ...
...
class MultiplyPtg(OperationPtg):
    ...
    @typing.overload
    def toFormulaString(
        self, ptgArray: list[Ptg] | jpype.JArray
    ) -> java.lang.String: ...
    def writeBytes(
        self, byteArray: list[int] | jpype.JArray | bytes, int: int
    ) -> None: ...
...
class __module_protocol__(Protocol):
    ...
    AbstractFunctionPtg: type[AbstractFunctionPtg]
    AddPtg: type[AddPtg]
    Area3DPtg: type[Area3DPtg]
    AreaAPtg: type[AreaAPtg]
    AreaErrPtg: type[AreaErrPtg]
    AreaNAPtg: type[AreaNAPtg]
    AreaNPtg: type[AreaNPtg]
    AreaNVPtg: type[AreaNVPtg]
    AreaPtg: type[AreaPtg]
    AreaVPtg: type[AreaVPtg]
    ArrayPtg: type[ArrayPtg]
    ArrayPtgA: type[ArrayPtgA]
    ArrayPtgV: type[ArrayPtgV]
    AttrPtg: type[AttrPtg]
    BoolPtg: type[BoolPtg]
    ConcatPtg: type[ConcatPtg]
    ControlPtg: type[ControlPtg]
    DeletedArea3DPtg: type[DeletedArea3DPtg]
    DeletedRef3DPtg: type[DeletedRef3DPtg]
    DividePtg: type[DividePtg]
    EqualPtg: type[EqualPtg]
    ErrPtg: type[ErrPtg]
    ExpPtg: type[ExpPtg]
    FuncPtg: type[FuncPtg]
    FuncVarPtg: type[FuncVarPtg]
    GreaterEqualPtg: type[GreaterEqualPtg]
    GreaterThanPtg: type[GreaterThanPtg]
    IntPtg: type[IntPtg]
    IntersectionPtg: type[IntersectionPtg]
    LessEqualPtg: type[LessEqualPtg]
    LessThanPtg: type[LessThanPtg]
    MemAreaPtg: type[MemAreaPtg]
    MemErrPtg: type[MemErrPtg]
    MemFuncPtg: type[MemFuncPtg]
    MissingArgPtg: type[MissingArgPtg]
    MultiplyPtg: type[MultiplyPtg]
    NamePtg: type[NamePtg]
    NameXPtg: type[NameXPtg]
    NotEqualPtg: type[NotEqualPtg]
    NumberPtg: type[NumberPtg]
    OperationPtg: type[OperationPtg]
    ParenthesisPtg: type[ParenthesisPtg]
    PercentPtg: type[PercentPtg]
    PowerPtg: type[PowerPtg]
    Ptg: type[Ptg]
    RangePtg: type[RangePtg]
    Ref3DPtg: type[Ref3DPtg]
    RefAPtg: type[RefAPtg]
    RefErrorPtg: type[RefErrorPtg]
    RefNAPtg: type[RefNAPtg]
    RefNPtg: type[RefNPtg]
    RefNVPtg: type[RefNVPtg]
    RefVPtg: type[RefVPtg]
    ReferencePtg: type[ReferencePtg]
    StringPtg: type[StringPtg]
    SubtractPtg: type[SubtractPtg]
    UnaryMinusPtg: type[UnaryMinusPtg]
    UnaryPlusPtg: type[UnaryPlusPtg]
    UnionPtg: type[UnionPtg]
    UnknownPtg: type[UnknownPtg]
