...
import loci.poi.hssf.record.aggregates
...
class Record:
    ...
    @typing.overload
    def serialize(self) -> typing.MutableSequence[int]: ...
...
class RecordInputStream(java.io.InputStream):
    ...
    def getNANData(self) -> typing.MutableSequence[int]: ...
    def getPos(self) -> int: ...
    ...
    @typing.overload
    def read(self) -> int: ...
    def readAllContinuedRemainder(self) -> typing.MutableSequence[int]: ...
    def readByte(self) -> int: ...
    def readCompressedUnicode(self, int: int) -> java.lang.String: ...
    def readDouble(self) -> float: ...
    def readInt(self) -> int: ...
    def readLong(self) -> int: ...
    def readRemainder(self) -> typing.MutableSequence[int]: ...
    def readShort(self) -> int: ...
    def readShortArray(self) -> typing.MutableSequence[int]: ...
...
class UnicodeString(java.lang.Comparable):
    ...
    def serialize(
        self,
        unicodeRecordStats: UnicodeString.UnicodeRecordStats,
        int: int,
        byteArray: list[int] | jpype.JArray | bytes,
    ) -> int: ...
    def setCharCount(self, short: int) -> None: ...
    def setCompressedUnicode(self) -> None: ...
    def setExtendedRst(self, byteArray: list[int] | jpype.JArray | bytes) -> None: ...
...
class AbstractEscherHolderRecord(Record):
    ...
    def __init__(self, recordInputStream: RecordInputStream): ...
    @typing.overload
    def addEscherRecord(self, escherRecord: loci.poi.ddf.EscherRecord) -> bool: ...
    @typing.overload
    def addEscherRecord(
        self, int: int, escherRecord: loci.poi.ddf.EscherRecord
    ) -> None: ...
    def clearEscherRecords(self) -> None: ...
    def clone(self) -> typing.Any: ...
    def decode(self) -> None: ...
    def getEscherRecord(self, int: int) -> loci.poi.ddf.EscherRecord: ...
    def getEscherRecords(self) -> java.util.List: ...
    def getRawData(self) -> typing.MutableSequence[int]: ...
    def getRecordSize(self) -> int: ...
    def getSid(self) -> int: ...
    ...
    def setRawData(self, byteArray: list[int] | jpype.JArray | bytes) -> None: ...
    def toString(self) -> java.lang.String: ...
...
class BoundSheetRecord(Record):
    ...
    def setSheetname(self, string: java.lang.String | str) -> None: ...
...
class FileSharingRecord(Record):
    ...
    @staticmethod
    def hashPassword(string: java.lang.String | str) -> int: ...
    @typing.overload
    def serialize(self) -> typing.MutableSequence[int]: ...
    @typing.overload
    def serialize(
...
class FontRecord(Record):
    ...
    def setFontName(self, string: java.lang.String | str) -> None: ...
...
class FooterRecord(Record):
    ...
    def setFooter(self, string: java.lang.String | str) -> None: ...
...
class FormatRecord(Record):
    ...
    def setFormatString(self, string: java.lang.String | str) -> None: ...
...
class FormulaRecord(Record, CellValueRecordInterface, java.lang.Comparable):
    ...
    def isValue(self) -> bool: ...
    def peekExpressionToken(self) -> loci.poi.hssf.record.formula.Ptg: ...
    def popExpressionToken(self) -> loci.poi.hssf.record.formula.Ptg: ...
    def pushExpressionToken(self, ptg: loci.poi.hssf.record.formula.Ptg) -> None: ...
    @typing.overload
    def serialize(self) -> typing.MutableSequence[int]: ...
    @typing.overload
    def serialize(
...
class HeaderRecord(Record):
    ...
    def setHeader(self, string: java.lang.String | str) -> None: ...
...
class IndexRecord(Record):
    ...
    field_4_zero: int = ...
    field_5_dbcells: loci.poi.util.IntList = ...
    @typing.overload
    def __init__(self): ...
    @typing.overload
    def __init__(self, recordInputStream: RecordInputStream): ...
...
class LinkedDataRecord(Record):
    ...
    def setFormulaOfLink(
        self, linkedDataFormulaField: LinkedDataFormulaField
    ) -> None: ...
...
class NameRecord(Record):
    ...
    @typing.overload
    def __init__(self, recordInputStream: RecordInputStream): ...
    def getAreaReference(
        self, workbook: loci.poi.hssf.model.Workbook
    ) -> java.lang.String: ...
    ...
    def setAreaReference(self, string: java.lang.String | str) -> None: ...
    def setCompressedUnicodeFlag(self, byte: int) -> None: ...
    def setCustomMenuLength(self, byte: int) -> None: ...
    def setCustomMenuText(self, string: java.lang.String | str) -> None: ...
    def setDefinitionTextLength(self, short: int) -> None: ...
    def setDescriptionText(self, string: java.lang.String | str) -> None: ...
...
class PageBreakRecord(Record):
    ...
    class Break:
        ...
        subTo: int = ...
        def __init__(
            self, pageBreakRecord: PageBreakRecord, short: int, short2: int, short3: int
        ): ...
...
class PaletteRecord(Record):
    ...
    @typing.overload
    def __init__(self, recordInputStream: RecordInputStream): ...
    def getColor(self, short: int) -> typing.MutableSequence[int]: ...
    def getRecordSize(self) -> int: ...
    def getSid(self) -> int: ...
    @typing.overload
    def serialize(self) -> typing.MutableSequence[int]: ...
...
class RecalcIdRecord(Record):
    sid: typing.ClassVar[int] = ...
    field_1_recalcids: typing.MutableSequence[int] = ...
    @typing.overload
    def __init__(self): ...
    @typing.overload
    def __init__(self, recordInputStream: RecordInputStream): ...
    def getRecalcIdArray(self) -> typing.MutableSequence[int]: ...
    def getRecordSize(self) -> int: ...
    def getSid(self) -> int: ...
    ...
    def setRecalcIdArray(self, shortArray: list[int] | jpype.JArray) -> None: ...
    def toString(self) -> java.lang.String: ...
...
class SeriesListRecord(Record):
    ...
    def clone(self) -> typing.Any: ...
    def getRecordSize(self) -> int: ...
    def getSeriesNumbers(self) -> typing.MutableSequence[int]: ...
    def getSid(self) -> int: ...
    @typing.overload
    def serialize(self) -> typing.MutableSequence[int]: ...
    @typing.overload
    ...
    def setSeriesNumbers(self, shortArray: list[int] | jpype.JArray) -> None: ...
    def toString(self) -> java.lang.String: ...
...
class TabIdRecord(Record):
    sid: typing.ClassVar[int] = ...
    field_1_tabids: typing.MutableSequence[int] = ...
    @typing.overload
    def __init__(self): ...
    @typing.overload
    def __init__(self, recordInputStream: RecordInputStream): ...
    def getRecordSize(self) -> int: ...
    def getSid(self) -> int: ...
    def getTabIdArray(self) -> typing.MutableSequence[int]: ...
    @typing.overload
    def serialize(self) -> typing.MutableSequence[int]: ...
    @typing.overload
    def serialize(
    ...
    def setTabIdArray(self, shortArray: list[int] | jpype.JArray) -> None: ...
    def toString(self) -> java.lang.String: ...
...
class UnknownRecord(Record):
    ...
    def __init__(self, recordInputStream: RecordInputStream): ...
    @typing.overload
    def __init__(self, short: int, byteArray: list[int] | jpype.JArray | bytes): ...
    def clone(self) -> typing.Any: ...
    def getRecordSize(self) -> int: ...
    def getSid(self) -> int: ...
    @typing.overload
...
class EmbeddedObjectRefSubRecord(SubRecord):
    ...
    field_2_unknown: typing.MutableSequence[int] = ...
...
class EscherAggregate(AbstractEscherHolderRecord):
    ...
    def __init__(self, drawingManager2: loci.poi.hssf.model.DrawingManager2): ...
    def assoicateShapeToObjRecord(
        self, escherRecord: loci.poi.ddf.EscherRecord, record: Record
    ) -> typing.Any: ...
    def clear(self) -> None: ...
    @staticmethod
    def createAggregate(
        list: java.util.List,
        int: int,
        drawingManager2: loci.poi.hssf.model.DrawingManager2,
    ) -> EscherAggregate: ...
    def getPatriarch(self) -> loci.poi.hssf.usermodel.HSSFPatriarch: ...
    def getRecordSize(self) -> int: ...
    def getSid(self) -> int: ...
    @typing.overload
    def serialize(self) -> typing.MutableSequence[int]: ...
    ...
    def setPatriarch(
        self, hSSFPatriarch: loci.poi.hssf.usermodel.HSSFPatriarch
    ) -> None: ...
    def toString(self) -> java.lang.String: ...
...
class TextObjectRecord(TextObjectBaseRecord):
    ...
    def __init__(self, recordInputStream: RecordInputStream): ...
    def getRecordSize(self) -> int: ...
    def getStr(self) -> loci.poi.hssf.usermodel.HSSFRichTextString: ...
    @typing.overload
    def serialize(self) -> typing.MutableSequence[int]: ...
    @typing.overload
    def serialize(
    ...
    def setStr(
        self, hSSFRichTextString: loci.poi.hssf.usermodel.HSSFRichTextString
    ) -> None: ...
    def toString(self) -> java.lang.String: ...
...
class __module_protocol__(Protocol):
    ...
    AbstractEscherHolderRecord: type[AbstractEscherHolderRecord]
    AreaFormatRecord: type[AreaFormatRecord]
    AreaRecord: type[AreaRecord]
    AxisLineFormatRecord: type[AxisLineFormatRecord]
    AxisOptionsRecord: type[AxisOptionsRecord]
    AxisParentRecord: type[AxisParentRecord]
    AxisRecord: type[AxisRecord]
    AxisUsedRecord: type[AxisUsedRecord]
    BOFRecord: type[BOFRecord]
    BackupRecord: type[BackupRecord]
    BarRecord: type[BarRecord]
    BeginRecord: type[BeginRecord]
    BlankRecord: type[BlankRecord]
    BookBoolRecord: type[BookBoolRecord]
    BoolErrRecord: type[BoolErrRecord]
    BottomMarginRecord: type[BottomMarginRecord]
    BoundSheetRecord: type[BoundSheetRecord]
    CalcCountRecord: type[CalcCountRecord]
    CalcModeRecord: type[CalcModeRecord]
    CategorySeriesAxisRecord: type[CategorySeriesAxisRecord]
    CellValueRecordInterface: type[CellValueRecordInterface]
    ChartFormatRecord: type[ChartFormatRecord]
    ChartRecord: type[ChartRecord]
    CodepageRecord: type[CodepageRecord]
    ColumnInfoRecord: type[ColumnInfoRecord]
    CommonObjectDataSubRecord: type[CommonObjectDataSubRecord]
    ContinueRecord: type[ContinueRecord]
    CountryRecord: type[CountryRecord]
    CustomField: type[CustomField]
    DBCellRecord: type[DBCellRecord]
    DSFRecord: type[DSFRecord]
    DatRecord: type[DatRecord]
    DataFormatRecord: type[DataFormatRecord]
    DateWindow1904Record: type[DateWindow1904Record]
    DefaultColWidthRecord: type[DefaultColWidthRecord]
    DefaultDataLabelTextPropertiesRecord: type[DefaultDataLabelTextPropertiesRecord]
    DefaultRowHeightRecord: type[DefaultRowHeightRecord]
    DeltaRecord: type[DeltaRecord]
    DimensionsRecord: type[DimensionsRecord]
    DrawingGroupRecord: type[DrawingGroupRecord]
    DrawingRecord: type[DrawingRecord]
    DrawingRecordForBiffViewer: type[DrawingRecordForBiffViewer]
    DrawingSelectionRecord: type[DrawingSelectionRecord]
    EOFRecord: type[EOFRecord]
    EmbeddedObjectRefSubRecord: type[EmbeddedObjectRefSubRecord]
    EndRecord: type[EndRecord]
    EndSubRecord: type[EndSubRecord]
    EscherAggregate: type[EscherAggregate]
    ExtSSTInfoSubRecord: type[ExtSSTInfoSubRecord]
    ExtSSTRecord: type[ExtSSTRecord]
    ExtendedFormatRecord: type[ExtendedFormatRecord]
    ExternSheetRecord: type[ExternSheetRecord]
    ExternSheetSubRecord: type[ExternSheetSubRecord]
    FilePassRecord: type[FilePassRecord]
    FileSharingRecord: type[FileSharingRecord]
    FnGroupCountRecord: type[FnGroupCountRecord]
    FontBasisRecord: type[FontBasisRecord]
    FontIndexRecord: type[FontIndexRecord]
    FontRecord: type[FontRecord]
    FooterRecord: type[FooterRecord]
    FormatRecord: type[FormatRecord]
    FormulaRecord: type[FormulaRecord]
    FrameRecord: type[FrameRecord]
    GridsetRecord: type[GridsetRecord]
    GroupMarkerSubRecord: type[GroupMarkerSubRecord]
    GutsRecord: type[GutsRecord]
    HCenterRecord: type[HCenterRecord]
    HeaderRecord: type[HeaderRecord]
    HideObjRecord: type[HideObjRecord]
    HorizontalPageBreakRecord: type[HorizontalPageBreakRecord]
    IndexRecord: type[IndexRecord]
    InterfaceEndRecord: type[InterfaceEndRecord]
    InterfaceHdrRecord: type[InterfaceHdrRecord]
    IterationRecord: type[IterationRecord]
    LabelRecord: type[LabelRecord]
    LabelSSTRecord: type[LabelSSTRecord]
    LeftMarginRecord: type[LeftMarginRecord]
    LegendRecord: type[LegendRecord]
    LineFormatRecord: type[LineFormatRecord]
    LinkedDataFormulaField: type[LinkedDataFormulaField]
    LinkedDataRecord: type[LinkedDataRecord]
    MMSRecord: type[MMSRecord]
    Margin: type[Margin]
    MergeCellsRecord: type[MergeCellsRecord]
    MulBlankRecord: type[MulBlankRecord]
    MulRKRecord: type[MulRKRecord]
    NameRecord: type[NameRecord]
    NoteRecord: type[NoteRecord]
    NoteStructureSubRecord: type[NoteStructureSubRecord]
    NumberFormatIndexRecord: type[NumberFormatIndexRecord]
    NumberRecord: type[NumberRecord]
    ObjRecord: type[ObjRecord]
    ObjectLinkRecord: type[ObjectLinkRecord]
    ObjectProtectRecord: type[ObjectProtectRecord]
    PageBreakRecord: type[PageBreakRecord]
    PaletteRecord: type[PaletteRecord]
    PaneRecord: type[PaneRecord]
    PasswordRecord: type[PasswordRecord]
    PasswordRev4Record: type[PasswordRev4Record]
    PlotAreaRecord: type[PlotAreaRecord]
    PlotGrowthRecord: type[PlotGrowthRecord]
    PrecisionRecord: type[PrecisionRecord]
    PrintGridlinesRecord: type[PrintGridlinesRecord]
    PrintHeadersRecord: type[PrintHeadersRecord]
    PrintSetupRecord: type[PrintSetupRecord]
    ProtectRecord: type[ProtectRecord]
    ProtectionRev4Record: type[ProtectionRev4Record]
    RKRecord: type[RKRecord]
    RecalcIdRecord: type[RecalcIdRecord]
    Record: type[Record]
    RecordFactory: type[RecordFactory]
    RecordFormatException: type[RecordFormatException]
    RecordInputStream: type[RecordInputStream]
    RefModeRecord: type[RefModeRecord]
    RefreshAllRecord: type[RefreshAllRecord]
    RightMarginRecord: type[RightMarginRecord]
    RowRecord: type[RowRecord]
    SCLRecord: type[SCLRecord]
    SSTRecord: type[SSTRecord]
    SaveRecalcRecord: type[SaveRecalcRecord]
    ScenarioProtectRecord: type[ScenarioProtectRecord]
    SelectionRecord: type[SelectionRecord]
    SeriesChartGroupIndexRecord: type[SeriesChartGroupIndexRecord]
    SeriesIndexRecord: type[SeriesIndexRecord]
    SeriesLabelsRecord: type[SeriesLabelsRecord]
    SeriesListRecord: type[SeriesListRecord]
    SeriesRecord: type[SeriesRecord]
    SeriesTextRecord: type[SeriesTextRecord]
    SeriesToChartGroupRecord: type[SeriesToChartGroupRecord]
    SharedFormulaRecord: type[SharedFormulaRecord]
    SheetPropertiesRecord: type[SheetPropertiesRecord]
    StringRecord: type[StringRecord]
    StyleRecord: type[StyleRecord]
    SubRecord: type[SubRecord]
    SupBookRecord: type[SupBookRecord]
    TabIdRecord: type[TabIdRecord]
    TextObjectBaseRecord: type[TextObjectBaseRecord]
    TextObjectRecord: type[TextObjectRecord]
    TextRecord: type[TextRecord]
    TickRecord: type[TickRecord]
    TopMarginRecord: type[TopMarginRecord]
    UnicodeString: type[UnicodeString]
    UnitsRecord: type[UnitsRecord]
    UnknownRecord: type[UnknownRecord]
    UseSelFSRecord: type[UseSelFSRecord]
    VCenterRecord: type[VCenterRecord]
    ValueRangeRecord: type[ValueRangeRecord]
    VerticalPageBreakRecord: type[VerticalPageBreakRecord]
    WSBoolRecord: type[WSBoolRecord]
    WindowOneRecord: type[WindowOneRecord]
    WindowProtectRecord: type[WindowProtectRecord]
    WindowTwoRecord: type[WindowTwoRecord]
    WriteAccessRecord: type[WriteAccessRecord]
    WriteProtectRecord: type[WriteProtectRecord]
    aggregates: loci.poi.hssf.record.aggregates.__module_protocol__
    formula: loci.poi.hssf.record.formula.__module_protocol__
