...
class ColumnInfoRecordsAggregate(loci.poi.hssf.record.Record):
    ...
    @staticmethod
    def createColInfo() -> loci.poi.hssf.record.Record: ...
    ...
    def getColInfo(self, int: int) -> loci.poi.hssf.record.ColumnInfoRecord: ...
    ...
    @typing.overload
    def insertColumn(
        self, int: int, columnInfoRecord: loci.poi.hssf.record.ColumnInfoRecord
    ) -> None: ...
    @typing.overload
    def insertColumn(
        self, columnInfoRecord: loci.poi.hssf.record.ColumnInfoRecord
    ) -> None: ...
    ...
    def writeHidden(
        self,
        columnInfoRecord: loci.poi.hssf.record.ColumnInfoRecord,
        int: int,
        boolean: bool,
...
class FormulaRecordAggregate(
    ...
    def __init__(
        self,
        formulaRecord: loci.poi.hssf.record.FormulaRecord,
        stringRecord: loci.poi.hssf.record.StringRecord,
    ): ...
    def clone(self) -> typing.Any: ...
    def compareTo(self, object: typing.Any) -> int: ...
    def equals(self, object: typing.Any) -> bool: ...
    def getColumn(self) -> int: ...
    def getFormulaRecord(self) -> loci.poi.hssf.record.FormulaRecord: ...
    def getRecordSize(self) -> int: ...
    def getRow(self) -> int: ...
    def getSid(self) -> int: ...
    def getStringRecord(self) -> loci.poi.hssf.record.StringRecord: ...
...
class RowRecordsAggregate(loci.poi.hssf.record.Record):
    ...
    @staticmethod
    def createRow(int: int) -> loci.poi.hssf.record.RowRecord: ...
    ...
    def insertRow(self, rowRecord: loci.poi.hssf.record.RowRecord) -> None: ...
    ...
    def writeHidden(
        self, rowRecord: loci.poi.hssf.record.RowRecord, int: int, boolean: bool
    ) -> int: ...
...
class ValueRecordsAggregate(loci.poi.hssf.record.Record):
    ...
    class MyIterator(java.util.Iterator):
        ...
        @typing.overload
        def __init__(
            self, valueRecordsAggregate: ValueRecordsAggregate, int: int, int2: int
        ): ...
...
class __module_protocol__(Protocol):
    ...
    ColumnInfoRecordsAggregate: type[ColumnInfoRecordsAggregate]
    FormulaRecordAggregate: type[FormulaRecordAggregate]
    RowRecordsAggregate: type[RowRecordsAggregate]
    ValueRecordsAggregate: type[ValueRecordsAggregate]
