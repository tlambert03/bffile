...
class DummyGraphics2d(java.awt.Graphics2D):
    def __init__(self): ...
    def addRenderingHints(self, map: java.util.Map | typing.Mapping) -> None: ...
    ...
    def hit(
        self, rectangle: java.awt.Rectangle, shape: java.awt.Shape, boolean: bool
    ) -> bool: ...
    ...
    def setComposite(self, composite: java.awt.Composite | typing.Callable) -> None: ...
    ...
    def setRenderingHint(
        self, key: java.awt.RenderingHints.Key, object: typing.Any
    ) -> None: ...
    def setRenderingHints(self, map: java.util.Map | typing.Mapping) -> None: ...
    def setStroke(self, stroke: java.awt.Stroke | typing.Callable) -> None: ...
...
class FontDetails:
    ...
    def addChars(
        self, charArray: list[str] | jpype.JArray, intArray: list[int] | jpype.JArray
    ) -> None: ...
    @staticmethod
    def create(
    ...
    def getStringWidth(self, string: java.lang.String | str) -> int: ...
...
class HSSFCell:
    ...
    def setCellFormula(self, string: java.lang.String | str) -> None: ...
    ...
    @typing.overload
    def setCellValue(self, string: java.lang.String | str) -> None: ...
    @typing.overload
...
class HSSFDataFormat:
    def __init__(self, workbook: loci.poi.hssf.model.Workbook): ...
    @typing.overload
    @staticmethod
    def getBuiltinFormat(short: int) -> java.lang.String: ...
    @typing.overload
    @staticmethod
    def getBuiltinFormat(string: java.lang.String | str) -> int: ...
    @staticmethod
    def getBuiltinFormats() -> java.util.List: ...
    @typing.overload
    def getFormat(self, short: int) -> java.lang.String: ...
    @typing.overload
    def getFormat(self, string: java.lang.String | str) -> int: ...
    @staticmethod
...
class HSSFDateUtil:
    ...
    @staticmethod
    def isADateFormat(int: int, string: java.lang.String | str) -> bool: ...
    @staticmethod
...
class HSSFFooter:
    ...
    def setCenter(self, string: java.lang.String | str) -> None: ...
    def setLeft(self, string: java.lang.String | str) -> None: ...
    def setRight(self, string: java.lang.String | str) -> None: ...
    @staticmethod
...
class HSSFName:
    ...
    def setNameName(self, string: java.lang.String | str) -> None: ...
    def setReference(self, string: java.lang.String | str) -> None: ...

class HSSFObjectData:
    def __init__(
        self,
        objRecord: loci.poi.hssf.record.ObjRecord,
        pOIFSFileSystem: loci.poi.poifs.filesystem.POIFSFileSystem,
    ): ...
    def getDirectory(self) -> loci.poi.poifs.filesystem.DirectoryEntry: ...

class HSSFPalette:
    def addColor(
        self, byte: int, byte2: int, byte3: int
    ) -> loci.poi.hssf.util.HSSFColor: ...
    def findColor(
        self, byte: int, byte2: int, byte3: int
    ) -> loci.poi.hssf.util.HSSFColor: ...
    def findSimilarColor(
        self, byte: int, byte2: int, byte3: int
    ) -> loci.poi.hssf.util.HSSFColor: ...
    def getColor(self, short: int) -> loci.poi.hssf.util.HSSFColor: ...
    def setColorAtIndex(
        self, short: int, byte: int, byte2: int, byte3: int
    ) -> None: ...
...
class HSSFSheet:
    ...
    INITIAL_CAPACITY: typing.ClassVar[int] = ...
    def addMergedRegion(self, region: loci.poi.hssf.util.Region) -> int: ...
    ...
    def getColumnBreaks(self) -> typing.MutableSequence[int]: ...
    ...
    def getMergedRegionAt(self, int: int) -> loci.poi.hssf.util.Region: ...
    ...
    def getRowBreaks(self) -> typing.MutableSequence[int]: ...
    ...
    def protectSheet(self, string: java.lang.String | str) -> None: ...
    ...
    def setDefaultColumnStyle(
        self, short: int, hSSFCellStyle: HSSFCellStyle
    ) -> None: ...
    ...
    @typing.overload
    def shiftRows(
        self, int: int, int2: int, int3: int, boolean: bool, boolean2: bool
    ) -> None: ...
...
class HSSFWorkbook(loci.poi.POIDocument):
    ...
    @typing.overload
    def __init__(
        self, pOIFSFileSystem: loci.poi.poifs.filesystem.POIFSFileSystem, boolean: bool
    ): ...
    def addPicture(
        self, byteArray: list[int] | jpype.JArray | bytes, int: int
    ) -> int: ...
    def addSSTString(self, string: java.lang.String | str) -> int: ...
    ...
    @typing.overload
    def createSheet(self, string: java.lang.String | str) -> HSSFSheet: ...
    ...
    def getNameIndex(self, string: java.lang.String | str) -> int: ...
    ...
    def getSheet(self, string: java.lang.String | str) -> HSSFSheet: ...
    ...
    @typing.overload
    def removeName(self, string: java.lang.String | str) -> None: ...
    ...
    @typing.overload
    def setPrintArea(self, int: int, string: java.lang.String | str) -> None: ...
    def setRepeatingRowsAndColumns(
        self, int: int, int2: int, int3: int, int4: int, int5: int
    ) -> None: ...
...
class HSSFPatriarch(HSSFShapeContainer):
    ...
    def createPicture(
        self, hSSFClientAnchor: HSSFClientAnchor, int: int
    ) -> HSSFPicture: ...
...
class HSSFPolygon(HSSFShape):
    ...
    def getXPoints(self) -> typing.MutableSequence[int]: ...
    def getYPoints(self) -> typing.MutableSequence[int]: ...
    def setPoints(
...
class HSSFShapeGroup(HSSFShape, HSSFShapeContainer):
    ...
    def createPicture(
        self, hSSFChildAnchor: HSSFChildAnchor, int: int
    ) -> HSSFPicture: ...
...
class __module_protocol__(Protocol):
    ...
    DummyGraphics2d: type[DummyGraphics2d]
    EscherGraphics: type[EscherGraphics]
    EscherGraphics2d: type[EscherGraphics2d]
    FontDetails: type[FontDetails]
    HSSFAnchor: type[HSSFAnchor]
    HSSFCell: type[HSSFCell]
    HSSFCellStyle: type[HSSFCellStyle]
    HSSFChildAnchor: type[HSSFChildAnchor]
    HSSFClientAnchor: type[HSSFClientAnchor]
    HSSFComment: type[HSSFComment]
    HSSFDataFormat: type[HSSFDataFormat]
    HSSFDateUtil: type[HSSFDateUtil]
    HSSFErrorConstants: type[HSSFErrorConstants]
    HSSFFont: type[HSSFFont]
    HSSFFooter: type[HSSFFooter]
    HSSFHeader: type[HSSFHeader]
    HSSFName: type[HSSFName]
    HSSFObjectData: type[HSSFObjectData]
    HSSFPalette: type[HSSFPalette]
    HSSFPatriarch: type[HSSFPatriarch]
    HSSFPicture: type[HSSFPicture]
    HSSFPictureData: type[HSSFPictureData]
    HSSFPolygon: type[HSSFPolygon]
    HSSFPrintSetup: type[HSSFPrintSetup]
    HSSFRichTextString: type[HSSFRichTextString]
    HSSFRow: type[HSSFRow]
    HSSFShape: type[HSSFShape]
    HSSFShapeContainer: type[HSSFShapeContainer]
    HSSFShapeGroup: type[HSSFShapeGroup]
    HSSFSheet: type[HSSFSheet]
    HSSFSimpleShape: type[HSSFSimpleShape]
    HSSFTextbox: type[HSSFTextbox]
    HSSFWorkbook: type[HSSFWorkbook]
