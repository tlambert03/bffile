...
class BigDecimal(java.lang.Number, java.lang.Comparable["BigDecimal"], _JBigDecimal):
    ...
    @typing.overload
    def __init__(
        self, charArray: list[str] | jpype.JArray, mathContext: MathContext
    ): ...
    @typing.overload
    ...
    @typing.overload
    def __init__(self, string: java.lang.String | str, mathContext: MathContext): ...
    @typing.overload
    ...
    @typing.overload
    def add(self, bigDecimal: BigDecimal | decimal.Decimal) -> BigDecimal: ...
    @typing.overload
    def add(
        self, bigDecimal: BigDecimal | decimal.Decimal, mathContext: MathContext
    ) -> BigDecimal: ...
    def byteValueExact(self) -> int: ...
    def compareTo(self, bigDecimal: BigDecimal | decimal.Decimal) -> int: ...
    @typing.overload
    def divide(self, bigDecimal: BigDecimal | decimal.Decimal) -> BigDecimal: ...
    @typing.overload
    def divide(
        self, bigDecimal: BigDecimal | decimal.Decimal, int: int
    ) -> BigDecimal: ...
    @typing.overload
    def divide(
        self, bigDecimal: BigDecimal | decimal.Decimal, int: int, int2: int
    ) -> BigDecimal: ...
    @typing.overload
    def divide(
        self,
    ...
    @typing.overload
    def divide(
        self, bigDecimal: BigDecimal | decimal.Decimal, roundingMode: RoundingMode
    ) -> BigDecimal: ...
    @typing.overload
    def divideAndRemainder(
        self, bigDecimal: BigDecimal | decimal.Decimal
    ) -> typing.MutableSequence[BigDecimal]: ...
    @typing.overload
    def divideAndRemainder(
        self, bigDecimal: BigDecimal | decimal.Decimal, mathContext: MathContext
    ) -> typing.MutableSequence[BigDecimal]: ...
    ...
    def max(self, bigDecimal: BigDecimal | decimal.Decimal) -> BigDecimal: ...
    def min(self, bigDecimal: BigDecimal | decimal.Decimal) -> BigDecimal: ...
    def movePointLeft(self, int: int) -> BigDecimal: ...
    def movePointRight(self, int: int) -> BigDecimal: ...
    @typing.overload
    def multiply(self, bigDecimal: BigDecimal | decimal.Decimal) -> BigDecimal: ...
    @typing.overload
    def multiply(
        self, bigDecimal: BigDecimal | decimal.Decimal, mathContext: MathContext
    ) -> BigDecimal: ...
    ...
    @typing.overload
    def remainder(self, bigDecimal: BigDecimal | decimal.Decimal) -> BigDecimal: ...
    @typing.overload
    def remainder(
        self, bigDecimal: BigDecimal | decimal.Decimal, mathContext: MathContext
    ) -> BigDecimal: ...
    ...
    @typing.overload
    def subtract(self, bigDecimal: BigDecimal | decimal.Decimal) -> BigDecimal: ...
    @typing.overload
    def subtract(
        self, bigDecimal: BigDecimal | decimal.Decimal, mathContext: MathContext
    ) -> BigDecimal: ...
...
class BigInteger(java.lang.Number, java.lang.Comparable["BigInteger"]):
    ...
    ) -> typing.MutableSequence[BigInteger]: ...
    def doubleValue(self) -> float: ...
    def equals(self, object: typing.Any) -> bool: ...
...
class RoundingMode(java.lang.Enum["RoundingMode"]):
    ...
    @typing.overload
    @staticmethod
    def valueOf(string: java.lang.String | str) -> RoundingMode: ...
    @staticmethod
