...
class DateTimeFormatter:
    ...
    @typing.overload
    @staticmethod
    def ofLocalizedDateTime(
        formatStyle: FormatStyle, formatStyle2: FormatStyle
    ) -> DateTimeFormatter: ...
    @staticmethod
    def ofLocalizedPattern(string: java.lang.String | str) -> DateTimeFormatter: ...
    @staticmethod
    def ofLocalizedTime(formatStyle: FormatStyle) -> DateTimeFormatter: ...
    @typing.overload
    @staticmethod
    def ofPattern(string: java.lang.String | str) -> DateTimeFormatter: ...
    @typing.overload
    @staticmethod
    def ofPattern(
        string: java.lang.String | str, locale: java.util.Locale
    ) -> DateTimeFormatter: ...
    ...
    def parse(
        ...
        temporalQuery: java.time.temporal.TemporalQuery[_parse_0__T]
        | typing.Callable[[java.time.temporal.TemporalAccessor], _parse_0__T],
    ) -> _parse_0__T: ...
    @typing.overload
    def parse(
    ...
    def parseBest(
        self,
        charSequence: java.lang.CharSequence | str,
        *temporalQuery: java.time.temporal.TemporalQuery[typing.Any]
        | typing.Callable[[java.time.temporal.TemporalAccessor], typing.Any],
    ) -> java.time.temporal.TemporalAccessor: ...
    def parseUnresolved(
        self,
        charSequence: java.lang.CharSequence | str,
    ...
    def withChronology(
        self, chronology: java.time.chrono.Chronology
    ) -> DateTimeFormatter: ...
    ...
    @typing.overload
    def withResolverFields(
        self, *temporalField: java.time.temporal.TemporalField
    ) -> DateTimeFormatter: ...
    @typing.overload
    def withResolverFields(
        self, set: java.util.Set[java.time.temporal.TemporalField]
    ) -> DateTimeFormatter: ...
...
class DateTimeFormatterBuilder:
    ...
    @typing.overload
    def appendGenericZoneText(
        self, textStyle: TextStyle
    ) -> DateTimeFormatterBuilder: ...
    @typing.overload
    def appendGenericZoneText(
        self, textStyle: TextStyle, set: java.util.Set[java.time.ZoneId]
    ) -> DateTimeFormatterBuilder: ...
    @typing.overload
    ...
    @typing.overload
    def appendLocalized(
        self, formatStyle: FormatStyle, formatStyle2: FormatStyle
    ) -> DateTimeFormatterBuilder: ...
    def appendLocalizedOffset(
        self, textStyle: TextStyle
    ) -> DateTimeFormatterBuilder: ...
    def appendOffset(
    ...
    @typing.overload
    def appendText(
        self, temporalField: java.time.temporal.TemporalField, textStyle: TextStyle
    ) -> DateTimeFormatterBuilder: ...
    @typing.overload
    def appendText(
        self,
        temporalField: java.time.temporal.TemporalField,
        map: java.util.Map[int, java.lang.String | str]
        | typing.Mapping[int, java.lang.String | str],
    ) -> DateTimeFormatterBuilder: ...
    @typing.overload
    def appendValue(
        self, temporalField: java.time.temporal.TemporalField
    ...
    @typing.overload
    def appendValue(
        self, temporalField: java.time.temporal.TemporalField, int: int
    ) -> DateTimeFormatterBuilder: ...
    @typing.overload
    def appendValue(
        self,
    ...
    @typing.overload
    @staticmethod
    def getLocalizedDateTimePattern(
...
class FormatStyle(java.lang.Enum["FormatStyle"]):
    ...
    @typing.overload
    @staticmethod
    def valueOf(string: java.lang.String | str) -> FormatStyle: ...
    @staticmethod
...
class ResolverStyle(java.lang.Enum["ResolverStyle"]):
    ...
    @typing.overload
    @staticmethod
    def valueOf(string: java.lang.String | str) -> ResolverStyle: ...
    @staticmethod
...
class SignStyle(java.lang.Enum["SignStyle"]):
    ...
    @typing.overload
    @staticmethod
    def valueOf(string: java.lang.String | str) -> SignStyle: ...
    @staticmethod
...
class TextStyle(java.lang.Enum["TextStyle"]):
    ...
    @typing.overload
    @staticmethod
    def valueOf(string: java.lang.String | str) -> TextStyle: ...
    @staticmethod
...
class __module_protocol__(Protocol):
    ...
    DateTimeFormatter: type[DateTimeFormatter]
    DateTimeFormatterBuilder: type[DateTimeFormatterBuilder]
    DateTimeParseException: type[DateTimeParseException]
    DecimalStyle: type[DecimalStyle]
    FormatStyle: type[FormatStyle]
    ResolverStyle: type[ResolverStyle]
    SignStyle: type[SignStyle]
