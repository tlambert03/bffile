...
class ZoneOffsetTransition(
    java.lang.Comparable["ZoneOffsetTransition"], java.io.Serializable
):
    ...
    def of(
        ...
        zoneOffset2: java.time.ZoneOffset,
...
class ZoneOffsetTransitionRule(java.io.Serializable):
    ...
    def of(
        ...
        zoneOffset: java.time.ZoneOffset,
        zoneOffset2: java.time.ZoneOffset,
        zoneOffset3: java.time.ZoneOffset,
...
class ZoneRules(java.io.Serializable):
    def equals(self, object: typing.Any) -> bool: ...
    def getDaylightSavings(
        self, instant: java.time.Instant | datetime.datetime
    ) -> java.time.Duration: ...
    @typing.overload
    def getOffset(
        self, instant: java.time.Instant | datetime.datetime
    ...
    def getValidOffsets(
        self, localDateTime: java.time.LocalDateTime
    ) -> java.util.List[java.time.ZoneOffset]: ...
    def hashCode(self) -> int: ...
    ...
    def isValidOffset(
        self, localDateTime: java.time.LocalDateTime, zoneOffset: java.time.ZoneOffset
    ) -> bool: ...
    def nextTransition(
        self, instant: java.time.Instant | datetime.datetime
    ) -> ZoneOffsetTransition: ...
    ...
    def of(
        zoneOffset: java.time.ZoneOffset,
        zoneOffset2: java.time.ZoneOffset,
        list: java.util.List[ZoneOffsetTransition],
        list2: java.util.List[ZoneOffsetTransition],
        list3: java.util.List[ZoneOffsetTransitionRule],
    ) -> ZoneRules: ...
...
class ZoneRulesProvider:
    ...
    @staticmethod
    def getRules(string: java.lang.String | str, boolean: bool) -> ZoneRules: ...
    @staticmethod
    def getVersions(
        string: java.lang.String | str,
    ) -> java.util.NavigableMap[java.lang.String, ZoneRules]: ...
    @staticmethod
    def refresh() -> bool: ...
    @staticmethod
...
class __module_protocol__(Protocol):
    ...
    ZoneOffsetTransition: type[ZoneOffsetTransition]
    ZoneOffsetTransitionRule: type[ZoneOffsetTransitionRule]
    ZoneRules: type[ZoneRules]
    ZoneRulesException: type[ZoneRulesException]
    ZoneRulesProvider: type[ZoneRulesProvider]
