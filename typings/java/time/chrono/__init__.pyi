...
class ChronoLocalDate(
    ...
    def adjustInto(
        self, temporal: java.time.temporal.Temporal
    ) -> java.time.temporal.Temporal: ...
    def atTime(
        self, localTime: java.time.LocalTime
    ) -> ChronoLocalDateTime[typing.Any]: ...
    def compareTo(self, chronoLocalDate: ChronoLocalDate) -> int: ...
    def equals(self, object: typing.Any) -> bool: ...
    def format(
        self, dateTimeFormatter: java.time.format.DateTimeFormatter
    ) -> java.lang.String: ...
    @staticmethod
    def from_(
    ...
    @typing.overload
    def minus(
        self, temporalAmount: java.time.temporal.TemporalAmount
    ) -> ChronoLocalDate: ...
    @typing.overload
    def minus(
        self, long: int, temporalUnit: java.time.temporal.TemporalUnit
    ) -> ChronoLocalDate: ...
    @typing.overload
    def plus(
        self, temporalAmount: java.time.temporal.TemporalAmount
    ...
    def query(
        self,
        temporalQuery: java.time.temporal.TemporalQuery[_query__R]
        | typing.Callable[[java.time.temporal.TemporalAccessor], _query__R],
    ) -> _query__R: ...
    @staticmethod
    ...
    @typing.overload
    def with_(
        self, temporalAdjuster: java.time.temporal.TemporalAdjuster | typing.Callable
    ) -> ChronoLocalDate: ...
    @typing.overload
    def with_(
        self, temporalField: java.time.temporal.TemporalField, long: int
    ) -> ChronoLocalDate: ...

_ChronoLocalDateTime__D = typing.TypeVar(
    "_ChronoLocalDateTime__D", bound=ChronoLocalDate
)  # <D>

class ChronoLocalDateTime(
    java.time.temporal.Temporal,
    java.time.temporal.TemporalAdjuster,
    java.lang.Comparable["ChronoLocalDateTime"[typing.Any]],
    typing.Generic[_ChronoLocalDateTime__D],
):
    def adjustInto(
        self, temporal: java.time.temporal.Temporal
    ) -> java.time.temporal.Temporal: ...
    def atZone(
        self, zoneId: java.time.ZoneId
    ) -> ChronoZonedDateTime[_ChronoLocalDateTime__D]: ...
    def compareTo(
        self, chronoLocalDateTime: ChronoLocalDateTime[typing.Any]
    ) -> int: ...
    def equals(self, object: typing.Any) -> bool: ...
    def format(
        self, dateTimeFormatter: java.time.format.DateTimeFormatter
    ...
    def minus(
        self, temporalAmount: java.time.temporal.TemporalAmount
    ) -> ChronoLocalDateTime[_ChronoLocalDateTime__D]: ...
    @typing.overload
    def minus(
        self, long: int, temporalUnit: java.time.temporal.TemporalUnit
    ) -> ChronoLocalDateTime[_ChronoLocalDateTime__D]: ...
...
class ChronoPeriod(java.time.temporal.TemporalAmount):
    ...
    @staticmethod
    def between(
        chronoLocalDate: ChronoLocalDate, chronoLocalDate2: ChronoLocalDate
    ) -> ChronoPeriod: ...
    def equals(self, object: typing.Any) -> bool: ...
...
_ChronoZonedDateTime__D = typing.TypeVar(
    "_ChronoZonedDateTime__D", bound=ChronoLocalDate
)  # <D>

class ChronoZonedDateTime(
    java.time.temporal.Temporal,
    java.lang.Comparable["ChronoZonedDateTime"[typing.Any]],
    typing.Generic[_ChronoZonedDateTime__D],
):
    def compareTo(
        self, chronoZonedDateTime: ChronoZonedDateTime[typing.Any]
    ) -> int: ...
    def equals(self, object: typing.Any) -> bool: ...
    def format(
        self, dateTimeFormatter: java.time.format.DateTimeFormatter
    ...
    def from_(
        temporalAccessor: java.time.temporal.TemporalAccessor,
    ) -> ChronoZonedDateTime[typing.Any]: ...
    ...
    def minus(
        self, temporalAmount: java.time.temporal.TemporalAmount
    ) -> ChronoZonedDateTime[_ChronoZonedDateTime__D]: ...
    @typing.overload
    def minus(
        self, long: int, temporalUnit: java.time.temporal.TemporalUnit
    ) -> ChronoZonedDateTime[_ChronoZonedDateTime__D]: ...
    ...
    def range(
        self, temporalField: java.time.temporal.TemporalField
    ...
    def withZoneSameInstant(
        self, zoneId: java.time.ZoneId
    ) -> ChronoZonedDateTime[_ChronoZonedDateTime__D]: ...
    def withZoneSameLocal(
        self, zoneId: java.time.ZoneId
    ) -> ChronoZonedDateTime[_ChronoZonedDateTime__D]: ...
    @typing.overload
    def with_(
...
class Chronology(java.lang.Comparable["Chronology"]):
    ...
    @typing.overload
    def date(
        self, temporalAccessor: java.time.temporal.TemporalAccessor
    ) -> ChronoLocalDate: ...
    @typing.overload
    def date(
        self, era: Era | typing.Callable, int: int, int2: int, int3: int
    ) -> ChronoLocalDate: ...
    ...
    @typing.overload
    def dateYearDay(
        self, era: Era | typing.Callable, int: int, int2: int
    ) -> ChronoLocalDate: ...
    @typing.overload
    def epochSecond(
        self,
    ...
    def getDisplayName(
        self, textStyle: java.time.format.TextStyle, locale: java.util.Locale
    ) -> java.lang.String: ...
    ...
    def localDateTime(
        self, temporalAccessor: java.time.temporal.TemporalAccessor
    ) -> ChronoLocalDateTime[ChronoLocalDate]: ...
    @staticmethod
    def of(string: java.lang.String | str) -> Chronology: ...
    @staticmethod
    def ofLocale(locale: java.util.Locale) -> Chronology: ...
    def period(self, int: int, int2: int, int3: int) -> ChronoPeriod: ...
    def prolepticYear(self, era: Era | typing.Callable, int: int) -> int: ...
    def range(
        self, chronoField: java.time.temporal.ChronoField
    ) -> java.time.temporal.ValueRange: ...
    def resolveDate(
        self,
        map: java.util.Map[java.time.temporal.TemporalField, int]
    ...
    @typing.overload
    def zonedDateTime(
        self, instant: java.time.Instant | datetime.datetime, zoneId: java.time.ZoneId
    ) -> ChronoZonedDateTime[ChronoLocalDate]: ...
    @typing.overload
    def zonedDateTime(
        self, temporalAccessor: java.time.temporal.TemporalAccessor
    ) -> ChronoZonedDateTime[ChronoLocalDate]: ...
...
class HijrahEra(java.lang.Enum["HijrahEra"], Era):
    ...
    @typing.overload
    @staticmethod
    def valueOf(string: java.lang.String | str) -> HijrahEra: ...
    @staticmethod
...
class IsoEra(java.lang.Enum["IsoEra"], Era):
    ...
    @typing.overload
    @staticmethod
    def valueOf(string: java.lang.String | str) -> IsoEra: ...
    @staticmethod
...
class JapaneseEra(Era, java.io.Serializable):
    ...
    def toString(self) -> java.lang.String: ...
    @staticmethod
    def valueOf(string: java.lang.String | str) -> JapaneseEra: ...
    @staticmethod
...
class MinguoEra(java.lang.Enum["MinguoEra"], Era):
    ...
    @typing.overload
    @staticmethod
    def valueOf(string: java.lang.String | str) -> MinguoEra: ...
    @staticmethod
...
class ThaiBuddhistEra(java.lang.Enum["ThaiBuddhistEra"], Era):
    ...
    @typing.overload
    @staticmethod
    def valueOf(string: java.lang.String | str) -> ThaiBuddhistEra: ...
    @staticmethod
...
class HijrahDate(
    java.time.chrono.ChronoLocalDateImpl["HijrahDate"],
    ChronoLocalDate,
...
class JapaneseDate(
    java.time.chrono.ChronoLocalDateImpl["JapaneseDate"],
    ChronoLocalDate,
    java.io.Serializable,
):
    def atTime(
    ...
    @staticmethod
    def of(
        japaneseEra: JapaneseEra, int: int, int2: int, int3: int
    ) -> JapaneseDate: ...
    @typing.overload
    def plus(
        self, temporalAmount: java.time.temporal.TemporalAmount
...
class MinguoDate(
    java.time.chrono.ChronoLocalDateImpl["MinguoDate"],
    ChronoLocalDate,
    java.io.Serializable,
):
    def atTime(
...
class ThaiBuddhistDate(
    java.time.chrono.ChronoLocalDateImpl["ThaiBuddhistDate"],
    ChronoLocalDate,
    java.io.Serializable,
):
    def atTime(
...
class __module_protocol__(Protocol):
    ...
    AbstractChronology: type[AbstractChronology]
    ChronoLocalDate: type[ChronoLocalDate]
    ChronoLocalDateImpl: type[ChronoLocalDateImpl]
    ChronoLocalDateTime: type[ChronoLocalDateTime]
    ChronoPeriod: type[ChronoPeriod]
    ChronoZonedDateTime: type[ChronoZonedDateTime]
    Chronology: type[Chronology]
    Era: type[Era]
    HijrahChronology: type[HijrahChronology]
    HijrahDate: type[HijrahDate]
    HijrahEra: type[HijrahEra]
    IsoChronology: type[IsoChronology]
    IsoEra: type[IsoEra]
    JapaneseChronology: type[JapaneseChronology]
    JapaneseDate: type[JapaneseDate]
    JapaneseEra: type[JapaneseEra]
    MinguoChronology: type[MinguoChronology]
    MinguoDate: type[MinguoDate]
    MinguoEra: type[MinguoEra]
    ThaiBuddhistChronology: type[ThaiBuddhistChronology]
    ThaiBuddhistDate: type[ThaiBuddhistDate]
    ThaiBuddhistEra: type[ThaiBuddhistEra]
