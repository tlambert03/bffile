...
class DayOfWeek(
    ...
    @typing.overload
    @staticmethod
    def valueOf(string: java.lang.String | str) -> DayOfWeek: ...
    @staticmethod
...
class Duration(
    ...
    @staticmethod
    def between(
        temporal: java.time.temporal.Temporal, temporal2: java.time.temporal.Temporal
    ) -> Duration: ...
    ...
    @staticmethod
    def parse(charSequence: java.lang.CharSequence | str) -> Duration: ...
    @typing.overload
...
class Instant(
    ...
    def compareTo(self, instant: Instant | datetime.datetime) -> int: ...
    def equals(self, object: typing.Any) -> bool: ...
    @staticmethod
    ...
    def getNano(self) -> int: ...
    def hashCode(self) -> int: ...
    def isAfter(self, instant: Instant | datetime.datetime) -> bool: ...
    def isBefore(self, instant: Instant | datetime.datetime) -> bool: ...
    @typing.overload
    def isSupported(self, temporalField: java.time.temporal.TemporalField) -> bool: ...
    @typing.overload
    ...
    @staticmethod
    def parse(charSequence: java.lang.CharSequence | str) -> Instant: ...
    @typing.overload
    ...
    @typing.overload
    def until(self, instant: Instant | datetime.datetime) -> Duration: ...
    @typing.overload
    def until(
        self,
...
class InstantSource:
    @staticmethod
    def fixed(instant: Instant | datetime.datetime) -> InstantSource: ...
    def instant(self) -> Instant: ...
    def millis(self) -> int: ...
    @staticmethod
    def offset(
        instantSource: InstantSource | typing.Callable, duration: Duration
    ) -> InstantSource: ...
    @staticmethod
...
class LocalDate(
    ...
    @typing.overload
    def datesUntil(
        self, localDate: LocalDate, period: Period
    ) -> java.util.stream.Stream[LocalDate]: ...
    def equals(self, object: typing.Any) -> bool: ...
    def format(
    ...
    @staticmethod
    def ofInstant(
        instant: Instant | datetime.datetime, zoneId: ZoneId
    ) -> LocalDate: ...
    @staticmethod
    def ofYearDay(int: int, int2: int) -> LocalDate: ...
    @typing.overload
    @staticmethod
    def parse(charSequence: java.lang.CharSequence | str) -> LocalDate: ...
    @typing.overload
    @staticmethod
    def parse(
...
class LocalDateTime(
    ...
    def atZone(self, zoneId: ZoneId) -> ZonedDateTime: ...
    def compareTo(
        self, chronoLocalDateTime: java.time.chrono.ChronoLocalDateTime[typing.Any]
    ) -> int: ...
    def equals(self, object: typing.Any) -> bool: ...
    def format(
        self, dateTimeFormatter: java.time.format.DateTimeFormatter
    ...
    @staticmethod
    def of(
        int: int, int2: int, int3: int, int4: int, int5: int, int6: int
    ) -> LocalDateTime: ...
    @typing.overload
    @staticmethod
    def of(
        int: int, int2: int, int3: int, int4: int, int5: int, int6: int, int7: int
    ) -> LocalDateTime: ...
    @typing.overload
    @staticmethod
    def of(
        int: int, month: Month, int2: int, int3: int, int4: int
    ) -> LocalDateTime: ...
    @typing.overload
    @staticmethod
    def of(
        int: int, month: Month, int2: int, int3: int, int4: int, int5: int
    ) -> LocalDateTime: ...
    @typing.overload
    @staticmethod
    def of(
        int: int, month: Month, int2: int, int3: int, int4: int, int5: int, int6: int
    ) -> LocalDateTime: ...
    @typing.overload
    @staticmethod
    ...
    @typing.overload
    @staticmethod
    def parse(charSequence: java.lang.CharSequence | str) -> LocalDateTime: ...
    @typing.overload
    @staticmethod
    def parse(
        charSequence: java.lang.CharSequence | str,
...
class LocalTime(
    ...
    @typing.overload
    @staticmethod
    def parse(charSequence: java.lang.CharSequence | str) -> LocalTime: ...
    @typing.overload
    @staticmethod
    def parse(
        charSequence: java.lang.CharSequence | str,
...
class Month(
    ...
    @typing.overload
    @staticmethod
    def valueOf(string: java.lang.String | str) -> Month: ...
    @staticmethod
...
class MonthDay(
    ...
    @typing.overload
    @staticmethod
    def parse(charSequence: java.lang.CharSequence | str) -> MonthDay: ...
    @typing.overload
    @staticmethod
    def parse(
        charSequence: java.lang.CharSequence | str,
...
class OffsetDateTime(
    ...
    @typing.overload
    @staticmethod
    def parse(charSequence: java.lang.CharSequence | str) -> OffsetDateTime: ...
    @typing.overload
    @staticmethod
    def parse(
        charSequence: java.lang.CharSequence | str,
...
class OffsetTime(
    ...
    @staticmethod
    def of(
        int: int, int2: int, int3: int, int4: int, zoneOffset: ZoneOffset
    ) -> OffsetTime: ...
    @typing.overload
    @staticmethod
    ...
    @typing.overload
    @staticmethod
    def parse(charSequence: java.lang.CharSequence | str) -> OffsetTime: ...
    @typing.overload
    @staticmethod
    def parse(
        charSequence: java.lang.CharSequence | str,
...
class Period(java.time.chrono.ChronoPeriod, java.io.Serializable):
    ...
    @staticmethod
    def parse(charSequence: java.lang.CharSequence | str) -> Period: ...
...
class Year(
    ...
    @typing.overload
    @staticmethod
    def parse(charSequence: java.lang.CharSequence | str) -> Year: ...
    @typing.overload
    @staticmethod
    def parse(
        charSequence: java.lang.CharSequence | str,
...
class YearMonth(
    java.time.temporal.Temporal,
    java.time.temporal.TemporalAdjuster,
    java.lang.Comparable["YearMonth"],
    java.io.Serializable,
):
    def adjustInto(
        self, temporal: java.time.temporal.Temporal
    ...
    @typing.overload
    @staticmethod
    def parse(charSequence: java.lang.CharSequence | str) -> YearMonth: ...
    @typing.overload
    @staticmethod
    def parse(
        charSequence: java.lang.CharSequence | str,
...
class ZoneId(java.io.Serializable):
    ...
    @typing.overload
    @staticmethod
    def of(string: java.lang.String | str) -> ZoneId: ...
    @typing.overload
    @staticmethod
    def of(
    ...
    @staticmethod
    def ofOffset(string: java.lang.String | str, zoneOffset: ZoneOffset) -> ZoneId: ...
    @staticmethod
...
class ZonedDateTime(
    ...
    @staticmethod
    def ofInstant(
        localDateTime: LocalDateTime, zoneOffset: ZoneOffset, zoneId: ZoneId
    ) -> ZonedDateTime: ...
    @staticmethod
    def ofLocal(
        localDateTime: LocalDateTime, zoneId: ZoneId, zoneOffset: ZoneOffset
    ) -> ZonedDateTime: ...
    @staticmethod
    def ofStrict(
        localDateTime: LocalDateTime, zoneOffset: ZoneOffset, zoneId: ZoneId
    ...
    @typing.overload
    @staticmethod
    def parse(charSequence: java.lang.CharSequence | str) -> ZonedDateTime: ...
    @typing.overload
    @staticmethod
    def parse(
        charSequence: java.lang.CharSequence | str,
...
class Clock(InstantSource):
    def equals(self, object: typing.Any) -> bool: ...
    @staticmethod
    def fixed(instant: Instant | datetime.datetime, zoneId: ZoneId) -> Clock: ...
    def getZone(self) -> ZoneId: ...
    def hashCode(self) -> int: ...
    def instant(self) -> Instant: ...
    def millis(self) -> int: ...
...
class ZoneOffset(
    ...
    @typing.overload
    @staticmethod
    def of(string: java.lang.String | str) -> ZoneOffset: ...
    @staticmethod
