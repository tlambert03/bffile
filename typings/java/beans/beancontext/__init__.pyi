...
class BeanContextMembershipListener(java.util.EventListener):
    def childrenAdded(
        self, beanContextMembershipEvent: BeanContextMembershipEvent
    ) -> None: ...
    def childrenRemoved(
        self, beanContextMembershipEvent: BeanContextMembershipEvent
    ) -> None: ...
...
class BeanContextServiceProvider:
    def getCurrentServiceSelectors(
        self, beanContextServices: BeanContextServices, class_: type[typing.Any]
    ) -> java.util.Iterator[typing.Any]: ...
    def getService(
        self,
...
class BeanContextServiceRevokedListener(java.util.EventListener):
    def serviceRevoked(
        self, beanContextServiceRevokedEvent: BeanContextServiceRevokedEvent
    ) -> None: ...

class BeanContext(
    BeanContextChild, java.util.Collection, java.beans.DesignMode, java.beans.Visibility
):
    globalHierarchyLock: typing.ClassVar[typing.Any] = ...
    def addBeanContextMembershipListener(
        self, beanContextMembershipListener: BeanContextMembershipListener
    ) -> None: ...
    def equals(self, object: typing.Any) -> bool: ...
    def getResource(
        self, string: java.lang.String | str, beanContextChild: BeanContextChild
    ) -> java.net.URL: ...
    def getResourceAsStream(
        self, string: java.lang.String | str, beanContextChild: BeanContextChild
    ) -> java.io.InputStream: ...
    def hashCode(self) -> int: ...
    def instantiateChild(self, string: java.lang.String | str) -> typing.Any: ...
    def removeBeanContextMembershipListener(
        self, beanContextMembershipListener: BeanContextMembershipListener
    ) -> None: ...
...
class BeanContextMembershipEvent(BeanContextEvent):
    @typing.overload
    def __init__(
        self, beanContext: BeanContext, objectArray: list[typing.Any] | jpype.JArray
    ): ...
    @typing.overload
    def __init__(
        self,
...
class BeanContextServiceAvailableEvent(BeanContextEvent):
    ...
    def getServiceClass(self) -> type[typing.Any]: ...
...
class BeanContextServiceRevokedEvent(BeanContextEvent):
    ...
    def isServiceClass(self, class_: type[typing.Any]) -> bool: ...

class BeanContextServicesListener(BeanContextServiceRevokedListener):
    def serviceAvailable(
        self, beanContextServiceAvailableEvent: BeanContextServiceAvailableEvent
    ) -> None: ...

class BeanContextChildSupport(
    BeanContextChild, BeanContextServicesListener, java.io.Serializable
):
...
class BeanContextServices(BeanContext, BeanContextServicesListener):
    def addBeanContextServicesListener(
        self, beanContextServicesListener: BeanContextServicesListener
    ) -> None: ...
    def addService(
        self,
        class_: type[typing.Any],
    ...
    def hasService(self, class_: type[typing.Any]) -> bool: ...
    def hashCode(self) -> int: ...
    def releaseService(
        self,
        beanContextChild: BeanContextChild,
    ...
    def removeBeanContextServicesListener(
        self, beanContextServicesListener: BeanContextServicesListener
    ) -> None: ...
    def revokeService(
        self,
...
class BeanContextSupport(
    ...
    @typing.overload
    def __init__(
        self, beanContext: BeanContext, locale: java.util.Locale, boolean: bool
    ): ...
    @typing.overload
    def __init__(
        self,
    ...
    def addAll(
        self, collection: java.util.Collection | typing.Sequence | set
    ) -> bool: ...
    def addBeanContextMembershipListener(
        self, beanContextMembershipListener: BeanContextMembershipListener
    ) -> None: ...
    ...
    @typing.overload
    def toArray(
        self, objectArray: list[typing.Any] | jpype.JArray
...
class BeanContextServicesSupport(BeanContextSupport, BeanContextServices):
    ...
    @typing.overload
    def __init__(
        self, beanContextServices: BeanContextServices, locale: java.util.Locale
    ): ...
    @typing.overload
    def __init__(
        self,
...
class __module_protocol__(Protocol):
    ...
    BeanContext: type[BeanContext]
    BeanContextChild: type[BeanContextChild]
    BeanContextChildComponentProxy: type[BeanContextChildComponentProxy]
    BeanContextChildSupport: type[BeanContextChildSupport]
    BeanContextContainerProxy: type[BeanContextContainerProxy]
    BeanContextEvent: type[BeanContextEvent]
    BeanContextMembershipEvent: type[BeanContextMembershipEvent]
    BeanContextMembershipListener: type[BeanContextMembershipListener]
    BeanContextProxy: type[BeanContextProxy]
    BeanContextServiceAvailableEvent: type[BeanContextServiceAvailableEvent]
    BeanContextServiceProvider: type[BeanContextServiceProvider]
    BeanContextServiceProviderBeanInfo: type[BeanContextServiceProviderBeanInfo]
    BeanContextServiceRevokedEvent: type[BeanContextServiceRevokedEvent]
    BeanContextServiceRevokedListener: type[BeanContextServiceRevokedListener]
    BeanContextServices: type[BeanContextServices]
    BeanContextServicesListener: type[BeanContextServicesListener]
    BeanContextServicesSupport: type[BeanContextServicesSupport]
    BeanContextSupport: type[BeanContextSupport]
