...
class DSAKeyPairGenerator:
    @typing.overload
    def initialize(
        self, int: int, boolean: bool, secureRandom: java.security.SecureRandom
    ) -> None: ...
    @typing.overload
    def initialize(
        self, dSAParams: DSAParams, secureRandom: java.security.SecureRandom
    ) -> None: ...

class DSAParams(java.security.spec.AlgorithmParameterSpec):
...
class RSAMultiPrimePrivateCrtKey(RSAPrivateKey):
    ...
    def getOtherPrimeInfo(
        self,
    ) -> typing.MutableSequence[java.security.spec.RSAOtherPrimeInfo]: ...
...
class __module_protocol__(Protocol):
    ...
    DSAKey: type[DSAKey]
    DSAKeyPairGenerator: type[DSAKeyPairGenerator]
    DSAParams: type[DSAParams]
    DSAPrivateKey: type[DSAPrivateKey]
    DSAPublicKey: type[DSAPublicKey]
    ECKey: type[ECKey]
    ECPrivateKey: type[ECPrivateKey]
    ECPublicKey: type[ECPublicKey]
    EdECKey: type[EdECKey]
    EdECPrivateKey: type[EdECPrivateKey]
    EdECPublicKey: type[EdECPublicKey]
    RSAKey: type[RSAKey]
    RSAMultiPrimePrivateCrtKey: type[RSAMultiPrimePrivateCrtKey]
    RSAPrivateCrtKey: type[RSAPrivateCrtKey]
    RSAPrivateKey: type[RSAPrivateKey]
    RSAPublicKey: type[RSAPublicKey]
    XECKey: type[XECKey]
    XECPrivateKey: type[XECPrivateKey]
    XECPublicKey: type[XECPublicKey]
