...
_RandomGeneratorFactory__T = typing.TypeVar(
    "_RandomGeneratorFactory__T", bound="RandomGenerator"
)  # <T>
...
class RandomGeneratorFactory(typing.Generic[_RandomGeneratorFactory__T]):
    ...
    @staticmethod
    def of(string: java.lang.String | str) -> RandomGeneratorFactory[_of__T]: ...
...
class RandomGenerator:
    ...
    @staticmethod
    def of(string: java.lang.String | str) -> RandomGenerator: ...
    class ArbitrarilyJumpableGenerator(
        ...
        def jumps(
            self, double: float
        ) -> java.util.stream.Stream[RandomGenerator.ArbitrarilyJumpableGenerator]: ...
        @typing.overload
        def jumps(
            self, long: int, double: float
        ) -> java.util.stream.Stream[RandomGenerator.ArbitrarilyJumpableGenerator]: ...
        @typing.overload
    ...
    class JumpableGenerator(java.util.random.RandomGenerator.StreamableGenerator):
        ...
        def jumps(self, long: int) -> java.util.stream.Stream[RandomGenerator]: ...
        @staticmethod
        def of(string: java.lang.String | str) -> RandomGenerator.JumpableGenerator: ...
        @typing.overload
    ...
    class LeapableGenerator(java.util.random.RandomGenerator.JumpableGenerator):
        ...
        def leaps(
            self,
        ) -> java.util.stream.Stream[RandomGenerator.JumpableGenerator]: ...
        @typing.overload
        def leaps(
            self, long: int
        ) -> java.util.stream.Stream[RandomGenerator.JumpableGenerator]: ...
        @staticmethod
        def of(string: java.lang.String | str) -> RandomGenerator.LeapableGenerator: ...
    ...
    class SplittableGenerator(java.util.random.RandomGenerator.StreamableGenerator):
        ...
        @typing.overload
        def split(
            self, splittableGenerator: RandomGenerator.SplittableGenerator
        ) -> RandomGenerator.SplittableGenerator: ...
        @typing.overload
        def splits(
            self, splittableGenerator: RandomGenerator.SplittableGenerator
        ...
        @typing.overload
        def splits(
            self, long: int, splittableGenerator: RandomGenerator.SplittableGenerator
        ) -> java.util.stream.Stream[RandomGenerator.SplittableGenerator]: ...
        @typing.overload
        def splits(
            self,
...
class __module_protocol__(Protocol):
    ...
    RandomGeneratorFactory: type[RandomGeneratorFactory]
