...
class Deflater(java.lang.AutoCloseable):
    ...
    def close(self) -> None: ...
    @typing.overload
    def deflate(self, byteArray: list[int] | jpype.JArray | bytes) -> int: ...
    @typing.overload
    def deflate(
        self, byteArray: list[int] | jpype.JArray | bytes, int: int, int2: int
    ) -> int: ...
    ...
    def reset(self) -> None: ...
    @typing.overload
    def setDictionary(self, byteArray: list[int] | jpype.JArray | bytes) -> None: ...
    @typing.overload
    def setDictionary(
        self, byteArray: list[int] | jpype.JArray | bytes, int: int, int2: int
    ) -> None: ...
    ...
    @typing.overload
    def setInput(self, byteArray: list[int] | jpype.JArray | bytes) -> None: ...
    @typing.overload
    def setInput(
        self, byteArray: list[int] | jpype.JArray | bytes, int: int, int2: int
    ) -> None: ...
...
class DeflaterInputStream(java.io.FilterInputStream):
    ...
    @typing.overload
    def __init__(
        self, inputStream: java.io.InputStream, deflater: Deflater, int: int
    ): ...
...
class DeflaterOutputStream(java.io.FilterOutputStream):
    ...
    @typing.overload
    def __init__(
        self, outputStream: java.io.OutputStream, deflater: Deflater, boolean: bool
    ): ...
    @typing.overload
    def __init__(
        self, outputStream: java.io.OutputStream, deflater: Deflater, int: int
    ): ...
    @typing.overload
    def __init__(
        self,
...
class Inflater(java.lang.AutoCloseable):
    @typing.overload
    def __init__(self): ...
    @typing.overload
    ...
    def getTotalOut(self) -> int: ...
    @typing.overload
    def inflate(self, byteArray: list[int] | jpype.JArray | bytes) -> int: ...
    @typing.overload
    def inflate(
        self, byteArray: list[int] | jpype.JArray | bytes, int: int, int2: int
    ) -> int: ...
...
class InflaterInputStream(java.io.FilterInputStream):
    ...
    @typing.overload
    def __init__(
        self, inputStream: java.io.InputStream, inflater: Inflater, int: int
    ): ...
    def available(self) -> int: ...
    def close(self) -> None: ...
    def mark(self, int: int) -> None: ...
...
class InflaterOutputStream(java.io.FilterOutputStream):
    ...
    @typing.overload
    def __init__(
        self, outputStream: java.io.OutputStream, inflater: Inflater, int: int
    ): ...
    def close(self) -> None: ...
    def finish(self) -> None: ...
    def flush(self) -> None: ...
...
class ZipEntry(java.util.zip.ZipConstants, java.lang.Cloneable):
    ...
    def setCreationTime(
        self, fileTime: java.nio.file.attribute.FileTime
    ) -> ZipEntry: ...
    def setExtra(self, byteArray: list[int] | jpype.JArray | bytes) -> None: ...
...
class ZipFile(java.util.zip.ZipConstants, java.io.Closeable):
    ...
    @typing.overload
    def __init__(self, file: java.io.File | jpype.protocol.SupportsPath, int: int): ...
    @typing.overload
    def __init__(
        self,
    ...
    def getComment(self) -> java.lang.String: ...
    def getEntry(self, string: java.lang.String | str) -> ZipEntry: ...
...
class ZipOutputStream(DeflaterOutputStream, java.util.zip.ZipConstants):
    ...
    @typing.overload
    def __init__(
        self, outputStream: java.io.OutputStream, charset: java.nio.charset.Charset
    ): ...
    def close(self) -> None: ...
    def closeEntry(self) -> None: ...
    def finish(self) -> None: ...
...
class __module_protocol__(Protocol):
    ...
    Adler32: type[Adler32]
    CRC32: type[CRC32]
    CRC32C: type[CRC32C]
    CheckedInputStream: type[CheckedInputStream]
    CheckedOutputStream: type[CheckedOutputStream]
    Checksum: type[Checksum]
    DataFormatException: type[DataFormatException]
    Deflater: type[Deflater]
    DeflaterInputStream: type[DeflaterInputStream]
    DeflaterOutputStream: type[DeflaterOutputStream]
    GZIPInputStream: type[GZIPInputStream]
    GZIPOutputStream: type[GZIPOutputStream]
    Inflater: type[Inflater]
    InflaterInputStream: type[InflaterInputStream]
    InflaterOutputStream: type[InflaterOutputStream]
    ZipConstants: type[ZipConstants]
    ZipEntry: type[ZipEntry]
    ZipError: type[ZipError]
    ZipException: type[ZipException]
    ZipFile: type[ZipFile]
    ZipInputStream: type[ZipInputStream]
    ZipOutputStream: type[ZipOutputStream]
