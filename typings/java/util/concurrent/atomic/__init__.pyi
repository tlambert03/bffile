...
class AtomicIntegerFieldUpdater(typing.Generic[_AtomicIntegerFieldUpdater__T]):
    def accumulateAndGet(
        self,
        t: _AtomicIntegerFieldUpdater__T,
        int: int,
        intBinaryOperator: java.util.function.IntBinaryOperator | typing.Callable,
    ) -> int: ...
    def addAndGet(self, t: _AtomicIntegerFieldUpdater__T, int: int) -> int: ...
    def compareAndSet(
        self, t: _AtomicIntegerFieldUpdater__T, int: int, int2: int
    ) -> bool: ...
    ...
    @staticmethod
    def newUpdater(
        class_: type[_newUpdater__U], string: java.lang.String | str
    ) -> AtomicIntegerFieldUpdater[_newUpdater__U]: ...
...
class AtomicLongArray(java.io.Serializable):
    ...
    def __init__(self, int: int): ...
    @typing.overload
    def __init__(self, longArray: list[int] | jpype.JArray): ...
    def accumulateAndGet(
        self,
        int: int,
        long: int,
...
class AtomicLongFieldUpdater(typing.Generic[_AtomicLongFieldUpdater__T]):
    def accumulateAndGet(
        self,
        t: _AtomicLongFieldUpdater__T,
        long: int,
        longBinaryOperator: java.util.function.LongBinaryOperator | typing.Callable,
    ) -> int: ...
    def addAndGet(self, t: _AtomicLongFieldUpdater__T, long: int) -> int: ...
    def compareAndSet(
        self, t: _AtomicLongFieldUpdater__T, long: int, long2: int
    ) -> bool: ...
    ...
    def newUpdater(
        class_: type[_newUpdater__U], string: java.lang.String | str
    ) -> AtomicLongFieldUpdater[_newUpdater__U]: ...
...
class AtomicMarkableReference(typing.Generic[_AtomicMarkableReference__V]):
    ...
    def compareAndSet(
        self,
        v: _AtomicMarkableReference__V,
        v2: _AtomicMarkableReference__V,
        boolean: bool,
        boolean2: bool,
    ) -> bool: ...
    def get(
        self, booleanArray: list[bool] | jpype.JArray
    ) -> _AtomicMarkableReference__V: ...
...
class AtomicReference(java.io.Serializable, typing.Generic[_AtomicReference__V]):
    ...
    def accumulateAndGet(
        self,
        v: _AtomicReference__V,
        binaryOperator: java.util.function.BinaryOperator[_AtomicReference__V]
        | typing.Callable,
    ) -> _AtomicReference__V: ...
    def compareAndExchange(
        self, v: _AtomicReference__V, v2: _AtomicReference__V
    ) -> _AtomicReference__V: ...
    def compareAndExchangeAcquire(
        self, v: _AtomicReference__V, v2: _AtomicReference__V
    ) -> _AtomicReference__V: ...
    def compareAndExchangeRelease(
        self, v: _AtomicReference__V, v2: _AtomicReference__V
    ) -> _AtomicReference__V: ...
    def compareAndSet(
        self, v: _AtomicReference__V, v2: _AtomicReference__V
    ...
    def getAndUpdate(
        self,
        unaryOperator: java.util.function.UnaryOperator[_AtomicReference__V]
        | typing.Callable,
    ) -> _AtomicReference__V: ...
    ...
    def weakCompareAndSetAcquire(
        self, v: _AtomicReference__V, v2: _AtomicReference__V
    ) -> bool: ...
    def weakCompareAndSetPlain(
        self, v: _AtomicReference__V, v2: _AtomicReference__V
    ) -> bool: ...
    def weakCompareAndSetRelease(
        self, v: _AtomicReference__V, v2: _AtomicReference__V
    ) -> bool: ...
    def weakCompareAndSetVolatile(
        self, v: _AtomicReference__V, v2: _AtomicReference__V
    ) -> bool: ...
...
class AtomicReferenceArray(
    java.io.Serializable, typing.Generic[_AtomicReferenceArray__E]
):
    @typing.overload
    def __init__(self, int: int): ...
    @typing.overload
    def __init__(self, eArray: list[_AtomicReferenceArray__E] | jpype.JArray): ...
    def accumulateAndGet(
        self,
        int: int,
        e: _AtomicReferenceArray__E,
        binaryOperator: java.util.function.BinaryOperator[_AtomicReferenceArray__E]
        | typing.Callable,
    ) -> _AtomicReferenceArray__E: ...
    def compareAndExchange(
        self, int: int, e: _AtomicReferenceArray__E, e2: _AtomicReferenceArray__E
    ) -> _AtomicReferenceArray__E: ...
    def compareAndExchangeAcquire(
        self, int: int, e: _AtomicReferenceArray__E, e2: _AtomicReferenceArray__E
    ) -> _AtomicReferenceArray__E: ...
    ...
    def getAndSet(
        self, int: int, e: _AtomicReferenceArray__E
    ) -> _AtomicReferenceArray__E: ...
    def getAndUpdate(
        self,
        int: int,
        unaryOperator: java.util.function.UnaryOperator[_AtomicReferenceArray__E]
        | typing.Callable,
    ) -> _AtomicReferenceArray__E: ...
...
_AtomicReferenceFieldUpdater__T = typing.TypeVar(
    "_AtomicReferenceFieldUpdater__T"
)  # <T>
_AtomicReferenceFieldUpdater__V = typing.TypeVar(
    "_AtomicReferenceFieldUpdater__V"
)  # <V>

class AtomicReferenceFieldUpdater(
    typing.Generic[_AtomicReferenceFieldUpdater__T, _AtomicReferenceFieldUpdater__V]
):
    def accumulateAndGet(
        self,
        t: _AtomicReferenceFieldUpdater__T,
        v: _AtomicReferenceFieldUpdater__V,
    ...
    def compareAndSet(
        ...
        t: _AtomicReferenceFieldUpdater__T,
        v: _AtomicReferenceFieldUpdater__V,
        v2: _AtomicReferenceFieldUpdater__V,
    ) -> bool: ...
    def get(
        self, t: _AtomicReferenceFieldUpdater__T
    ) -> _AtomicReferenceFieldUpdater__V: ...
    def getAndAccumulate(
        self,
        t: _AtomicReferenceFieldUpdater__T,
    ...
    def getAndSet(
        self, t: _AtomicReferenceFieldUpdater__T, v: _AtomicReferenceFieldUpdater__V
    ) -> _AtomicReferenceFieldUpdater__V: ...
    def getAndUpdate(
        self,
        t: _AtomicReferenceFieldUpdater__T,
        unaryOperator: java.util.function.UnaryOperator[_AtomicReferenceFieldUpdater__V]
        | typing.Callable,
    ) -> _AtomicReferenceFieldUpdater__V: ...
    def lazySet(
        self, t: _AtomicReferenceFieldUpdater__T, v: _AtomicReferenceFieldUpdater__V
    ...
    @staticmethod
    def newUpdater(
        class_: type[_newUpdater__U],
        class2: type[_newUpdater__W],
        string: java.lang.String | str,
    ) -> AtomicReferenceFieldUpdater[_newUpdater__U, _newUpdater__W]: ...
    def set(
        self, t: _AtomicReferenceFieldUpdater__T, v: _AtomicReferenceFieldUpdater__V
    ) -> None: ...
    def updateAndGet(
...
class AtomicStampedReference(typing.Generic[_AtomicStampedReference__V]):
    ...
    def compareAndSet(
        self,
        v: _AtomicStampedReference__V,
        v2: _AtomicStampedReference__V,
        int: int,
        int2: int,
    ) -> bool: ...
    def get(self, intArray: list[int] | jpype.JArray) -> _AtomicStampedReference__V: ...
...
class __module_protocol__(Protocol):
    ...
    AtomicBoolean: type[AtomicBoolean]
    AtomicInteger: type[AtomicInteger]
    AtomicIntegerArray: type[AtomicIntegerArray]
    AtomicIntegerFieldUpdater: type[AtomicIntegerFieldUpdater]
    AtomicLong: type[AtomicLong]
    AtomicLongArray: type[AtomicLongArray]
    AtomicLongFieldUpdater: type[AtomicLongFieldUpdater]
    AtomicMarkableReference: type[AtomicMarkableReference]
    AtomicReference: type[AtomicReference]
    AtomicReferenceArray: type[AtomicReferenceArray]
    AtomicReferenceFieldUpdater: type[AtomicReferenceFieldUpdater]
    AtomicStampedReference: type[AtomicStampedReference]
    DoubleAccumulator: type[DoubleAccumulator]
    DoubleAdder: type[DoubleAdder]
    LongAccumulator: type[LongAccumulator]
    LongAdder: type[LongAdder]
    Striped64: type[Striped64]
