...
class AbstractQueuedLongSynchronizer(AbstractOwnableSynchronizer, java.io.Serializable):
    ...
    def getWaitQueueLength(
        self, conditionObject: AbstractQueuedLongSynchronizer.ConditionObject
    ) -> int: ...
    def getWaitingThreads(
        self, conditionObject: AbstractQueuedLongSynchronizer.ConditionObject
    ...
    class ConditionObject(Condition, java.io.Serializable):
        def __init__(
            self, abstractQueuedLongSynchronizer: AbstractQueuedLongSynchronizer
        ): ...
        def awaitNanos(self, long: int) -> int: ...
        def awaitUninterruptibly(self) -> None: ...
        def awaitUntil(self, date: java.util.Date) -> bool: ...
...
class AbstractQueuedSynchronizer(AbstractOwnableSynchronizer, java.io.Serializable):
    ...
    def getSharedQueuedThreads(self) -> java.util.Collection[java.lang.Thread]: ...
    def getWaitQueueLength(
        self, conditionObject: AbstractQueuedSynchronizer.ConditionObject
    ) -> int: ...
    def getWaitingThreads(
        self, conditionObject: AbstractQueuedSynchronizer.ConditionObject
    ) -> java.util.Collection[java.lang.Thread]: ...
...
class __module_protocol__(Protocol):
    ...
    AbstractOwnableSynchronizer: type[AbstractOwnableSynchronizer]
    AbstractQueuedLongSynchronizer: type[AbstractQueuedLongSynchronizer]
    AbstractQueuedSynchronizer: type[AbstractQueuedSynchronizer]
    Condition: type[Condition]
    Lock: type[Lock]
    LockSupport: type[LockSupport]
    ReadWriteLock: type[ReadWriteLock]
    ReentrantLock: type[ReentrantLock]
    ReentrantReadWriteLock: type[ReentrantReadWriteLock]
    StampedLock: type[StampedLock]
