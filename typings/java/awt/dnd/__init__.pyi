...
class DragGestureEvent(java.util.EventObject):
    def __init__(
        ...
        list: java.util.List[java.awt.event.InputEvent],
    ): ...
    ...
    @typing.overload
    def startDrag(
        self, cursor: java.awt.Cursor, transferable: java.awt.datatransfer.Transferable
    ) -> None: ...
    @typing.overload
    def startDrag(
        self,
...
class DragGestureRecognizer(java.io.Serializable):
    def addDragGestureListener(
        self, dragGestureListener: DragGestureListener | typing.Callable
    ) -> None: ...
    def getComponent(self) -> java.awt.Component: ...
    def getDragSource(self) -> DragSource: ...
    def getSourceActions(self) -> int: ...
    def getTriggerEvent(self) -> java.awt.event.InputEvent: ...
    def removeDragGestureListener(
        self, dragGestureListener: DragGestureListener | typing.Callable
    ) -> None: ...
...
class DragSource(java.io.Serializable):
    ...
    def addDragSourceMotionListener(
        self, dragSourceMotionListener: DragSourceMotionListener | typing.Callable
    ) -> None: ...
    def createDefaultDragGestureRecognizer(
        self,
        component: java.awt.Component,
        int: int,
        dragGestureListener: DragGestureListener | typing.Callable,
    ) -> DragGestureRecognizer: ...
    _createDragGestureRecognizer__T = typing.TypeVar(
        "_createDragGestureRecognizer__T", bound=DragGestureRecognizer
    )  # <T>
    ...
    def getDragSourceMotionListeners(
        self,
    ) -> typing.MutableSequence[DragSourceMotionListener]: ...
    @staticmethod
    ...
    def removeDragSourceListener(
        self, dragSourceListener: DragSourceListener
    ) -> None: ...
    def removeDragSourceMotionListener(
        self, dragSourceMotionListener: DragSourceMotionListener | typing.Callable
    ) -> None: ...
    @typing.overload
    def startDrag(
...
class DragSourceContext(
    DragSourceListener, DragSourceMotionListener, java.io.Serializable
):
    def __init__(
        self,
        dragGestureEvent: DragGestureEvent,
...
class DragSourceDragEvent(DragSourceEvent):
    @typing.overload
    def __init__(
        self, dragSourceContext: DragSourceContext, int: int, int2: int, int3: int
    ): ...
    @typing.overload
    def __init__(
        self,
...
class DragSourceDropEvent(DragSourceEvent):
    ...
    @typing.overload
    def __init__(
        self, dragSourceContext: DragSourceContext, int: int, boolean: bool
    ): ...
    @typing.overload
    def __init__(
        self,
...
class DropTarget(DropTargetListener, java.io.Serializable):
    ...
    @typing.overload
    def __init__(
        self, component: java.awt.Component, dropTargetListener: DropTargetListener
    ): ...
    ...
    def removeDropTargetListener(
        self, dropTargetListener: DropTargetListener
    ) -> None: ...
...
class DropTargetDragEvent(DropTargetEvent):
    ...
    def getCurrentDataFlavors(
        self,
    ) -> typing.MutableSequence[java.awt.datatransfer.DataFlavor]: ...
    def getCurrentDataFlavorsAsList(
        self,
    ...
    def isDataFlavorSupported(
        self, dataFlavor: java.awt.datatransfer.DataFlavor
    ) -> bool: ...
...
class __module_protocol__(Protocol):
    ...
    DnDConstants: type[DnDConstants]
    DragGestureEvent: type[DragGestureEvent]
    DragGestureListener: type[DragGestureListener]
    DragGestureRecognizer: type[DragGestureRecognizer]
    DragSource: type[DragSource]
    DragSourceAdapter: type[DragSourceAdapter]
    DragSourceContext: type[DragSourceContext]
    DragSourceDragEvent: type[DragSourceDragEvent]
    DragSourceDropEvent: type[DragSourceDropEvent]
    DragSourceEvent: type[DragSourceEvent]
    DragSourceListener: type[DragSourceListener]
    DragSourceMotionListener: type[DragSourceMotionListener]
    DropTarget: type[DropTarget]
    DropTargetAdapter: type[DropTargetAdapter]
    DropTargetContext: type[DropTargetContext]
    DropTargetDragEvent: type[DropTargetDragEvent]
    DropTargetDropEvent: type[DropTargetDropEvent]
    DropTargetEvent: type[DropTargetEvent]
    DropTargetListener: type[DropTargetListener]
    InvalidDnDOperationException: type[InvalidDnDOperationException]
    MouseDragGestureRecognizer: type[MouseDragGestureRecognizer]
