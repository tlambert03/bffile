...
class ActionEvent(java.awt.AWTEvent):
    ...
    @typing.overload
    def __init__(
        self, object: typing.Any, int: int, string: java.lang.String | str
    ): ...
    @typing.overload
    def __init__(
        self, object: typing.Any, int: int, string: java.lang.String | str, int2: int
    ): ...
    @typing.overload
    def __init__(
        self,
...
class AdjustmentEvent(java.awt.AWTEvent):
    ...
    @typing.overload
    def __init__(
        self, adjustable: java.awt.Adjustable, int: int, int2: int, int3: int
    ): ...
    @typing.overload
    def __init__(
        self,
...
class InputMethodEvent(java.awt.AWTEvent):
    ...
    def __init__(
        ...
        textHitInfo2: java.awt.font.TextHitInfo,
    ): ...
    @typing.overload
    def __init__(
        self,
...
class InvocationEvent(java.awt.AWTEvent, java.awt.ActiveEvent):
    ...
    def __init__(
        ...
        object: typing.Any,
        runnable: java.lang.Runnable | typing.Callable,
        runnable2: java.lang.Runnable | typing.Callable,
        boolean: bool,
    ): ...
...
class AWTEventListenerProxy(
    java.util.EventListenerProxy[AWTEventListener], AWTEventListener
):
    def __init__(
        self, long: int, aWTEventListener: AWTEventListener | typing.Callable
    ): ...
    def eventDispatched(self, aWTEvent: java.awt.AWTEvent) -> None: ...
...
class ContainerEvent(ComponentEvent):
    ...
    def __init__(
        self, component: java.awt.Component, int: int, component2: java.awt.Component
    ): ...
...
class FocusEvent(ComponentEvent):
    ...
    class Cause(java.lang.Enum["FocusEvent.Cause"]):
        ...
        @typing.overload
        @staticmethod
        def valueOf(string: java.lang.String | str) -> FocusEvent.Cause: ...
        @typing.overload
        @staticmethod
        def valueOf(
...
class InputEvent(ComponentEvent):
    ...
    @staticmethod
    def getModifiersExText(int: int) -> java.lang.String: ...
    def getWhen(self) -> int: ...
...
class PaintEvent(ComponentEvent):
    ...
    def __init__(
        self, component: java.awt.Component, int: int, rectangle: java.awt.Rectangle
    ): ...
...
class KeyEvent(InputEvent):
    ...
    @typing.overload
    def __init__(
        self, component: java.awt.Component, int: int, long: int, int2: int, int3: int
    ): ...
    @typing.overload
    def __init__(
        self,
    ...
    @staticmethod
    def getKeyModifiersText(int: int) -> java.lang.String: ...
    @staticmethod
    def getKeyText(int: int) -> java.lang.String: ...
...
class MouseEvent(InputEvent):
    ...
    def getModifiersEx(self) -> int: ...
    @staticmethod
    def getMouseModifiersText(int: int) -> java.lang.String: ...
...
class __module_protocol__(Protocol):
    ...
    AWTEventListener: type[AWTEventListener]
    AWTEventListenerProxy: type[AWTEventListenerProxy]
    ActionEvent: type[ActionEvent]
    ActionListener: type[ActionListener]
    AdjustmentEvent: type[AdjustmentEvent]
    AdjustmentListener: type[AdjustmentListener]
    ComponentAdapter: type[ComponentAdapter]
    ComponentEvent: type[ComponentEvent]
    ComponentListener: type[ComponentListener]
    ContainerAdapter: type[ContainerAdapter]
    ContainerEvent: type[ContainerEvent]
    ContainerListener: type[ContainerListener]
    FocusAdapter: type[FocusAdapter]
    FocusEvent: type[FocusEvent]
    FocusListener: type[FocusListener]
    HierarchyBoundsAdapter: type[HierarchyBoundsAdapter]
    HierarchyBoundsListener: type[HierarchyBoundsListener]
    HierarchyEvent: type[HierarchyEvent]
    HierarchyListener: type[HierarchyListener]
    InputEvent: type[InputEvent]
    InputMethodEvent: type[InputMethodEvent]
    InputMethodListener: type[InputMethodListener]
    InvocationEvent: type[InvocationEvent]
    ItemEvent: type[ItemEvent]
    ItemListener: type[ItemListener]
    ...
    MouseMotionAdapter: type[MouseMotionAdapter]
    MouseMotionListener: type[MouseMotionListener]
    MouseWheelEvent: type[MouseWheelEvent]
    MouseWheelListener: type[MouseWheelListener]
    PaintEvent: type[PaintEvent]
    TextEvent: type[TextEvent]
    TextListener: type[TextListener]
    WindowAdapter: type[WindowAdapter]
    WindowEvent: type[WindowEvent]
    WindowFocusListener: type[WindowFocusListener]
    WindowListener: type[WindowListener]
    WindowStateListener: type[WindowStateListener]
