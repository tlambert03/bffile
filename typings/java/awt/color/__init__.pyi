...
class ICC_Profile(java.io.Serializable):
    ...
    @typing.overload
    @staticmethod
    def getInstance(byteArray: list[int] | jpype.JArray | bytes) -> ICC_Profile: ...
    @typing.overload
    @staticmethod
    ...
    @typing.overload
    @staticmethod
    def getInstance(string: java.lang.String | str) -> ICC_Profile: ...
...
class __module_protocol__(Protocol):
    ...
    CMMException: type[CMMException]
    ColorSpace: type[ColorSpace]
    ICC_ColorSpace: type[ICC_ColorSpace]
    ICC_Profile: type[ICC_Profile]
    ICC_ProfileGray: type[ICC_ProfileGray]
    ICC_ProfileRGB: type[ICC_ProfileRGB]
    ProfileDataException: type[ProfileDataException]
