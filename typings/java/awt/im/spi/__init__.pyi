...
class InputMethod:
    ...
    def setCharacterSubsets(
        self, subsetArray: list[java.lang.Character.Subset] | jpype.JArray
    ) -> None: ...
...
class InputMethodContext(java.awt.im.InputMethodRequests):
    def createInputMethodJFrame(
        self, string: java.lang.String | str, boolean: bool
    ) -> javax.swing.JFrame: ...
    def createInputMethodWindow(
        self, string: java.lang.String | str, boolean: bool
    ) -> java.awt.Window: ...
    def dispatchInputMethodEvent(
        self,
        int: int,
    ...
    def enableClientWindowNotification(
        self, inputMethod: InputMethod, boolean: bool
    ) -> None: ...

class InputMethodDescriptor:
    def createInputMethod(self) -> InputMethod: ...
    def getAvailableLocales(self) -> typing.MutableSequence[java.util.Locale]: ...
    def getInputMethodDisplayName(
        self, locale: java.util.Locale, locale2: java.util.Locale
    ) -> java.lang.String: ...
...
class __module_protocol__(Protocol):
    ...
    InputMethodContext: type[InputMethodContext]
    InputMethodDescriptor: type[InputMethodDescriptor]
