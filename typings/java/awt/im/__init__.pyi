...
class InputMethodHighlight:
    ...
    def __init__(
        ...
        int: int,
        int2: int,
        map: java.util.Map[java.awt.font.TextAttribute, typing.Any]
        | typing.Mapping[java.awt.font.TextAttribute, typing.Any],
    ): ...
...
class InputMethodRequests:
    def cancelLatestCommittedText(
        self,
        attributeArray: list[java.text.AttributedCharacterIterator.Attribute]
        | jpype.JArray,
    ) -> java.text.AttributedCharacterIterator: ...
    def getCommittedText(
        self,
        int: int,
        int2: int,
        attributeArray: list[java.text.AttributedCharacterIterator.Attribute]
    ...
    def getTextLocation(
        self, textHitInfo: java.awt.font.TextHitInfo
    ) -> java.awt.Rectangle: ...
...
class __module_protocol__(Protocol):
    ...
    InputMethodHighlight: type[InputMethodHighlight]
    InputMethodRequests: type[InputMethodRequests]
    InputSubset: type[InputSubset]
