...
class ComponentPeer:
    ...
    def createBuffers(
        self, int: int, bufferCapabilities: java.awt.BufferCapabilities
    ) -> None: ...
    ...
    def flip(
        ...
        int3: int,
        int4: int,
        flipContents: java.awt.BufferCapabilities.FlipContents,
    ) -> None: ...
    ...
    def requestFocus(
        ...
        boolean2: bool,
        long: int,
        cause: java.awt.event.FocusEvent.Cause,
    ) -> bool: ...
...
class TaskbarPeer:
    ...
    def setWindowIconBadge(
        self, window: java.awt.Window, image: java.awt.Image
    ) -> None: ...
    def setWindowProgressState(
        self, window: java.awt.Window, state: java.awt.Taskbar.State
    ) -> None: ...
...
class CanvasPeer(ComponentPeer):
    def getAppropriateGraphicsConfiguration(
        self, graphicsConfiguration: java.awt.GraphicsConfiguration
...
class __module_protocol__(Protocol):
    ...
    ButtonPeer: type[ButtonPeer]
    CanvasPeer: type[CanvasPeer]
    CheckboxMenuItemPeer: type[CheckboxMenuItemPeer]
    CheckboxPeer: type[CheckboxPeer]
    ChoicePeer: type[ChoicePeer]
    ComponentPeer: type[ComponentPeer]
    ContainerPeer: type[ContainerPeer]
    DesktopPeer: type[DesktopPeer]
    DialogPeer: type[DialogPeer]
    FileDialogPeer: type[FileDialogPeer]
    FontPeer: type[FontPeer]
    FramePeer: type[FramePeer]
    KeyboardFocusManagerPeer: type[KeyboardFocusManagerPeer]
    LabelPeer: type[LabelPeer]
    LightweightPeer: type[LightweightPeer]
    ListPeer: type[ListPeer]
    MenuBarPeer: type[MenuBarPeer]
    MenuComponentPeer: type[MenuComponentPeer]
    MenuItemPeer: type[MenuItemPeer]
    MenuPeer: type[MenuPeer]
    MouseInfoPeer: type[MouseInfoPeer]
    PanelPeer: type[PanelPeer]
    PopupMenuPeer: type[PopupMenuPeer]
    RobotPeer: type[RobotPeer]
    ScrollPanePeer: type[ScrollPanePeer]
    ScrollbarPeer: type[ScrollbarPeer]
    SystemTrayPeer: type[SystemTrayPeer]
    TaskbarPeer: type[TaskbarPeer]
    TextAreaPeer: type[TextAreaPeer]
    TextComponentPeer: type[TextComponentPeer]
    TextFieldPeer: type[TextFieldPeer]
    TrayIconPeer: type[TrayIconPeer]
    WindowPeer: type[WindowPeer]
