...
class GlyphMetrics:
    ...
    @typing.overload
    def __init__(
        self, float: float, rectangle2D: java.awt.geom.Rectangle2D, byte: int
    ): ...
...
class GlyphVector(java.lang.Cloneable):
    ...
    @typing.overload
    def getGlyphOutline(
        self, int: int, float: float, float2: float
    ) -> java.awt.Shape: ...
    def getGlyphPixelBounds(
        self,
        int: int,
    ...
    def getPixelBounds(
        self, fontRenderContext: FontRenderContext, float: float, float2: float
    ) -> java.awt.Rectangle: ...
...
class GraphicAttribute:
    ...
    def draw(
        self, graphics2D: java.awt.Graphics2D, float: float, float2: float
    ) -> None: ...
    def getAdvance(self) -> float: ...
...
class MultipleMaster:
    @typing.overload
    def deriveMMFont(self, floatArray: list[float] | jpype.JArray) -> java.awt.Font: ...
    @typing.overload
    def deriveMMFont(
        self,
    ...
    def getDesignAxisNames(self) -> typing.MutableSequence[java.lang.String]: ...
...
class NumericShaper(java.io.Serializable):
    ...
    @typing.overload
    @staticmethod
    def getContextualShaper(
        set: java.util.Set[NumericShaper.Range],
    ) -> NumericShaper: ...
    @typing.overload
    @staticmethod
    def getContextualShaper(
        set: java.util.Set[NumericShaper.Range], range: NumericShaper.Range
    ) -> NumericShaper: ...
    ...
    @typing.overload
    def shape(
        self, charArray: list[str] | jpype.JArray, int: int, int2: int, int3: int
    ) -> None: ...
    @typing.overload
    def shape(
        self,
    ...
    class Range(java.lang.Enum["NumericShaper.Range"]):
        ...
        @typing.overload
        @staticmethod
        def valueOf(string: java.lang.String | str) -> NumericShaper.Range: ...
        @typing.overload
        @staticmethod
        def valueOf(
...
class OpenType:
    ...
    @typing.overload
    def getFontTableSize(self, string: java.lang.String | str) -> int: ...
...
class TextLayout(java.lang.Cloneable):
    ...
    @typing.overload
    def getCaretInfo(
        self, textHitInfo: TextHitInfo
    ) -> typing.MutableSequence[float]: ...
    @typing.overload
    def getCaretInfo(
        self, textHitInfo: TextHitInfo, rectangle2D: java.awt.geom.Rectangle2D
    ) -> typing.MutableSequence[float]: ...
    @typing.overload
    ...
    @typing.overload
    def getCaretShapes(
        self, int: int, rectangle2D: java.awt.geom.Rectangle2D
    ) -> typing.MutableSequence[java.awt.Shape]: ...
    @typing.overload
    def getCaretShapes(
        self,
        int: int,
        rectangle2D: java.awt.geom.Rectangle2D,
        caretPolicy: TextLayout.CaretPolicy,
    ) -> typing.MutableSequence[java.awt.Shape]: ...
    ...
    @typing.overload
    def getLogicalHighlightShape(
        self, int: int, int2: int, rectangle2D: java.awt.geom.Rectangle2D
    ) -> java.awt.Shape: ...
    def getLogicalRangesForVisualSelection(
        self, textHitInfo: TextHitInfo, textHitInfo2: TextHitInfo
    ) -> typing.MutableSequence[int]: ...
    @typing.overload
    def getNextLeftHit(self, int: int) -> TextHitInfo: ...
    @typing.overload
    def getNextLeftHit(
        self, int: int, caretPolicy: TextLayout.CaretPolicy
    ) -> TextHitInfo: ...
    @typing.overload
    ...
    @typing.overload
    def hitTestChar(
        self, float: float, float2: float, rectangle2D: java.awt.geom.Rectangle2D
    ) -> TextHitInfo: ...
    def hitToPoint(
        self, textHitInfo: TextHitInfo, point2D: java.awt.geom.Point2D
    ) -> None: ...
...
class ImageGraphicAttribute(GraphicAttribute):
    ...
    @typing.overload
    def __init__(
        self, image: java.awt.Image, int: int, float: float, float2: float
    ): ...
    def draw(
        self, graphics2D: java.awt.Graphics2D, float: float, float2: float
    ) -> None: ...
...
class __module_protocol__(Protocol):
    ...
    FontRenderContext: type[FontRenderContext]
    GlyphJustificationInfo: type[GlyphJustificationInfo]
    GlyphMetrics: type[GlyphMetrics]
    GlyphVector: type[GlyphVector]
    GraphicAttribute: type[GraphicAttribute]
    ImageGraphicAttribute: type[ImageGraphicAttribute]
    LayoutPath: type[LayoutPath]
    LineBreakMeasurer: type[LineBreakMeasurer]
    LineMetrics: type[LineMetrics]
    MultipleMaster: type[MultipleMaster]
    NumericShaper: type[NumericShaper]
    OpenType: type[OpenType]
    ShapeGraphicAttribute: type[ShapeGraphicAttribute]
    TextAttribute: type[TextAttribute]
    TextHitInfo: type[TextHitInfo]
    TextLayout: type[TextLayout]
    TextMeasurer: type[TextMeasurer]
    TransformAttribute: type[TransformAttribute]
