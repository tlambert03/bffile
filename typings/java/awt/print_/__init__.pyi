...
class Book(java.awt.print_.Pageable):
    ...
    @typing.overload
    def append(
        self, printable: Printable | typing.Callable, pageFormat: PageFormat
    ) -> None: ...
    @typing.overload
    def append(
        self, printable: Printable | typing.Callable, pageFormat: PageFormat, int: int
    ) -> None: ...
    def getNumberOfPages(self) -> int: ...
    def getPageFormat(self, int: int) -> PageFormat: ...
    def getPrintable(self, int: int) -> Printable: ...
    def setPage(
        self, int: int, printable: Printable | typing.Callable, pageFormat: PageFormat
    ) -> None: ...
...
class Printable:
    ...
    def print_(
        self, graphics: java.awt.Graphics, pageFormat: PageFormat, int: int
    ) -> int: ...
...
class PrinterJob:
    ...
    def getJobName(self) -> java.lang.String: ...
    def getPageFormat(
        self, printRequestAttributeSet: javax.print_.attribute.PrintRequestAttributeSet
    ) -> PageFormat: ...
    ...
    @staticmethod
    def lookupStreamPrintServices(
        string: java.lang.String | str,
    ) -> typing.MutableSequence[javax.print_.StreamPrintServiceFactory]: ...
    @typing.overload
    ...
    def setJobName(self, string: java.lang.String | str) -> None: ...
    def setPageable(self, pageable: Pageable) -> None: ...
    def setPrintService(self, printService: javax.print_.PrintService) -> None: ...
    @typing.overload
    def setPrintable(self, printable: Printable | typing.Callable) -> None: ...
    @typing.overload
    def setPrintable(
        self, printable: Printable | typing.Callable, pageFormat: PageFormat
    ) -> None: ...
...
class __module_protocol__(Protocol):
    ...
    Book: type[Book]
    PageFormat: type[PageFormat]
    Pageable: type[Pageable]
    Paper: type[Paper]
    Printable: type[Printable]
    PrinterAbortException: type[PrinterAbortException]
    PrinterException: type[PrinterException]
    PrinterGraphics: type[PrinterGraphics]
    PrinterIOException: type[PrinterIOException]
    PrinterJob: type[PrinterJob]
