...
class ParameterBlock(java.lang.Cloneable, java.io.Serializable):
    ...
    def __init__(
        self,
        vector: java.util.Vector[typing.Any],
        vector2: java.util.Vector[typing.Any],
    ): ...
    @typing.overload
    ...
    def getParamClasses(self) -> typing.MutableSequence[type[typing.Any]]: ...
...
class RenderContext(java.lang.Cloneable):
    ...
    @typing.overload
    def __init__(
        self, affineTransform: java.awt.geom.AffineTransform, shape: java.awt.Shape
    ): ...
    @typing.overload
    def __init__(
        self,
    ...
    def preConcatenateTransform(
        self, affineTransform: java.awt.geom.AffineTransform
    ) -> None: ...
    def preConcetenateTransform(
        self, affineTransform: java.awt.geom.AffineTransform
    ) -> None: ...
...
class RenderableImage:
    HINTS_OBSERVED: typing.ClassVar[java.lang.String] = ...
    def createDefaultRendering(self) -> java.awt.image.RenderedImage: ...
    def createRendering(
        self, renderContext: RenderContext
    ) -> java.awt.image.RenderedImage: ...
    def createScaledRendering(
        self, int: int, int2: int, renderingHints: java.awt.RenderingHints
    ) -> java.awt.image.RenderedImage: ...
...
class RenderableImageProducer(java.awt.image.ImageProducer, java.lang.Runnable):
    def __init__(
        self, renderableImage: RenderableImage, renderContext: RenderContext
    ): ...
    ...
    def requestTopDownLeftRightResend(
        self, imageConsumer: java.awt.image.ImageConsumer
    ) -> None: ...
    def run(self) -> None: ...
...
class RenderedImageFactory:
    def create(
        self, parameterBlock: ParameterBlock, renderingHints: java.awt.RenderingHints
    ) -> java.awt.image.RenderedImage: ...

class ContextualRenderedImageFactory(RenderedImageFactory):
    @typing.overload
    def create(
        self, renderContext: RenderContext, parameterBlock: ParameterBlock
    ) -> java.awt.image.RenderedImage: ...
    @typing.overload
    def create(
        self, parameterBlock: ParameterBlock, renderingHints: java.awt.RenderingHints
    ...
    def getProperty(
        self, parameterBlock: ParameterBlock, string: java.lang.String | str
    ) -> typing.Any: ...
    def getPropertyNames(self) -> typing.MutableSequence[java.lang.String]: ...
    def isDynamic(self) -> bool: ...
    def mapRenderContext(
        self,
        int: int,
...
class RenderableImageOp(RenderableImage):
    def __init__(
        self,
        contextualRenderedImageFactory: ContextualRenderedImageFactory,
        parameterBlock: ParameterBlock,
    ): ...
    def createDefaultRendering(self) -> java.awt.image.RenderedImage: ...
    def createRendering(
...
class __module_protocol__(Protocol):
    ...
    ContextualRenderedImageFactory: type[ContextualRenderedImageFactory]
    ParameterBlock: type[ParameterBlock]
    RenderContext: type[RenderContext]
    RenderableImage: type[RenderableImage]
    RenderableImageOp: type[RenderableImageOp]
    RenderableImageProducer: type[RenderableImageProducer]
    RenderedImageFactory: type[RenderedImageFactory]
