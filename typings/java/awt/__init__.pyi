...
class AWTEvent(java.util.EventObject):
    ...
    def getID(self) -> int: ...
    def paramString(self) -> java.lang.String: ...
...
class AWTEventMulticaster(
    ...
    @staticmethod
    def add(
        actionListener: java.awt.event.ActionListener | typing.Callable,
        actionListener2: java.awt.event.ActionListener | typing.Callable,
    ) -> java.awt.event.ActionListener: ...
    @typing.overload
    @staticmethod
    def add(
        adjustmentListener: java.awt.event.AdjustmentListener | typing.Callable,
        adjustmentListener2: java.awt.event.AdjustmentListener | typing.Callable,
    ) -> java.awt.event.AdjustmentListener: ...
    @typing.overload
    @staticmethod
    def add(
    ...
    def add(
        ...
        containerListener2: java.awt.event.ContainerListener,
    ) -> java.awt.event.ContainerListener: ...
    @typing.overload
    @staticmethod
    def add(
        focusListener: java.awt.event.FocusListener,
        focusListener2: java.awt.event.FocusListener,
    ) -> java.awt.event.FocusListener: ...
    @typing.overload
    @staticmethod
    def add(
        hierarchyBoundsListener: java.awt.event.HierarchyBoundsListener,
        hierarchyBoundsListener2: java.awt.event.HierarchyBoundsListener,
    ) -> java.awt.event.HierarchyBoundsListener: ...
    @typing.overload
    @staticmethod
    def add(
        hierarchyListener: java.awt.event.HierarchyListener | typing.Callable,
        hierarchyListener2: java.awt.event.HierarchyListener | typing.Callable,
    ) -> java.awt.event.HierarchyListener: ...
    @typing.overload
    @staticmethod
    def add(
        inputMethodListener: java.awt.event.InputMethodListener,
        inputMethodListener2: java.awt.event.InputMethodListener,
    ) -> java.awt.event.InputMethodListener: ...
    @typing.overload
    @staticmethod
    def add(
        itemListener: java.awt.event.ItemListener | typing.Callable,
        itemListener2: java.awt.event.ItemListener | typing.Callable,
    ) -> java.awt.event.ItemListener: ...
    @typing.overload
    @staticmethod
    def add(
        keyListener: java.awt.event.KeyListener,
        keyListener2: java.awt.event.KeyListener,
    ) -> java.awt.event.KeyListener: ...
    @typing.overload
    @staticmethod
    def add(
        mouseListener: java.awt.event.MouseListener,
        mouseListener2: java.awt.event.MouseListener,
    ) -> java.awt.event.MouseListener: ...
    @typing.overload
    @staticmethod
    def add(
        mouseMotionListener: java.awt.event.MouseMotionListener,
        mouseMotionListener2: java.awt.event.MouseMotionListener,
    ) -> java.awt.event.MouseMotionListener: ...
    @typing.overload
    @staticmethod
    def add(
        mouseWheelListener: java.awt.event.MouseWheelListener | typing.Callable,
        mouseWheelListener2: java.awt.event.MouseWheelListener | typing.Callable,
    ) -> java.awt.event.MouseWheelListener: ...
    @typing.overload
    @staticmethod
    def add(
        textListener: java.awt.event.TextListener | typing.Callable,
        textListener2: java.awt.event.TextListener | typing.Callable,
    ) -> java.awt.event.TextListener: ...
    @typing.overload
    @staticmethod
    def add(
        windowFocusListener: java.awt.event.WindowFocusListener,
        windowFocusListener2: java.awt.event.WindowFocusListener,
    ) -> java.awt.event.WindowFocusListener: ...
    @typing.overload
    @staticmethod
    def add(
        windowListener: java.awt.event.WindowListener,
        windowListener2: java.awt.event.WindowListener,
    ) -> java.awt.event.WindowListener: ...
    @typing.overload
    @staticmethod
    def add(
        windowStateListener: java.awt.event.WindowStateListener | typing.Callable,
        windowStateListener2: java.awt.event.WindowStateListener | typing.Callable,
    ) -> java.awt.event.WindowStateListener: ...
    def adjustmentValueChanged(
        self, adjustmentEvent: java.awt.event.AdjustmentEvent
    ) -> None: ...
    def ancestorMoved(self, hierarchyEvent: java.awt.event.HierarchyEvent) -> None: ...
    def ancestorResized(
        self, hierarchyEvent: java.awt.event.HierarchyEvent
    ) -> None: ...
    def caretPositionChanged(
        self, inputMethodEvent: java.awt.event.InputMethodEvent
    ) -> None: ...
    def componentAdded(self, containerEvent: java.awt.event.ContainerEvent) -> None: ...
    def componentHidden(
        self, componentEvent: java.awt.event.ComponentEvent
    ) -> None: ...
    def componentMoved(self, componentEvent: java.awt.event.ComponentEvent) -> None: ...
    def componentRemoved(
        self, containerEvent: java.awt.event.ContainerEvent
    ) -> None: ...
    ...
    _getListeners__T = typing.TypeVar(
        "_getListeners__T", bound=java.util.EventListener
    )  # <T>
    @staticmethod
    def getListeners(
        eventListener: java.util.EventListener, class_: type[_getListeners__T]
    ) -> typing.MutableSequence[_getListeners__T]: ...
    def hierarchyChanged(
        self, hierarchyEvent: java.awt.event.HierarchyEvent
    ) -> None: ...
    def inputMethodTextChanged(
        self, inputMethodEvent: java.awt.event.InputMethodEvent
    ) -> None: ...
    ...
    def mouseWheelMoved(
        self, mouseWheelEvent: java.awt.event.MouseWheelEvent
    ) -> None: ...
    @typing.overload
    @staticmethod
    def remove(
...
class AWTKeyStroke(java.io.Serializable):
    ...
    @typing.overload
    @staticmethod
    def getAWTKeyStroke(string: java.lang.String | str) -> AWTKeyStroke: ...
    @staticmethod
...
class Adjustable:
    ...
    def addAdjustmentListener(
        self, adjustmentListener: java.awt.event.AdjustmentListener | typing.Callable
    ) -> None: ...
...
class Composite:
    def createContext(
        ...
        colorModel2: java.awt.image.ColorModel,
...
class Cursor(java.io.Serializable):
    ...
    @staticmethod
    def getSystemCustomCursor(string: java.lang.String | str) -> Cursor: ...
    def getType(self) -> int: ...
    def toString(self) -> java.lang.String: ...

class Desktop:
    def addAppEventListener(
        self, systemEventListener: java.awt.desktop.SystemEventListener
    ) -> None: ...
    def browse(self, uRI: java.net.URI) -> None: ...
    def browseFileDirectory(
        self, file: java.io.File | jpype.protocol.SupportsPath
    ) -> None: ...
    def disableSuddenTermination(self) -> None: ...
    def edit(self, file: java.io.File | jpype.protocol.SupportsPath) -> None: ...
    ...
    def moveToTrash(self, file: java.io.File | jpype.protocol.SupportsPath) -> bool: ...
    def open(self, file: java.io.File | jpype.protocol.SupportsPath) -> None: ...
    def openHelpViewer(self) -> None: ...
    def print_(self, file: java.io.File | jpype.protocol.SupportsPath) -> None: ...
    def removeAppEventListener(
        self, systemEventListener: java.awt.desktop.SystemEventListener
    ) -> None: ...
    def requestForeground(self, boolean: bool) -> None: ...
    def setAboutHandler(
        self, aboutHandler: java.awt.desktop.AboutHandler | typing.Callable
    ) -> None: ...
    def setDefaultMenuBar(self, jMenuBar: javax.swing.JMenuBar) -> None: ...
    def setOpenFileHandler(
        self, openFilesHandler: java.awt.desktop.OpenFilesHandler | typing.Callable
    ) -> None: ...
    def setOpenURIHandler(
        self, openURIHandler: java.awt.desktop.OpenURIHandler | typing.Callable
    ) -> None: ...
    def setPreferencesHandler(
        self, preferencesHandler: java.awt.desktop.PreferencesHandler | typing.Callable
    ) -> None: ...
    def setPrintFileHandler(
        self, printFilesHandler: java.awt.desktop.PrintFilesHandler | typing.Callable
    ) -> None: ...
    def setQuitHandler(
        self, quitHandler: java.awt.desktop.QuitHandler | typing.Callable
    ) -> None: ...
    ...
    class Action(java.lang.Enum["Desktop.Action"]):
        ...
        @typing.overload
        @staticmethod
        def valueOf(string: java.lang.String | str) -> Desktop.Action: ...
        @typing.overload
        @staticmethod
        def valueOf(
...
class EventQueue:
    ...
    @staticmethod
    def invokeAndWait(runnable: java.lang.Runnable | typing.Callable) -> None: ...
    @staticmethod
    def invokeLater(runnable: java.lang.Runnable | typing.Callable) -> None: ...
    @staticmethod
...
class FocusTraversalPolicy:
    def getComponentAfter(
        self, container: Container, component: Component
    ) -> Component: ...
    def getComponentBefore(
        self, container: Container, component: Component
    ) -> Component: ...
...
class Font(java.io.Serializable):
    DIALOG: typing.ClassVar[java.lang.String] = ...
    DIALOG_INPUT: typing.ClassVar[java.lang.String] = ...
    SANS_SERIF: typing.ClassVar[java.lang.String] = ...
    SERIF: typing.ClassVar[java.lang.String] = ...
    MONOSPACED: typing.ClassVar[java.lang.String] = ...
    ...
    def __init__(
        self,
        map: java.util.Map[java.text.AttributedCharacterIterator.Attribute, typing.Any]
        | typing.Mapping[java.text.AttributedCharacterIterator.Attribute, typing.Any],
    ): ...
    @typing.overload
    ...
    @typing.overload
    def canDisplayUpTo(self, string: java.lang.String | str) -> int: ...
    @typing.overload
    def canDisplayUpTo(
        self, characterIterator: java.text.CharacterIterator, int: int, int2: int
    ) -> int: ...
    @typing.overload
    @staticmethod
    def createFont(
        int: int, file: java.io.File | jpype.protocol.SupportsPath
    ) -> Font: ...
    @typing.overload
    @staticmethod
    ...
    @staticmethod
    def decode(string: java.lang.String | str) -> Font: ...
    @typing.overload
    ...
    @typing.overload
    def deriveFont(
        self, int: int, affineTransform: java.awt.geom.AffineTransform
    ) -> Font: ...
    @typing.overload
    ...
    def getAttributes(
        self,
    ) -> java.util.Map[java.awt.font.TextAttribute, typing.Any]: ...
    def getAvailableAttributes(
        self,
    ) -> typing.MutableSequence[java.text.AttributedCharacterIterator.Attribute]: ...
    def getBaselineFor(self, char: str) -> int: ...
    @typing.overload
    def getFamily(self) -> java.lang.String: ...
    @typing.overload
    def getFamily(self, locale: java.util.Locale) -> java.lang.String: ...
    @typing.overload
    @staticmethod
    def getFont(string: java.lang.String | str) -> Font: ...
    @typing.overload
    @staticmethod
    def getFont(string: java.lang.String | str, font: Font) -> Font: ...
    @typing.overload
    @staticmethod
    def getFont(
        map: java.util.Map[java.text.AttributedCharacterIterator.Attribute, typing.Any]
    ...
    @typing.overload
    def getFontName(self, locale: java.util.Locale) -> java.lang.String: ...
    ...
    def getMaxCharBounds(
        self, fontRenderContext: java.awt.font.FontRenderContext
    ) -> java.awt.geom.Rectangle2D: ...
    def getMissingGlyphCode(self) -> int: ...
    def getName(self) -> java.lang.String: ...
    def getNumGlyphs(self) -> int: ...
    def getPSName(self) -> java.lang.String: ...
...
class FontMetrics(java.io.Serializable):
    ...
    @typing.overload
    def getLineMetrics(
        self, string: java.lang.String | str, int: int, int2: int, graphics: Graphics
    ) -> java.awt.font.LineMetrics: ...
    @typing.overload
    def getLineMetrics(
        self, string: java.lang.String | str, graphics: Graphics
    ) -> java.awt.font.LineMetrics: ...
    @typing.overload
    def getLineMetrics(
        self,
    ...
    def hasUniformLineMetrics(self) -> bool: ...
    def stringWidth(self, string: java.lang.String | str) -> int: ...
    def toString(self) -> java.lang.String: ...
...
class Graphics:
    ...
    def drawImage(
        ...
        int8: int,
        color: Color,
        imageObserver: java.awt.image.ImageObserver | typing.Callable,
    ) -> bool: ...
    @typing.overload
    def drawImage(
        self,
...
class GraphicsConfigTemplate(java.io.Serializable):
    ...
    def getBestConfiguration(
        self, graphicsConfigurationArray: list[GraphicsConfiguration] | jpype.JArray
    ) -> GraphicsConfiguration: ...
    def isGraphicsConfigSupported(
        self, graphicsConfiguration: GraphicsConfiguration
    ) -> bool: ...
...
class GraphicsConfiguration:
    ...
    @typing.overload
    def createCompatibleVolatileImage(
        self, int: int, int2: int
    ...
    @typing.overload
    def createCompatibleVolatileImage(
        self, int: int, int2: int, imageCapabilities: ImageCapabilities
    ) -> java.awt.image.VolatileImage: ...
    @typing.overload
    def createCompatibleVolatileImage(
        self, int: int, int2: int, imageCapabilities: ImageCapabilities, int3: int
    ) -> java.awt.image.VolatileImage: ...
...
class GraphicsDevice:
    ...
    def getBestConfiguration(
        self, graphicsConfigTemplate: GraphicsConfigTemplate
    ) -> GraphicsConfiguration: ...
    ...
    def getIDstring(self) -> java.lang.String: ...
    def getType(self) -> int: ...
    def isDisplayChangeSupported(self) -> bool: ...
    def isFullScreenSupported(self) -> bool: ...
    def isWindowTranslucencySupported(
        self, windowTranslucency: GraphicsDevice.WindowTranslucency
    ) -> bool: ...
...
class GraphicsEnvironment:
    def createGraphics(
        self, bufferedImage: java.awt.image.BufferedImage
    ) -> Graphics2D: ...
    def getAllFonts(self) -> typing.MutableSequence[Font]: ...
    @typing.overload
    def getAvailableFontFamilyNames(
        self,
...
class Image:
    ...
    def getHeight(
        self, imageObserver: java.awt.image.ImageObserver | typing.Callable
    ) -> int: ...
    def getProperty(
        self,
        string: java.lang.String | str,
...
class ItemSelectable:
    def addItemListener(
        self, itemListener: java.awt.event.ItemListener | typing.Callable
    ) -> None: ...
    def getSelectedObjects(self) -> typing.MutableSequence[typing.Any]: ...
    def removeItemListener(
        self, itemListener: java.awt.event.ItemListener | typing.Callable
    ) -> None: ...
...
class LayoutManager:
    def addLayoutComponent(
        self, string: java.lang.String | str, component: Component
    ) -> None: ...
...
class RenderingHints(java.util.Map[typing.Any, typing.Any], java.lang.Cloneable):
    ...
    def __init__(
        self,
        map: java.util.Map[RenderingHints.Key, typing.Any]
        | typing.Mapping[RenderingHints.Key, typing.Any],
    ): ...
...
class Robot:
    ...
    def createMultiResolutionScreenCapture(
...
class Shape:
    ...
    @typing.overload
    def getPathIterator(
        self, affineTransform: java.awt.geom.AffineTransform
    ) -> java.awt.geom.PathIterator: ...
    @typing.overload
    def getPathIterator(
        self, affineTransform: java.awt.geom.AffineTransform, double: float
    ) -> java.awt.geom.PathIterator: ...
    @typing.overload
    def intersects(
        self, double: float, double2: float, double3: float, double4: float
...
class SystemTray:
    ...
    def addPropertyChangeListener(
        self,
        string: java.lang.String | str,
        propertyChangeListener: java.beans.PropertyChangeListener | typing.Callable,
    ) -> None: ...
    def getPropertyChangeListeners(
        self, string: java.lang.String | str
    ) -> typing.MutableSequence[java.beans.PropertyChangeListener]: ...
    @staticmethod
...
class Taskbar:
    ...
    def setIconBadge(self, string: java.lang.String | str) -> None: ...
    ...
    class Feature(java.lang.Enum["Taskbar.Feature"]):
        ...
        @typing.overload
        @staticmethod
        def valueOf(string: java.lang.String | str) -> Taskbar.Feature: ...
        @typing.overload
        @staticmethod
        def valueOf(
            class_: type[_valueOf_1__T], string: java.lang.String | str
    ...
    class State(java.lang.Enum["Taskbar.State"]):
        ...
        @typing.overload
        @staticmethod
        def valueOf(string: java.lang.String | str) -> Taskbar.State: ...
        @typing.overload
        @staticmethod
        def valueOf(
            class_: type[_valueOf_1__T], string: java.lang.String | str
...
class Toolkit:
    def addAWTEventListener(
        self,
        aWTEventListener: java.awt.event.AWTEventListener | typing.Callable,
        long: int,
    ) -> None: ...
    def addPropertyChangeListener(
        self,
    ...
    def createCustomCursor(
        self, image: Image, point: Point, string: java.lang.String | str
    ) -> Cursor: ...
    _createDragGestureRecognizer__T = typing.TypeVar(
        "_createDragGestureRecognizer__T", bound=java.awt.dnd.DragGestureRecognizer
    )  # <T>
    def createDragGestureRecognizer(
        self,
        class_: type[_createDragGestureRecognizer__T],
        dragSource: java.awt.dnd.DragSource,
        component: Component,
        int: int,
        dragGestureListener: java.awt.dnd.DragGestureListener | typing.Callable,
    ) -> _createDragGestureRecognizer__T: ...
    @typing.overload
    def createImage(
        self, byteArray: list[int] | jpype.JArray | bytes, int: int, int2: int
    ) -> Image: ...
    ...
    @typing.overload
    def createImage(self, string: java.lang.String | str) -> Image: ...
    @typing.overload
    def createImage(self, uRL: java.net.URL) -> Image: ...
    @typing.overload
    def createImage(self, byteArray: list[int] | jpype.JArray | bytes) -> Image: ...
    @typing.overload
    def getAWTEventListeners(
        self,
    ) -> typing.MutableSequence[java.awt.event.AWTEventListener]: ...
    @typing.overload
    def getAWTEventListeners(
        self, long: int
    ) -> typing.MutableSequence[java.awt.event.AWTEventListener]: ...
    ...
    def getDesktopProperty(self, string: java.lang.String | str) -> typing.Any: ...
    def getFontList(self) -> typing.MutableSequence[java.lang.String]: ...
    def getFontMetrics(self, font: Font) -> FontMetrics: ...
    @typing.overload
    def getImage(self, string: java.lang.String | str) -> Image: ...
    @typing.overload
    ...
    def isModalExclusionTypeSupported(
        self, modalExclusionType: Dialog.ModalExclusionType
    ) -> bool: ...
    def isModalityTypeSupported(self, modalityType: Dialog.ModalityType) -> bool: ...
    def mapInputMethodHighlight(
        self, inputMethodHighlight: java.awt.im.InputMethodHighlight
    ) -> java.util.Map[java.awt.font.TextAttribute, typing.Any]: ...
    def prepareImage(
        self,
        image: Image,
    ...
    def removeAWTEventListener(
        self, aWTEventListener: java.awt.event.AWTEventListener | typing.Callable
    ) -> None: ...
    def removePropertyChangeListener(
        self,
        string: java.lang.String | str,
...
class TrayIcon:
    ...
    @typing.overload
    def __init__(self, image: Image, string: java.lang.String | str): ...
    @typing.overload
    def __init__(
        self, image: Image, string: java.lang.String | str, popupMenu: PopupMenu
    ): ...
    def addActionListener(
        self, actionListener: java.awt.event.ActionListener | typing.Callable
    ) -> None: ...
    def addMouseListener(self, mouseListener: java.awt.event.MouseListener) -> None: ...
    def addMouseMotionListener(
        self, mouseMotionListener: java.awt.event.MouseMotionListener
    ) -> None: ...
    def displayMessage(
        self,
        string: java.lang.String | str,
    ...
    def getActionCommand(self) -> java.lang.String: ...
    def getActionListeners(
        self,
    ) -> typing.MutableSequence[java.awt.event.ActionListener]: ...
    def getImage(self) -> Image: ...
    def getMouseListeners(
        self,
    ) -> typing.MutableSequence[java.awt.event.MouseListener]: ...
    def getMouseMotionListeners(
        self,
    ) -> typing.MutableSequence[java.awt.event.MouseMotionListener]: ...
    def getPopupMenu(self) -> PopupMenu: ...
    def getSize(self) -> Dimension: ...
    def getToolTip(self) -> java.lang.String: ...
    def isImageAutoSize(self) -> bool: ...
    def removeActionListener(
        self, actionListener: java.awt.event.ActionListener | typing.Callable
    ) -> None: ...
    def removeMouseListener(
        self, mouseListener: java.awt.event.MouseListener
    ) -> None: ...
    def removeMouseMotionListener(
        self, mouseMotionListener: java.awt.event.MouseMotionListener
    ) -> None: ...
    def setActionCommand(self, string: java.lang.String | str) -> None: ...
    ...
    def setToolTip(self, string: java.lang.String | str) -> None: ...
    class MessageType(java.lang.Enum["TrayIcon.MessageType"]):
        ...
        @typing.overload
        @staticmethod
        def valueOf(string: java.lang.String | str) -> TrayIcon.MessageType: ...
        @typing.overload
        @staticmethod
        def valueOf(
            class_: type[_valueOf_1__T], string: java.lang.String | str
...
class Component(java.awt.image.ImageObserver, MenuContainer, java.io.Serializable):
    ...
    def addComponentListener(
        self, componentListener: java.awt.event.ComponentListener
    ) -> None: ...
    def addFocusListener(self, focusListener: java.awt.event.FocusListener) -> None: ...
    def addHierarchyBoundsListener(
        self, hierarchyBoundsListener: java.awt.event.HierarchyBoundsListener
    ) -> None: ...
    def addHierarchyListener(
        self, hierarchyListener: java.awt.event.HierarchyListener | typing.Callable
    ) -> None: ...
    def addInputMethodListener(
        self, inputMethodListener: java.awt.event.InputMethodListener
    ) -> None: ...
    ...
    def addMouseWheelListener(
        self, mouseWheelListener: java.awt.event.MouseWheelListener | typing.Callable
    ) -> None: ...
    ...
    def firePropertyChange(
        self, string: java.lang.String | str, byte: int, byte2: int
    ) -> None: ...
    @typing.overload
    def firePropertyChange(
        self, string: java.lang.String | str, char: str, char2: str
    ) -> None: ...
    @typing.overload
    def firePropertyChange(
        self, string: java.lang.String | str, double: float, double2: float
    ) -> None: ...
    @typing.overload
    def firePropertyChange(
        self, string: java.lang.String | str, float: float, float2: float
    ) -> None: ...
    @typing.overload
    def firePropertyChange(
        self, string: java.lang.String | str, long: int, long2: int
    ) -> None: ...
    @typing.overload
    def firePropertyChange(
        self, string: java.lang.String | str, short: int, short2: int
    ) -> None: ...
    def getAccessibleContext(self) -> javax.accessibility.AccessibleContext: ...
    ...
    def getComponentListeners(
        self,
    ) -> typing.MutableSequence[java.awt.event.ComponentListener]: ...
    ...
    def getFocusListeners(
        self,
    ) -> typing.MutableSequence[java.awt.event.FocusListener]: ...
    ...
    def getHeight(self) -> int: ...
    def getHierarchyBoundsListeners(
        self,
    ) -> typing.MutableSequence[java.awt.event.HierarchyBoundsListener]: ...
    def getHierarchyListeners(
        self,
    ) -> typing.MutableSequence[java.awt.event.HierarchyListener]: ...
    def getIgnoreRepaint(self) -> bool: ...
    def getInputContext(self) -> java.awt.im.InputContext: ...
    def getInputMethodListeners(
        self,
    ) -> typing.MutableSequence[java.awt.event.InputMethodListener]: ...
    ...
    def getListeners(
        self, class_: type[_getListeners__T]
    ) -> typing.MutableSequence[_getListeners__T]: ...
    ...
    def getMouseWheelListeners(
        self,
    ) -> typing.MutableSequence[java.awt.event.MouseWheelListener]: ...
    def getName(self) -> java.lang.String: ...
    ...
    def hide(self) -> None: ...
    def imageUpdate(
        self, image: Image, int: int, int2: int, int3: int, int4: int, int5: int
    ) -> bool: ...
    ...
    def removeFocusListener(
        self, focusListener: java.awt.event.FocusListener
    ) -> None: ...
    def removeHierarchyBoundsListener(
        self, hierarchyBoundsListener: java.awt.event.HierarchyBoundsListener
    ) -> None: ...
    def removeHierarchyListener(
        self, hierarchyListener: java.awt.event.HierarchyListener | typing.Callable
    ) -> None: ...
    def removeInputMethodListener(
        self, inputMethodListener: java.awt.event.InputMethodListener
    ) -> None: ...
    ...
    def setFocusTraversalKeys(
        self, int: int, set: java.util.Set[AWTKeyStroke]
    ) -> None: ...
...
class Graphics2D(Graphics):
    ...
    def drawGlyphVector(
        self, glyphVector: java.awt.font.GlyphVector, float: float, float2: float
    ) -> None: ...
    @typing.overload
    def drawImage(
        self,
    ...
    def setBackground(self, color: Color) -> None: ...
    def setComposite(self, composite: Composite | typing.Callable) -> None: ...
    ...
    def setStroke(self, stroke: Stroke | typing.Callable) -> None: ...
...
class KeyboardFocusManager(KeyEventDispatcher, KeyEventPostProcessor):
    ...
    def __init__(self): ...
    def addKeyEventDispatcher(
        self, keyEventDispatcher: KeyEventDispatcher | typing.Callable
    ) -> None: ...
    def addKeyEventPostProcessor(
        self, keyEventPostProcessor: KeyEventPostProcessor | typing.Callable
    ) -> None: ...
    @typing.overload
    def addPropertyChangeListener(
        self,
    ...
    def addVetoableChangeListener(
        self,
        vetoableChangeListener: java.beans.VetoableChangeListener | typing.Callable,
    ) -> None: ...
    @typing.overload
    def addVetoableChangeListener(
        self,
    ...
    def getVetoableChangeListeners(
        self,
    ) -> typing.MutableSequence[java.beans.VetoableChangeListener]: ...
    @typing.overload
    def getVetoableChangeListeners(
        self, string: java.lang.String | str
    ) -> typing.MutableSequence[java.beans.VetoableChangeListener]: ...
    def postProcessKeyEvent(self, keyEvent: java.awt.event.KeyEvent) -> bool: ...
    def processKeyEvent(
        self, component: Component, keyEvent: java.awt.event.KeyEvent
    ) -> None: ...
    def redispatchEvent(self, component: Component, aWTEvent: AWTEvent) -> None: ...
    def removeKeyEventDispatcher(
        self, keyEventDispatcher: KeyEventDispatcher | typing.Callable
    ) -> None: ...
    def removeKeyEventPostProcessor(
        self, keyEventPostProcessor: KeyEventPostProcessor | typing.Callable
    ) -> None: ...
    @typing.overload
    def removePropertyChangeListener(
    ...
    @staticmethod
    def setCurrentKeyboardFocusManager(
        keyboardFocusManager: KeyboardFocusManager,
    ) -> None: ...
    def setDefaultFocusTraversalKeys(
        self, int: int, set: java.util.Set[AWTKeyStroke]
    ) -> None: ...
    def setDefaultFocusTraversalPolicy(
        self, focusTraversalPolicy: FocusTraversalPolicy
    ) -> None: ...
...
class MenuItem(MenuComponent, javax.accessibility.Accessible):
    ...
    def __init__(self, string: java.lang.String | str): ...
    @typing.overload
    def __init__(self, string: java.lang.String | str, menuShortcut: MenuShortcut): ...
    def addActionListener(
        self, actionListener: java.awt.event.ActionListener | typing.Callable
    ) -> None: ...
    def addNotify(self) -> None: ...
    ...
    def setActionCommand(self, string: java.lang.String | str) -> None: ...
    def setEnabled(self, boolean: bool) -> None: ...
    def setLabel(self, string: java.lang.String | str) -> None: ...
...
class Rectangle(java.awt.geom.Rectangle2D, Shape, java.io.Serializable):
    ...
    def createIntersection(
        self, rectangle2D: java.awt.geom.Rectangle2D
    ) -> java.awt.geom.Rectangle2D: ...
    def createUnion(
        self, rectangle2D: java.awt.geom.Rectangle2D
    ) -> java.awt.geom.Rectangle2D: ...
...
class ScrollPaneAdjustable(Adjustable, java.io.Serializable):
    ...
    def getAdjustmentListeners(
        self,
    ) -> typing.MutableSequence[java.awt.event.AdjustmentListener]: ...
    def getBlockIncrement(self) -> int: ...
    def getMaximum(self) -> int: ...
    def getMinimum(self) -> int: ...
    def getOrientation(self) -> int: ...
...
class BorderLayout(LayoutManager2, java.io.Serializable):
    NORTH: typing.ClassVar[java.lang.String] = ...
    SOUTH: typing.ClassVar[java.lang.String] = ...
    EAST: typing.ClassVar[java.lang.String] = ...
    WEST: typing.ClassVar[java.lang.String] = ...
    CENTER: typing.ClassVar[java.lang.String] = ...
    BEFORE_FIRST_LINE: typing.ClassVar[java.lang.String] = ...
    AFTER_LAST_LINE: typing.ClassVar[java.lang.String] = ...
    BEFORE_LINE_BEGINS: typing.ClassVar[java.lang.String] = ...
    AFTER_LINE_ENDS: typing.ClassVar[java.lang.String] = ...
    PAGE_START: typing.ClassVar[java.lang.String] = ...
    PAGE_END: typing.ClassVar[java.lang.String] = ...
    LINE_START: typing.ClassVar[java.lang.String] = ...
    LINE_END: typing.ClassVar[java.lang.String] = ...
    @typing.overload
    def __init__(self): ...
    @typing.overload
    def __init__(self, int: int, int2: int): ...
    ...
    def getLayoutComponent(
        self, container: Container, object: typing.Any
    ) -> Component: ...
    @typing.overload
...
class Canvas(Component, javax.accessibility.Accessible):
    ...
    @typing.overload
    def createBufferStrategy(
        self, int: int, bufferCapabilities: BufferCapabilities
    ) -> None: ...
    def getAccessibleContext(self) -> javax.accessibility.AccessibleContext: ...
...
class CardLayout(LayoutManager2, java.io.Serializable):
    ...
    def setHgap(self, int: int) -> None: ...
    def setVgap(self, int: int) -> None: ...
    def show(self, container: Container, string: java.lang.String | str) -> None: ...
    def toString(self) -> java.lang.String: ...
...
class Checkbox(Component, ItemSelectable, javax.accessibility.Accessible):
    ...
    def getItemListeners(
        self,
    ) -> typing.MutableSequence[java.awt.event.ItemListener]: ...
    def getLabel(self) -> java.lang.String: ...
    _getListeners__T = typing.TypeVar(
        "_getListeners__T", bound=java.util.EventListener
    )  # <T>
...
class Choice(Component, ItemSelectable, javax.accessibility.Accessible):
    def __init__(self): ...
    @typing.overload
    def add(self, string: java.lang.String | str) -> None: ...
    @typing.overload
    def add(self, popupMenu: PopupMenu) -> None: ...
    def addItem(self, string: java.lang.String | str) -> None: ...
    def addItemListener(
        self, itemListener: java.awt.event.ItemListener | typing.Callable
    ) -> None: ...
    def addNotify(self) -> None: ...
    ...
    def getAccessibleContext(self) -> javax.accessibility.AccessibleContext: ...
    def getItem(self, int: int) -> java.lang.String: ...
    ...
    def getSelectedItem(self) -> java.lang.String: ...
    def getSelectedObjects(self) -> typing.MutableSequence[typing.Any]: ...
    def insert(self, string: java.lang.String | str, int: int) -> None: ...
    @typing.overload
    def remove(self, int: int) -> None: ...
    @typing.overload
    ...
    @typing.overload
    def select(self, string: java.lang.String | str) -> None: ...
...
class Color(Paint, java.io.Serializable):
    ...
    @staticmethod
    def RGBtoHSB(
        int: int, int2: int, int3: int, floatArray: list[float] | jpype.JArray
    ...
    @staticmethod
    def decode(string: java.lang.String | str) -> Color: ...
    def equals(self, object: typing.Any) -> bool: ...
    def getAlpha(self) -> int: ...
    def getBlue(self) -> int: ...
    @typing.overload
    @staticmethod
    def getColor(string: java.lang.String | str) -> Color: ...
    @typing.overload
    @staticmethod
    def getColor(string: java.lang.String | str, int: int) -> Color: ...
    @typing.overload
    @staticmethod
    def getColor(string: java.lang.String | str, color: Color) -> Color: ...
    @typing.overload
    def getColorComponents(
...
class Container(Component):
    ...
    def addContainerListener(
        self, containerListener: java.awt.event.ContainerListener
    ) -> None: ...
    def addNotify(self) -> None: ...
    @typing.overload
    def addPropertyChangeListener(
    ...
    def getContainerListeners(
        self,
    ) -> typing.MutableSequence[java.awt.event.ContainerListener]: ...
    def getFocusTraversalKeys(self, int: int) -> java.util.Set[AWTKeyStroke]: ...
...
class GradientPaint(Paint):
    ...
    def __init__(
        ...
        color: Color,
        point2D2: java.awt.geom.Point2D,
        color2: Color,
    ): ...
    @typing.overload
    def __init__(
...
class GridBagLayout(LayoutManager2, java.io.Serializable):
    ...
    def removeLayoutComponent(self, component: Component) -> None: ...
    def setConstraints(
        self, component: Component, gridBagConstraints: GridBagConstraints
    ) -> None: ...
    def toString(self) -> java.lang.String: ...
...
class List(Component, ItemSelectable, javax.accessibility.Accessible):
    ...
    def add(self, string: java.lang.String | str) -> None: ...
    @typing.overload
    def add(self, string: java.lang.String | str, int: int) -> None: ...
    def addActionListener(
        self, actionListener: java.awt.event.ActionListener | typing.Callable
    ) -> None: ...
    @typing.overload
    def addItem(self, string: java.lang.String | str, int: int) -> None: ...
    @typing.overload
    def addItem(self, string: java.lang.String | str) -> None: ...
    def addItemListener(
        self, itemListener: java.awt.event.ItemListener | typing.Callable
    ...
    def getItems(self) -> typing.MutableSequence[java.lang.String]: ...
    _getListeners__T = typing.TypeVar(
        "_getListeners__T", bound=java.util.EventListener
    )  # <T>
    def getListeners(
    ...
    def getSelectedItem(self) -> java.lang.String: ...
    def getSelectedItems(self) -> typing.MutableSequence[java.lang.String]: ...
    def getSelectedObjects(self) -> typing.MutableSequence[typing.Any]: ...
    ...
    def removeNotify(self) -> None: ...
    def replaceItem(self, string: java.lang.String | str, int: int) -> None: ...
    def select(self, int: int) -> None: ...
...
class TextComponent(Component, javax.accessibility.Accessible):
    def addNotify(self) -> None: ...
    def addTextListener(
        self, textListener: java.awt.event.TextListener | typing.Callable
    ) -> None: ...
    def enableInputMethods(self, boolean: bool) -> None: ...
    def getAccessibleContext(self) -> javax.accessibility.AccessibleContext: ...
    def getBackground(self) -> Color: ...
    ...
    def getSelectedText(self) -> java.lang.String: ...
    def getSelectionEnd(self) -> int: ...
    def getSelectionStart(self) -> int: ...
    def getText(self) -> java.lang.String: ...
    def getTextListeners(
        self,
    ) -> typing.MutableSequence[java.awt.event.TextListener]: ...
    def isEditable(self) -> bool: ...
    def removeNotify(self) -> None: ...
    def removeTextListener(
        self, textListener: java.awt.event.TextListener | typing.Callable
    ) -> None: ...
...
class LinearGradientPaint(MultipleGradientPaint):
    ...
    def __init__(
        ...
        float4: float,
        floatArray: list[float] | jpype.JArray,
        colorArray: list[Color] | jpype.JArray,
    ): ...
    @typing.overload
    def __init__(
        self,
...
class TextArea(TextComponent):
    ...
    def addNotify(self) -> None: ...
    def append(self, string: java.lang.String | str) -> None: ...
    def appendText(self, string: java.lang.String | str) -> None: ...
    def getAccessibleContext(self) -> javax.accessibility.AccessibleContext: ...
    def getColumns(self) -> int: ...
    @typing.overload
    def getMinimumSize(self) -> Dimension: ...
    ...
    def insert(self, string: java.lang.String | str, int: int) -> None: ...
    def insertText(self, string: java.lang.String | str, int: int) -> None: ...
    @typing.overload
    def minimumSize(self) -> Dimension: ...
    @typing.overload
...
class Window(Container, javax.accessibility.Accessible):
    ...
    @typing.overload
    def __init__(
        self, window: Window, graphicsConfiguration: GraphicsConfiguration
    ): ...
    def addNotify(self) -> None: ...
    @typing.overload
    def addPropertyChangeListener(
    ...
    def addWindowFocusListener(
        self, windowFocusListener: java.awt.event.WindowFocusListener
    ) -> None: ...
    def addWindowListener(
        self, windowListener: java.awt.event.WindowListener
    ) -> None: ...
    def addWindowStateListener(
        self, windowStateListener: java.awt.event.WindowStateListener | typing.Callable
    ) -> None: ...
    @typing.overload
    def applyResourceBundle(self, string: java.lang.String | str) -> None: ...
    @typing.overload
    ...
    def getWarningString(self) -> java.lang.String: ...
    def getWindowFocusListeners(
        self,
    ) -> typing.MutableSequence[java.awt.event.WindowFocusListener]: ...
    def getWindowListeners(
        self,
    ) -> typing.MutableSequence[java.awt.event.WindowListener]: ...
    def getWindowStateListeners(
        self,
    ) -> typing.MutableSequence[java.awt.event.WindowStateListener]: ...
    @staticmethod
    ...
    def postEvent(self, event: Event) -> bool: ...
    def removeNotify(self) -> None: ...
    def removeWindowFocusListener(
        self, windowFocusListener: java.awt.event.WindowFocusListener
    ) -> None: ...
    def removeWindowListener(
        self, windowListener: java.awt.event.WindowListener
    ) -> None: ...
    def removeWindowStateListener(
        self, windowStateListener: java.awt.event.WindowStateListener | typing.Callable
    ) -> None: ...
    def reshape(self, int: int, int2: int, int3: int, int4: int) -> None: ...
    ...
    class Type(java.lang.Enum["Window.Type"]):
        ...
        @typing.overload
        @staticmethod
        def valueOf(string: java.lang.String | str) -> Window.Type: ...
        @typing.overload
        @staticmethod
        def valueOf(
            class_: type[_valueOf_1__T], string: java.lang.String | str
...
class Dialog(Window):
    ...
    @typing.overload
    def __init__(self, dialog: Dialog, string: java.lang.String | str): ...
    @typing.overload
    def __init__(
        self, dialog: Dialog, string: java.lang.String | str, boolean: bool
    ): ...
    @typing.overload
    def __init__(
        self,
    ...
    @typing.overload
    def __init__(self, frame: Frame, string: java.lang.String | str): ...
    @typing.overload
    def __init__(self, frame: Frame, string: java.lang.String | str, boolean: bool): ...
    @typing.overload
    def __init__(
        self,
        frame: Frame,
    ...
    @typing.overload
    def __init__(self, window: Window, string: java.lang.String | str): ...
    @typing.overload
    def __init__(
        self,
        window: Window,
    ...
    class ModalExclusionType(java.lang.Enum["Dialog.ModalExclusionType"]):
        ...
        @typing.overload
        @staticmethod
        def valueOf(string: java.lang.String | str) -> Dialog.ModalExclusionType: ...
        @typing.overload
        @staticmethod
        def valueOf(
            class_: type[_valueOf_1__T], string: java.lang.String | str
    ...
    class ModalityType(java.lang.Enum["Dialog.ModalityType"]):
        ...
        @typing.overload
        @staticmethod
        def valueOf(string: java.lang.String | str) -> Dialog.ModalityType: ...
        @typing.overload
        @staticmethod
        def valueOf(
            class_: type[_valueOf_1__T], string: java.lang.String | str
...
class FileDialog(Dialog):
    ...
    def __init__(self, dialog: Dialog, string: java.lang.String | str): ...
    @typing.overload
    def __init__(self, dialog: Dialog, string: java.lang.String | str, int: int): ...
    @typing.overload
    def __init__(self, frame: Frame): ...
    @typing.overload
    def __init__(self, frame: Frame, string: java.lang.String | str): ...
    @typing.overload
    def __init__(self, frame: Frame, string: java.lang.String | str, int: int): ...
    def addNotify(self) -> None: ...
    def getDirectory(self) -> java.lang.String: ...
    ...
    def isMultipleMode(self) -> bool: ...
    def setDirectory(self, string: java.lang.String | str) -> None: ...
    def setFile(self, string: java.lang.String | str) -> None: ...
    def setFilenameFilter(
        self, filenameFilter: java.io.FilenameFilter | typing.Callable
    ) -> None: ...
...
class BufferCapabilities(java.lang.Cloneable):
    def __init__(
        ...
        imageCapabilities2: ImageCapabilities,
        flipContents: BufferCapabilities.FlipContents,
    ): ...
    def clone(self) -> typing.Any: ...
...
class JobAttributes(java.lang.Cloneable):
    ...
    def __init__(
        self,
        int: int,
        defaultSelectionType: JobAttributes.DefaultSelectionType,
        destinationType: JobAttributes.DestinationType,
        dialogType: JobAttributes.DialogType,
        string: java.lang.String | str,
        int2: int,
        int3: int,
        multipleDocumentHandlingType: JobAttributes.MultipleDocumentHandlingType,
        intArray: list[typing.MutableSequence[int]] | jpype.JArray,
        string2: java.lang.String | str,
        sidesType: JobAttributes.SidesType,
    ): ...
    @typing.overload
    ...
    def setDefaultSelection(
        self, defaultSelectionType: JobAttributes.DefaultSelectionType
    ) -> None: ...
    def setDestination(
        self, destinationType: JobAttributes.DestinationType
    ) -> None: ...
    def setDialog(self, dialogType: JobAttributes.DialogType) -> None: ...
    def setFileName(self, string: java.lang.String | str) -> None: ...
    def setFromPage(self, int: int) -> None: ...
    def setMaxPage(self, int: int) -> None: ...
    def setMinPage(self, int: int) -> None: ...
    def setMultipleDocumentHandling(
        self, multipleDocumentHandlingType: JobAttributes.MultipleDocumentHandlingType
    ) -> None: ...
    def setMultipleDocumentHandlingToDefault(self) -> None: ...
    def setPageRanges(
        self, intArray: list[typing.MutableSequence[int]] | jpype.JArray
    ) -> None: ...
    def setPrinter(self, string: java.lang.String | str) -> None: ...
    ...
    class MultipleDocumentHandlingType(java.awt.AttributeValue):
        SEPARATE_DOCUMENTS_COLLATED_COPIES: typing.ClassVar[
            JobAttributes.MultipleDocumentHandlingType
        ] = ...
        SEPARATE_DOCUMENTS_UNCOLLATED_COPIES: typing.ClassVar[
            JobAttributes.MultipleDocumentHandlingType
        ] = ...
...
class PageAttributes(java.lang.Cloneable):
    ...
    def __init__(
        self,
        colorType: PageAttributes.ColorType,
        mediaType: PageAttributes.MediaType,
        orientationRequestedType: PageAttributes.OrientationRequestedType,
        originType: PageAttributes.OriginType,
        printQualityType: PageAttributes.PrintQualityType,
        intArray: list[int] | jpype.JArray,
    ): ...
    @typing.overload
    ...
    @typing.overload
    def setOrientationRequested(
        self, orientationRequestedType: PageAttributes.OrientationRequestedType
    ) -> None: ...
    ...
    @typing.overload
    def setPrintQuality(
        self, printQualityType: PageAttributes.PrintQualityType
    ) -> None: ...
    def setPrintQualityToDefault(self) -> None: ...
    @typing.overload
    def setPrinterResolution(self, int: int) -> None: ...
    @typing.overload
    def setPrinterResolution(self, intArray: list[int] | jpype.JArray) -> None: ...
...
class __module_protocol__(Protocol):
    ...
    AWTError: type[AWTError]
    AWTEvent: type[AWTEvent]
    AWTEventMulticaster: type[AWTEventMulticaster]
    AWTException: type[AWTException]
    AWTKeyStroke: type[AWTKeyStroke]
    AWTPermission: type[AWTPermission]
    ActiveEvent: type[ActiveEvent]
    Adjustable: type[Adjustable]
    AlphaComposite: type[AlphaComposite]
    AttributeValue: type[AttributeValue]
    BasicStroke: type[BasicStroke]
    BorderLayout: type[BorderLayout]
    BufferCapabilities: type[BufferCapabilities]
    Button: type[Button]
    Canvas: type[Canvas]
    CardLayout: type[CardLayout]
    Checkbox: type[Checkbox]
    CheckboxGroup: type[CheckboxGroup]
    CheckboxMenuItem: type[CheckboxMenuItem]
    Choice: type[Choice]
    Color: type[Color]
    Component: type[Component]
    ComponentOrientation: type[ComponentOrientation]
    Composite: type[Composite]
    CompositeContext: type[CompositeContext]
    Container: type[Container]
    ContainerOrderFocusTraversalPolicy: type[ContainerOrderFocusTraversalPolicy]
    Cursor: type[Cursor]
    DefaultFocusTraversalPolicy: type[DefaultFocusTraversalPolicy]
    DefaultKeyboardFocusManager: type[DefaultKeyboardFocusManager]
    ...
    FlowLayout: type[FlowLayout]
    FocusTraversalPolicy: type[FocusTraversalPolicy]
    Font: type[Font]
    FontFormatException: type[FontFormatException]
    FontMetrics: type[FontMetrics]
    Frame: type[Frame]
    GradientPaint: type[GradientPaint]
    Graphics: type[Graphics]
    Graphics2D: type[Graphics2D]
    GraphicsConfigTemplate: type[GraphicsConfigTemplate]
    GraphicsConfiguration: type[GraphicsConfiguration]
    GraphicsDevice: type[GraphicsDevice]
    GraphicsEnvironment: type[GraphicsEnvironment]
    GridBagConstraints: type[GridBagConstraints]
    GridBagLayout: type[GridBagLayout]
    GridBagLayoutInfo: type[GridBagLayoutInfo]
    GridLayout: type[GridLayout]
    HeadlessException: type[HeadlessException]
    IllegalComponentStateException: type[IllegalComponentStateException]
    Image: type[Image]
    ImageCapabilities: type[ImageCapabilities]
    Insets: type[Insets]
    ItemSelectable: type[ItemSelectable]
    JobAttributes: type[JobAttributes]
    KeyEventDispatcher: type[KeyEventDispatcher]
    KeyEventPostProcessor: type[KeyEventPostProcessor]
    KeyboardFocusManager: type[KeyboardFocusManager]
    Label: type[Label]
    LayoutManager: type[LayoutManager]
    LayoutManager2: type[LayoutManager2]
    LinearGradientPaint: type[LinearGradientPaint]
    List: type[List]
    MediaTracker: type[MediaTracker]
    Menu: type[Menu]
    MenuBar: type[MenuBar]
    MenuComponent: type[MenuComponent]
    MenuContainer: type[MenuContainer]
    MenuItem: type[MenuItem]
    MenuShortcut: type[MenuShortcut]
    MouseInfo: type[MouseInfo]
    MultipleGradientPaint: type[MultipleGradientPaint]
    PageAttributes: type[PageAttributes]
    Paint: type[Paint]
    PaintContext: type[PaintContext]
    Panel: type[Panel]
    Point: type[Point]
    PointerInfo: type[PointerInfo]
    Polygon: type[Polygon]
    PopupMenu: type[PopupMenu]
    PrintGraphics: type[PrintGraphics]
    PrintJob: type[PrintJob]
    RadialGradientPaint: type[RadialGradientPaint]
    Rectangle: type[Rectangle]
    RenderingHints: type[RenderingHints]
    Robot: type[Robot]
    ScrollPane: type[ScrollPane]
    ScrollPaneAdjustable: type[ScrollPaneAdjustable]
    Scrollbar: type[Scrollbar]
    SecondaryLoop: type[SecondaryLoop]
    Shape: type[Shape]
    SplashScreen: type[SplashScreen]
    Stroke: type[Stroke]
    SystemColor: type[SystemColor]
    SystemTray: type[SystemTray]
    Taskbar: type[Taskbar]
    TextArea: type[TextArea]
    TextComponent: type[TextComponent]
    TextField: type[TextField]
    TexturePaint: type[TexturePaint]
    Toolkit: type[Toolkit]
    Transparency: type[Transparency]
    TrayIcon: type[TrayIcon]
    Window: type[Window]
