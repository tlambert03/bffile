...
class AbstractSelectableChannel(java.nio.channels.SelectableChannel):
    ...
    @typing.overload
    def register(
        self, selector: java.nio.channels.Selector, int: int
    ) -> java.nio.channels.SelectionKey: ...
    @typing.overload
    def register(
        self, selector: java.nio.channels.Selector, int: int, object: typing.Any
    ) -> java.nio.channels.SelectionKey: ...
...
class AsynchronousChannelProvider:
    @typing.overload
    def openAsynchronousChannelGroup(
        self,
        int: int,
    ...
    @typing.overload
    def openAsynchronousChannelGroup(
        self, executorService: java.util.concurrent.ExecutorService, int: int
    ) -> java.nio.channels.AsynchronousChannelGroup: ...
    def openAsynchronousServerSocketChannel(
        self, asynchronousChannelGroup: java.nio.channels.AsynchronousChannelGroup
    ) -> java.nio.channels.AsynchronousServerSocketChannel: ...
    def openAsynchronousSocketChannel(
        self, asynchronousChannelGroup: java.nio.channels.AsynchronousChannelGroup
...
class SelectorProvider:
    ...
    def openDatagramChannel(
        self, protocolFamily: java.net.ProtocolFamily | typing.Callable
...
class __module_protocol__(Protocol):
    ...
    AbstractInterruptibleChannel: type[AbstractInterruptibleChannel]
    AbstractSelectableChannel: type[AbstractSelectableChannel]
    AbstractSelectionKey: type[AbstractSelectionKey]
    AbstractSelector: type[AbstractSelector]
    AsynchronousChannelProvider: type[AsynchronousChannelProvider]
    SelectorProvider: type[SelectorProvider]
