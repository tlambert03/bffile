...
class __module_protocol__(Protocol):
    ...
    UNITS: type[UNITS]
    quantity: ome.units.quantity.__module_protocol__
    unit: ome.units.unit.__module_protocol__
