...
class OMEModel:
    def addModelObject(
        self, string: java.lang.String | str, oMEModelObject: OMEModelObject
    ) -> OMEModelObject: ...
    def addReference(
        self, oMEModelObject: OMEModelObject, reference: Reference
    ) -> bool: ...
    def getModelObject(self, string: java.lang.String | str) -> OMEModelObject: ...
    def getModelObjects(self) -> java.util.Map[java.lang.String, OMEModelObject]: ...
    def getReferences(
        self,
    ) -> java.util.Map[OMEModelObject, java.util.List[Reference]]: ...
    def removeModelObject(self, string: java.lang.String | str) -> OMEModelObject: ...
...
class ReferenceList(
    java.util.ArrayList[_ReferenceList__T], typing.Generic[_ReferenceList__T]
):
    @typing.overload
    def __init__(self): ...
    @typing.overload
    def __init__(
        self,
        collection: java.util.Collection[_ReferenceList__T]
        | typing.Sequence[_ReferenceList__T]
        | builtins.set[_ReferenceList__T],
    ): ...
    @typing.overload
...
class AbstractOMEModelObject(OMEModelObject):
    ...
    def asXMLElement(self, document: org.w3c.dom.Document) -> org.w3c.dom.Element: ...
    @staticmethod
    def getChildrenByTagName(
        element: org.w3c.dom.Element, string: java.lang.String | str
    ) -> java.util.List[org.w3c.dom.Element]: ...
    def link(self, reference: Reference, oMEModelObject: OMEModelObject) -> bool: ...
    @staticmethod
    def stripNamespacePrefix(string: java.lang.String | str) -> java.lang.String: ...
    def update(self, element: org.w3c.dom.Element, oMEModel: OMEModel) -> None: ...
...
class AffineTransform(AbstractOMEModelObject):
    ...
    @typing.overload
    def asXMLElement(
        self, document: org.w3c.dom.Document, element: org.w3c.dom.Element
    ) -> org.w3c.dom.Element: ...
    @staticmethod
...
class Annotation(AbstractOMEModelObject):
    ...
    def setAnnotator(self, string: java.lang.String | str) -> None: ...
    def setDescription(self, string: java.lang.String | str) -> None: ...
    ...
    def setLinkedExperimenter(
        self, int: int, experimenter: Experimenter
    ) -> Experimenter: ...
    def setLinkedExperimenterGroup(
        self, int: int, experimenterGroup: ExperimenterGroup
    ) -> ExperimenterGroup: ...
    ...
    def setLinkedLightSource(
        self, int: int, lightSource: LightSource
    ) -> LightSource: ...
    ...
    def setLinkedPlateAcquisition(
        self, int: int, plateAcquisition: PlateAcquisition
    ) -> PlateAcquisition: ...
    ...
    def setNamespace(self, string: java.lang.String | str) -> None: ...
...
class BinData(AbstractOMEModelObject):
    ...
    def getBase64Binary(self) -> typing.MutableSequence[int]: ...
    def getBigEndian(self) -> bool: ...
    def getCompression(self) -> ome.xml.model.enums.Compression: ...
    def getLength(self) -> ome.xml.model.primitives.NonNegativeLong: ...
    def getPixels(self) -> Pixels: ...
    def link(self, reference: Reference, oMEModelObject: OMEModelObject) -> bool: ...
    def setBase64Binary(self, byteArray: list[int] | jpype.JArray | bytes) -> None: ...
    def setBigEndian(self, boolean: bool) -> None: ...
    def setCompression(self, compression: ome.xml.model.enums.Compression) -> None: ...
    def setLength(
        self, nonNegativeLong: ome.xml.model.primitives.NonNegativeLong
    ) -> None: ...
...
class BinaryFile(AbstractOMEModelObject):
    ...
    def getSize(self) -> ome.xml.model.primitives.NonNegativeLong: ...
    def link(self, reference: Reference, oMEModelObject: OMEModelObject) -> bool: ...
    ...
    def setMIMEType(self, string: java.lang.String | str) -> None: ...
    def setSize(
        self, nonNegativeLong: ome.xml.model.primitives.NonNegativeLong
    ) -> None: ...
    def update(self, element: org.w3c.dom.Element, oMEModel: OMEModel) -> None: ...
...
class BinaryOnly(AbstractOMEModelObject):
    ...
    def link(self, reference: Reference, oMEModelObject: OMEModelObject) -> bool: ...
    def setMetadataFile(self, string: java.lang.String | str) -> None: ...
...
class Channel(AbstractOMEModelObject):
    ...
    def copyLinkedAnnotationList(self) -> java.util.List[Annotation]: ...
    def getAcquisitionMode(self) -> ome.xml.model.enums.AcquisitionMode: ...
    def getColor(self) -> ome.xml.model.primitives.Color: ...
    def getContrastMethod(self) -> ome.xml.model.enums.ContrastMethod: ...
    def getDetectorSettings(self) -> DetectorSettings: ...
    def getEmissionWavelength(self) -> ome.units.quantity.Length: ...
    @staticmethod
    def getEmissionWavelengthUnitXsdDefault() -> java.lang.String: ...
    def getExcitationWavelength(self) -> ome.units.quantity.Length: ...
    @staticmethod
    def getExcitationWavelengthUnitXsdDefault() -> java.lang.String: ...
    def getFluor(self) -> java.lang.String: ...
    def getID(self) -> java.lang.String: ...
    def getIlluminationType(self) -> ome.xml.model.enums.IlluminationType: ...
    ...
    def getName(self) -> java.lang.String: ...
    def getPinholeSize(self) -> ome.units.quantity.Length: ...
    @staticmethod
    def getPinholeSizeUnitXsdDefault() -> java.lang.String: ...
    def getPixels(self) -> Pixels: ...
    def getPockelCellSetting(self) -> int: ...
    def getSamplesPerPixel(self) -> ome.xml.model.primitives.PositiveInteger: ...
    def link(self, reference: Reference, oMEModelObject: OMEModelObject) -> bool: ...
    def linkAnnotation(self, annotation: Annotation) -> bool: ...
    def linkFilterSet(self, filterSet: FilterSet) -> None: ...
    def setAcquisitionMode(
        self, acquisitionMode: ome.xml.model.enums.AcquisitionMode
    ) -> None: ...
    def setColor(self, color: ome.xml.model.primitives.Color) -> None: ...
    def setContrastMethod(
        self, contrastMethod: ome.xml.model.enums.ContrastMethod
    ) -> None: ...
    def setDetectorSettings(self, detectorSettings: DetectorSettings) -> None: ...
    def setEmissionWavelength(self, length: ome.units.quantity.Length) -> None: ...
    def setExcitationWavelength(self, length: ome.units.quantity.Length) -> None: ...
    def setFluor(self, string: java.lang.String | str) -> None: ...
    def setID(self, string: java.lang.String | str) -> None: ...
    def setIlluminationType(
        self, illuminationType: ome.xml.model.enums.IlluminationType
    ) -> None: ...
    ...
    def setPinholeSize(self, length: ome.units.quantity.Length) -> None: ...
    def setPixels(self, pixels: Pixels) -> None: ...
    def setPockelCellSetting(self, integer: int) -> None: ...
    def setSamplesPerPixel(
        self, positiveInteger: ome.xml.model.primitives.PositiveInteger
    ) -> None: ...
    def sizeOfLinkedAnnotationList(self) -> int: ...
    def unlinkAnnotation(self, annotation: Annotation) -> bool: ...
...
class Experiment(AbstractOMEModelObject):
    ...
    def clearMicrobeamManipulationList(self) -> None: ...
    def copyLinkedImageList(self) -> java.util.List[Image]: ...
    def copyMicrobeamManipulationList(
        self,
    ...
    def getType(self) -> ome.xml.model.enums.ExperimentType: ...
    def link(self, reference: Reference, oMEModelObject: OMEModelObject) -> bool: ...
    def linkExperimenter(self, experimenter: Experimenter) -> None: ...
    def linkImage(self, image: Image) -> bool: ...
    ...
    def setMicrobeamManipulation(
        self, int: int, microbeamManipulation: MicrobeamManipulation
    ) -> MicrobeamManipulation: ...
    def setType(self, experimentType: ome.xml.model.enums.ExperimentType) -> None: ...
    def sizeOfLinkedImageList(self) -> int: ...
...
class Experimenter(AbstractOMEModelObject):
    ...
    def copyLinkedExperimenterGroupList(self) -> java.util.List[ExperimenterGroup]: ...
    def copyLinkedImageList(self) -> java.util.List[Image]: ...
    def copyLinkedMicrobeamManipulationList(
        self,
    ) -> java.util.List[MicrobeamManipulation]: ...
    def copyLinkedProjectList(self) -> java.util.List[Project]: ...
    ...
    def linkExperimenterGroup(self, experimenterGroup: ExperimenterGroup) -> bool: ...
    def linkImage(self, image: Image) -> bool: ...
    def linkMicrobeamManipulation(
        self, microbeamManipulation: MicrobeamManipulation
    ) -> bool: ...
    def linkProject(self, project: Project) -> bool: ...
    def setEmail(self, string: java.lang.String | str) -> None: ...
    def setFirstName(self, string: java.lang.String | str) -> None: ...
    def setID(self, string: java.lang.String | str) -> None: ...
    def setInstitution(self, string: java.lang.String | str) -> None: ...
    def setLastName(self, string: java.lang.String | str) -> None: ...
    def setLinkedAnnotation(self, int: int, annotation: Annotation) -> Annotation: ...
    def setLinkedDataset(self, int: int, dataset: Dataset) -> Dataset: ...
    ...
    def setLinkedImage(self, int: int, image: Image) -> Image: ...
    def setLinkedMicrobeamManipulation(
        self, int: int, microbeamManipulation: MicrobeamManipulation
    ) -> MicrobeamManipulation: ...
    def setLinkedProject(self, int: int, project: Project) -> Project: ...
    def setMiddleName(self, string: java.lang.String | str) -> None: ...
    def setUserName(self, string: java.lang.String | str) -> None: ...
    def sizeOfLinkedAnnotationList(self) -> int: ...
    def sizeOfLinkedDatasetList(self) -> int: ...
    ...
    def unlinkExperimenterGroup(self, experimenterGroup: ExperimenterGroup) -> bool: ...
    def unlinkImage(self, image: Image) -> bool: ...
    def unlinkMicrobeamManipulation(
        self, microbeamManipulation: MicrobeamManipulation
    ) -> bool: ...
    def unlinkProject(self, project: Project) -> bool: ...
    def update(self, element: org.w3c.dom.Element, oMEModel: OMEModel) -> None: ...
...
class External(AbstractOMEModelObject):
    ...
    def link(self, reference: Reference, oMEModelObject: OMEModelObject) -> bool: ...
    def setCompression(self, compression: ome.xml.model.enums.Compression) -> None: ...
    def setSHA1(self, string: java.lang.String | str) -> None: ...
    def sethref(self, string: java.lang.String | str) -> None: ...
    def update(self, element: org.w3c.dom.Element, oMEModel: OMEModel) -> None: ...
...
class Image(AbstractOMEModelObject):
    ...
    def getAcquisitionDate(self) -> ome.xml.model.primitives.Timestamp: ...
    def getDescription(self) -> java.lang.String: ...
    def getID(self) -> java.lang.String: ...
    ...
    def setAcquisitionDate(
        self, timestamp: ome.xml.model.primitives.Timestamp
    ) -> None: ...
    def setDescription(self, string: java.lang.String | str) -> None: ...
    def setID(self, string: java.lang.String | str) -> None: ...
...
class ImagingEnvironment(AbstractOMEModelObject):
    ...
    def getAirPressure(self) -> ome.units.quantity.Pressure: ...
    @staticmethod
    def getAirPressureUnitXsdDefault() -> java.lang.String: ...
    def getCO2Percent(self) -> ome.xml.model.primitives.PercentFraction: ...
    def getHumidity(self) -> ome.xml.model.primitives.PercentFraction: ...
    def getMap(self) -> java.util.List[MapPair]: ...
    def getTemperature(self) -> ome.units.quantity.Temperature: ...
    @staticmethod
    def getTemperatureUnitXsdDefault() -> java.lang.String: ...
    def link(self, reference: Reference, oMEModelObject: OMEModelObject) -> bool: ...
    def setAirPressure(self, pressure: ome.units.quantity.Pressure) -> None: ...
    def setCO2Percent(
        self, percentFraction: ome.xml.model.primitives.PercentFraction
    ) -> None: ...
    def setHumidity(
        self, percentFraction: ome.xml.model.primitives.PercentFraction
    ) -> None: ...
    def setMap(self, list: java.util.List[MapPair]) -> None: ...
    def setTemperature(self, temperature: ome.units.quantity.Temperature) -> None: ...
    def update(self, element: org.w3c.dom.Element, oMEModel: OMEModel) -> None: ...
...
class Instrument(AbstractOMEModelObject):
    ...
    def clearDetectorList(self) -> None: ...
    def clearDichroicList(self) -> None: ...
    def clearFilterList(self) -> None: ...
    def clearFilterSetList(self) -> None: ...
    def clearLightSourceList(self) -> None: ...
    def clearObjectiveList(self) -> None: ...
...
class ManufacturerSpec(AbstractOMEModelObject):
    ...
    def link(self, reference: Reference, oMEModelObject: OMEModelObject) -> bool: ...
    def setLotNumber(self, string: java.lang.String | str) -> None: ...
    def setManufacturer(self, string: java.lang.String | str) -> None: ...
    def setModel(self, string: java.lang.String | str) -> None: ...
    def setSerialNumber(self, string: java.lang.String | str) -> None: ...
    def update(self, element: org.w3c.dom.Element, oMEModel: OMEModel) -> None: ...
...
class MicrobeamManipulation(AbstractOMEModelObject):
    ...
    def clearLightSourceSettingsList(self) -> None: ...
    ...
    def getLinkedImage(self, int: int) -> Image: ...
    def getLinkedROI(self, int: int) -> ROI: ...
    def getType(self) -> ome.xml.model.enums.MicrobeamManipulationType: ...
    def link(self, reference: Reference, oMEModelObject: OMEModelObject) -> bool: ...
    def linkExperimenter(self, experimenter: Experimenter) -> None: ...
    def linkImage(self, image: Image) -> bool: ...
    def linkROI(self, rOI: ROI) -> bool: ...
    def removeLightSourceSettings(
        self, lightSourceSettings: LightSourceSettings
    ) -> None: ...
    def setDescription(self, string: java.lang.String | str) -> None: ...
    ...
    def setID(self, string: java.lang.String | str) -> None: ...
    def setLightSourceSettings(
        self, int: int, lightSourceSettings: LightSourceSettings
    ) -> LightSourceSettings: ...
    def setLinkedImage(self, int: int, image: Image) -> Image: ...
    def setLinkedROI(self, int: int, rOI: ROI) -> ROI: ...
    def setType(
        self, microbeamManipulationType: ome.xml.model.enums.MicrobeamManipulationType
    ) -> None: ...
...
class OME(AbstractOMEModelObject):
    ...
    def clearExperimentList(self) -> None: ...
    def clearExperimenterGroupList(self) -> None: ...
    def clearExperimenterList(self) -> None: ...
    def clearFolderList(self) -> None: ...
    def clearImageList(self) -> None: ...
    def clearInstrumentList(self) -> None: ...
    def clearPlateList(self) -> None: ...
    def clearProjectList(self) -> None: ...
    def clearROIList(self) -> None: ...
    def clearScreenList(self) -> None: ...
...
class Pixels(AbstractOMEModelObject):
    ...
    def clearBinDataList(self) -> None: ...
    def clearChannelList(self) -> None: ...
    def clearPlaneList(self) -> None: ...
    def clearTiffDataList(self) -> None: ...
    ...
    def getDimensionOrder(self) -> ome.xml.model.enums.DimensionOrder: ...
    def getID(self) -> java.lang.String: ...
    def getInterleaved(self) -> bool: ...
    def getMetadataOnly(self) -> MetadataOnly: ...
    def getPhysicalSizeX(self) -> ome.units.quantity.Length: ...
    @staticmethod
    def getPhysicalSizeXUnitXsdDefault() -> java.lang.String: ...
    def getPhysicalSizeY(self) -> ome.units.quantity.Length: ...
    @staticmethod
    def getPhysicalSizeYUnitXsdDefault() -> java.lang.String: ...
    def getPhysicalSizeZ(self) -> ome.units.quantity.Length: ...
    @staticmethod
    def getPhysicalSizeZUnitXsdDefault() -> java.lang.String: ...
    def getPlane(self, int: int) -> Plane: ...
    def getSignificantBits(self) -> ome.xml.model.primitives.PositiveInteger: ...
    def getSizeC(self) -> ome.xml.model.primitives.PositiveInteger: ...
    def getSizeT(self) -> ome.xml.model.primitives.PositiveInteger: ...
    def getSizeX(self) -> ome.xml.model.primitives.PositiveInteger: ...
    def getSizeY(self) -> ome.xml.model.primitives.PositiveInteger: ...
    def getSizeZ(self) -> ome.xml.model.primitives.PositiveInteger: ...
    def getTiffData(self, int: int) -> TiffData: ...
    def getTimeIncrement(self) -> ome.units.quantity.Time: ...
    @staticmethod
    def getTimeIncrementUnitXsdDefault() -> java.lang.String: ...
    def getType(self) -> ome.xml.model.enums.PixelType: ...
    def link(self, reference: Reference, oMEModelObject: OMEModelObject) -> bool: ...
    ...
    def setDimensionOrder(
        self, dimensionOrder: ome.xml.model.enums.DimensionOrder
    ) -> None: ...
    def setID(self, string: java.lang.String | str) -> None: ...
    def setInterleaved(self, boolean: bool) -> None: ...
    def setMetadataOnly(self, metadataOnly: MetadataOnly) -> None: ...
    def setPhysicalSizeX(self, length: ome.units.quantity.Length) -> None: ...
    def setPhysicalSizeY(self, length: ome.units.quantity.Length) -> None: ...
    def setPhysicalSizeZ(self, length: ome.units.quantity.Length) -> None: ...
    ...
    def setTimeIncrement(self, time: ome.units.quantity.Time) -> None: ...
    def setType(self, pixelType: ome.xml.model.enums.PixelType) -> None: ...
...
class Plane(AbstractOMEModelObject):
    ...
    def copyLinkedAnnotationList(self) -> java.util.List[Annotation]: ...
    def getDeltaT(self) -> ome.units.quantity.Time: ...
    @staticmethod
    def getDeltaTUnitXsdDefault() -> java.lang.String: ...
    def getExposureTime(self) -> ome.units.quantity.Time: ...
    @staticmethod
    ...
    def getTheC(self) -> ome.xml.model.primitives.NonNegativeInteger: ...
    def getTheT(self) -> ome.xml.model.primitives.NonNegativeInteger: ...
    def getTheZ(self) -> ome.xml.model.primitives.NonNegativeInteger: ...
    def link(self, reference: Reference, oMEModelObject: OMEModelObject) -> bool: ...
    def linkAnnotation(self, annotation: Annotation) -> bool: ...
    def setDeltaT(self, time: ome.units.quantity.Time) -> None: ...
    def setExposureTime(self, time: ome.units.quantity.Time) -> None: ...
    def setHashSHA1(self, string: java.lang.String | str) -> None: ...
    def setLinkedAnnotation(self, int: int, annotation: Annotation) -> Annotation: ...
    def setPixels(self, pixels: Pixels) -> None: ...
    def setPositionX(self, length: ome.units.quantity.Length) -> None: ...
    def setPositionY(self, length: ome.units.quantity.Length) -> None: ...
    def setPositionZ(self, length: ome.units.quantity.Length) -> None: ...
    def setTheC(
        self, nonNegativeInteger: ome.xml.model.primitives.NonNegativeInteger
    ) -> None: ...
    def setTheT(
        self, nonNegativeInteger: ome.xml.model.primitives.NonNegativeInteger
    ) -> None: ...
...
class Plate(AbstractOMEModelObject):
    ...
    def clearPlateAcquisitionList(self) -> None: ...
    def clearWellList(self) -> None: ...
    def copyLinkedAnnotationList(self) -> java.util.List[Annotation]: ...
    def copyLinkedScreenList(self) -> java.util.List[Screen]: ...
    def copyPlateAcquisitionList(self) -> java.util.List[PlateAcquisition]: ...
    def copyWellList(self) -> java.util.List[Well]: ...
    def getColumnNamingConvention(self) -> ome.xml.model.enums.NamingConvention: ...
    def getColumns(self) -> ome.xml.model.primitives.PositiveInteger: ...
    def getDescription(self) -> java.lang.String: ...
    def getExternalIdentifier(self) -> java.lang.String: ...
    def getFieldIndex(self) -> ome.xml.model.primitives.NonNegativeInteger: ...
    def getID(self) -> java.lang.String: ...
    def getLinkedAnnotation(self, int: int) -> Annotation: ...
    def getLinkedScreen(self, int: int) -> Screen: ...
    def getName(self) -> java.lang.String: ...
    def getPlateAcquisition(self, int: int) -> PlateAcquisition: ...
    def getRowNamingConvention(self) -> ome.xml.model.enums.NamingConvention: ...
    def getRows(self) -> ome.xml.model.primitives.PositiveInteger: ...
    def getStatus(self) -> java.lang.String: ...
    def getWell(self, int: int) -> Well: ...
    def getWellOriginX(self) -> ome.units.quantity.Length: ...
    @staticmethod
    def getWellOriginXUnitXsdDefault() -> java.lang.String: ...
    def getWellOriginY(self) -> ome.units.quantity.Length: ...
    @staticmethod
    ...
    def setDescription(self, string: java.lang.String | str) -> None: ...
    def setExternalIdentifier(self, string: java.lang.String | str) -> None: ...
    def setFieldIndex(
        self, nonNegativeInteger: ome.xml.model.primitives.NonNegativeInteger
    ) -> None: ...
    def setID(self, string: java.lang.String | str) -> None: ...
    ...
    def setStatus(self, string: java.lang.String | str) -> None: ...
    def setWell(self, int: int, well: Well) -> Well: ...
    def setWellOriginX(self, length: ome.units.quantity.Length) -> None: ...
    def setWellOriginY(self, length: ome.units.quantity.Length) -> None: ...
    def sizeOfLinkedAnnotationList(self) -> int: ...
    def sizeOfLinkedScreenList(self) -> int: ...
...
class PlateAcquisition(AbstractOMEModelObject):
    ...
    def copyLinkedWellSampleList(self) -> java.util.List[WellSample]: ...
    def getDescription(self) -> java.lang.String: ...
    def getEndTime(self) -> ome.xml.model.primitives.Timestamp: ...
    def getID(self) -> java.lang.String: ...
    def getLinkedAnnotation(self, int: int) -> Annotation: ...
    def getLinkedWellSample(self, int: int) -> WellSample: ...
    def getMaximumFieldCount(self) -> ome.xml.model.primitives.PositiveInteger: ...
    def getName(self) -> java.lang.String: ...
    def getPlate(self) -> Plate: ...
    def getStartTime(self) -> ome.xml.model.primitives.Timestamp: ...
    def link(self, reference: Reference, oMEModelObject: OMEModelObject) -> bool: ...
    def linkAnnotation(self, annotation: Annotation) -> bool: ...
    def linkWellSample(self, wellSample: WellSample) -> bool: ...
    def setDescription(self, string: java.lang.String | str) -> None: ...
    def setEndTime(self, timestamp: ome.xml.model.primitives.Timestamp) -> None: ...
    def setID(self, string: java.lang.String | str) -> None: ...
    def setLinkedAnnotation(self, int: int, annotation: Annotation) -> Annotation: ...
    def setLinkedWellSample(self, int: int, wellSample: WellSample) -> WellSample: ...
    ...
    def setStartTime(self, timestamp: ome.xml.model.primitives.Timestamp) -> None: ...
    def sizeOfLinkedAnnotationList(self) -> int: ...
    def sizeOfLinkedWellSampleList(self) -> int: ...
    def unlinkAnnotation(self, annotation: Annotation) -> bool: ...
    def unlinkWellSample(self, wellSample: WellSample) -> bool: ...
...
class Reagent(AbstractOMEModelObject):
    ...
    def setLinkedWell(self, int: int, well: Well) -> Well: ...
    def setName(self, string: java.lang.String | str) -> None: ...
    def setReagentIdentifier(self, string: java.lang.String | str) -> None: ...
...
class Rights(AbstractOMEModelObject):
    ...
    def link(self, reference: Reference, oMEModelObject: OMEModelObject) -> bool: ...
    def setRightsHeld(self, string: java.lang.String | str) -> None: ...
    def setRightsHolder(self, string: java.lang.String | str) -> None: ...
    def update(self, element: org.w3c.dom.Element, oMEModel: OMEModel) -> None: ...
...
class Screen(AbstractOMEModelObject):
    ...
    def clearReagentList(self) -> None: ...
    def copyLinkedAnnotationList(self) -> java.util.List[Annotation]: ...
    def copyLinkedPlateList(self) -> java.util.List[Plate]: ...
    ...
    def setLinkedPlate(self, int: int, plate: Plate) -> Plate: ...
    def setName(self, string: java.lang.String | str) -> None: ...
    def setProtocolDescription(self, string: java.lang.String | str) -> None: ...
    def setProtocolIdentifier(self, string: java.lang.String | str) -> None: ...
    def setReagent(self, int: int, reagent: Reagent) -> Reagent: ...
    def setReagentSetDescription(self, string: java.lang.String | str) -> None: ...
    def setReagentSetIdentifier(self, string: java.lang.String | str) -> None: ...
    def setType(self, string: java.lang.String | str) -> None: ...
    def sizeOfLinkedAnnotationList(self) -> int: ...
    def sizeOfLinkedPlateList(self) -> int: ...
...
class Shape(AbstractOMEModelObject):
    ...
    def copyLinkedAnnotationList(self) -> java.util.List[Annotation]: ...
    def getFillColor(self) -> ome.xml.model.primitives.Color: ...
    def getFillRule(self) -> ome.xml.model.enums.FillRule: ...
    def getFontFamily(self) -> ome.xml.model.enums.FontFamily: ...
    def getFontSize(self) -> ome.units.quantity.Length: ...
    @staticmethod
    def getFontSizeUnitXsdDefault() -> java.lang.String: ...
    def getFontStyle(self) -> ome.xml.model.enums.FontStyle: ...
    def getID(self) -> java.lang.String: ...
    def getLinkedAnnotation(self, int: int) -> Annotation: ...
    def getLocked(self) -> bool: ...
    def getStrokeColor(self) -> ome.xml.model.primitives.Color: ...
    def getStrokeDashArray(self) -> java.lang.String: ...
    def getStrokeWidth(self) -> ome.units.quantity.Length: ...
    @staticmethod
    ...
    def link(self, reference: Reference, oMEModelObject: OMEModelObject) -> bool: ...
    def linkAnnotation(self, annotation: Annotation) -> bool: ...
    def setFillColor(self, color: ome.xml.model.primitives.Color) -> None: ...
    def setFillRule(self, fillRule: ome.xml.model.enums.FillRule) -> None: ...
    def setFontFamily(self, fontFamily: ome.xml.model.enums.FontFamily) -> None: ...
    def setFontSize(self, length: ome.units.quantity.Length) -> None: ...
    def setFontStyle(self, fontStyle: ome.xml.model.enums.FontStyle) -> None: ...
    def setID(self, string: java.lang.String | str) -> None: ...
    def setLinkedAnnotation(self, int: int, annotation: Annotation) -> Annotation: ...
    def setLocked(self, boolean: bool) -> None: ...
    def setStrokeColor(self, color: ome.xml.model.primitives.Color) -> None: ...
    def setStrokeDashArray(self, string: java.lang.String | str) -> None: ...
    def setStrokeWidth(self, length: ome.units.quantity.Length) -> None: ...
...
class StageLabel(AbstractOMEModelObject):
    ...
    def getName(self) -> java.lang.String: ...
    def getX(self) -> ome.units.quantity.Length: ...
    @staticmethod
    def getXUnitXsdDefault() -> java.lang.String: ...
    def getY(self) -> ome.units.quantity.Length: ...
    @staticmethod
    def getYUnitXsdDefault() -> java.lang.String: ...
    def getZ(self) -> ome.units.quantity.Length: ...
    @staticmethod
    def getZUnitXsdDefault() -> java.lang.String: ...
    def link(self, reference: Reference, oMEModelObject: OMEModelObject) -> bool: ...
    def setName(self, string: java.lang.String | str) -> None: ...
    def setX(self, length: ome.units.quantity.Length) -> None: ...
    def setY(self, length: ome.units.quantity.Length) -> None: ...
    def setZ(self, length: ome.units.quantity.Length) -> None: ...
    def update(self, element: org.w3c.dom.Element, oMEModel: OMEModel) -> None: ...
...
class StructuredAnnotations(AbstractOMEModelObject):
    ...
    def clearBooleanAnnotationList(self) -> None: ...
    def clearCommentAnnotationList(self) -> None: ...
    def clearDoubleAnnotationList(self) -> None: ...
    def clearFileAnnotationList(self) -> None: ...
    def clearListAnnotationList(self) -> None: ...
    def clearLongAnnotationList(self) -> None: ...
    def clearMapAnnotationList(self) -> None: ...
    def clearTagAnnotationList(self) -> None: ...
    def clearTermAnnotationList(self) -> None: ...
    def clearTimestampAnnotationList(self) -> None: ...
    def clearXMLAnnotationList(self) -> None: ...
    ...
    def removeTimestampAnnotation(
        self, timestampAnnotation: TimestampAnnotation
    ) -> None: ...
    def removeXMLAnnotation(self, xMLAnnotation: XMLAnnotation) -> None: ...
    def setBooleanAnnotation(
        self, int: int, booleanAnnotation: BooleanAnnotation
    ) -> BooleanAnnotation: ...
    def setCommentAnnotation(
        self, int: int, commentAnnotation: CommentAnnotation
    ) -> CommentAnnotation: ...
    def setDoubleAnnotation(
        self, int: int, doubleAnnotation: DoubleAnnotation
    ) -> DoubleAnnotation: ...
    def setFileAnnotation(
        self, int: int, fileAnnotation: FileAnnotation
    ) -> FileAnnotation: ...
    def setListAnnotation(
        self, int: int, listAnnotation: ListAnnotation
    ) -> ListAnnotation: ...
    def setLongAnnotation(
        self, int: int, longAnnotation: LongAnnotation
    ) -> LongAnnotation: ...
    def setMapAnnotation(
        self, int: int, mapAnnotation: MapAnnotation
    ) -> MapAnnotation: ...
    def setTagAnnotation(
        self, int: int, tagAnnotation: TagAnnotation
    ) -> TagAnnotation: ...
    def setTermAnnotation(
        self, int: int, termAnnotation: TermAnnotation
    ) -> TermAnnotation: ...
    def setTimestampAnnotation(
        self, int: int, timestampAnnotation: TimestampAnnotation
    ) -> TimestampAnnotation: ...
    def setXMLAnnotation(
        self, int: int, xMLAnnotation: XMLAnnotation
    ) -> XMLAnnotation: ...
...
class TiffData(AbstractOMEModelObject):
    ...
    def getFirstC(self) -> ome.xml.model.primitives.NonNegativeInteger: ...
    def getFirstT(self) -> ome.xml.model.primitives.NonNegativeInteger: ...
    def getFirstZ(self) -> ome.xml.model.primitives.NonNegativeInteger: ...
    def getIFD(self) -> ome.xml.model.primitives.NonNegativeInteger: ...
    def getPixels(self) -> Pixels: ...
    def getPlaneCount(self) -> ome.xml.model.primitives.NonNegativeInteger: ...
...
class TransmittanceRange(AbstractOMEModelObject):
    ...
    def getCutIn(self) -> ome.units.quantity.Length: ...
    def getCutInTolerance(self) -> ome.units.quantity.Length: ...
    @staticmethod
    def getCutInToleranceUnitXsdDefault() -> java.lang.String: ...
    @staticmethod
    def getCutInUnitXsdDefault() -> java.lang.String: ...
    def getCutOut(self) -> ome.units.quantity.Length: ...
    def getCutOutTolerance(self) -> ome.units.quantity.Length: ...
    @staticmethod
    def getCutOutToleranceUnitXsdDefault() -> java.lang.String: ...
    @staticmethod
    def getCutOutUnitXsdDefault() -> java.lang.String: ...
    def getTransmittance(self) -> ome.xml.model.primitives.PercentFraction: ...
    def link(self, reference: Reference, oMEModelObject: OMEModelObject) -> bool: ...
    def setCutIn(self, length: ome.units.quantity.Length) -> None: ...
    def setCutInTolerance(self, length: ome.units.quantity.Length) -> None: ...
    def setCutOut(self, length: ome.units.quantity.Length) -> None: ...
    def setCutOutTolerance(self, length: ome.units.quantity.Length) -> None: ...
...
class Well(AbstractOMEModelObject):
    ...
    def clearWellSampleList(self) -> None: ...
    def copyLinkedAnnotationList(self) -> java.util.List[Annotation]: ...
    def copyWellSampleList(self) -> java.util.List[WellSample]: ...
    def getColor(self) -> ome.xml.model.primitives.Color: ...
    def getColumn(self) -> ome.xml.model.primitives.NonNegativeInteger: ...
    ...
    def getPlate(self) -> Plate: ...
    def getRow(self) -> ome.xml.model.primitives.NonNegativeInteger: ...
    def getType(self) -> java.lang.String: ...
    ...
    def setExternalDescription(self, string: java.lang.String | str) -> None: ...
    def setExternalIdentifier(self, string: java.lang.String | str) -> None: ...
    def setID(self, string: java.lang.String | str) -> None: ...
    def setLinkedAnnotation(self, int: int, annotation: Annotation) -> Annotation: ...
    def setPlate(self, plate: Plate) -> None: ...
...
class WellSample(AbstractOMEModelObject):
    ...
    def copyLinkedPlateAcquisitionList(self) -> java.util.List[PlateAcquisition]: ...
    def getID(self) -> java.lang.String: ...
    def getIndex(self) -> ome.xml.model.primitives.NonNegativeInteger: ...
    ...
    @staticmethod
    def getPositionYUnitXsdDefault() -> java.lang.String: ...
    def getTimepoint(self) -> ome.xml.model.primitives.Timestamp: ...
    ...
    def setPositionX(self, length: ome.units.quantity.Length) -> None: ...
    def setPositionY(self, length: ome.units.quantity.Length) -> None: ...
    def setTimepoint(self, timestamp: ome.xml.model.primitives.Timestamp) -> None: ...
...
class Detector(ManufacturerSpec):
    ...
    def getType(self) -> ome.xml.model.enums.DetectorType: ...
    def getVoltage(self) -> ome.units.quantity.ElectricPotential: ...
    @staticmethod
    ...
    def setType(self, detectorType: ome.xml.model.enums.DetectorType) -> None: ...
    def setVoltage(
...
class Filter(ManufacturerSpec):
    ...
    def getType(self) -> ome.xml.model.enums.FilterType: ...
    def link(self, reference: Reference, oMEModelObject: OMEModelObject) -> bool: ...
    def linkAnnotation(self, annotation: Annotation) -> bool: ...
    ...
    def setFilterWheel(self, string: java.lang.String | str) -> None: ...
    def setID(self, string: java.lang.String | str) -> None: ...
    def setInstrument(self, instrument: Instrument) -> None: ...
    def setLinkedAnnotation(self, int: int, annotation: Annotation) -> Annotation: ...
    def setLinkedFilterSetEmissionFilter(
        self, int: int, filterSet: FilterSet
    ) -> FilterSet: ...
    def setLinkedFilterSetExcitationFilter(
        self, int: int, filterSet: FilterSet
    ) -> FilterSet: ...
    def setLinkedLightPathEmissionFilter(
        self, int: int, lightPath: LightPath
    ) -> LightPath: ...
    def setLinkedLightPathExcitationFilter(
        self, int: int, lightPath: LightPath
    ) -> LightPath: ...
    def setTransmittanceRange(self, transmittanceRange: TransmittanceRange) -> None: ...
    def setType(self, filterType: ome.xml.model.enums.FilterType) -> None: ...
    def sizeOfLinkedAnnotationList(self) -> int: ...
...
class LightSource(ManufacturerSpec):
    ...
    def getInstrument(self) -> Instrument: ...
    def getLinkedAnnotation(self, int: int) -> Annotation: ...
    def getPower(self) -> ome.units.quantity.Power: ...
    @staticmethod
    ...
    def setInstrument(self, instrument: Instrument) -> None: ...
    def setLinkedAnnotation(self, int: int, annotation: Annotation) -> Annotation: ...
    def setPower(self, power: ome.units.quantity.Power) -> None: ...
    def sizeOfLinkedAnnotationList(self) -> int: ...
    def unlinkAnnotation(self, annotation: Annotation) -> bool: ...
    def update(self, element: org.w3c.dom.Element, oMEModel: OMEModel) -> None: ...
...
class Line(Shape):
    ...
    def getMarkerEnd(self) -> ome.xml.model.enums.Marker: ...
    ...
    def link(self, reference: Reference, oMEModelObject: OMEModelObject) -> bool: ...
    def setMarkerEnd(self, marker: ome.xml.model.enums.Marker) -> None: ...
    def setMarkerStart(self, marker: ome.xml.model.enums.Marker) -> None: ...
...
class Microscope(ManufacturerSpec):
    ...
    def getType(self) -> ome.xml.model.enums.MicroscopeType: ...
    def link(self, reference: Reference, oMEModelObject: OMEModelObject) -> bool: ...
    def setType(self, microscopeType: ome.xml.model.enums.MicroscopeType) -> None: ...
    def update(self, element: org.w3c.dom.Element, oMEModel: OMEModel) -> None: ...
...
class Objective(ManufacturerSpec):
    ...
    def getCorrection(self) -> ome.xml.model.enums.Correction: ...
    def getID(self) -> java.lang.String: ...
    def getImmersion(self) -> ome.xml.model.enums.Immersion: ...
    def getInstrument(self) -> Instrument: ...
    def getIris(self) -> bool: ...
    def getLensNA(self) -> float: ...
    def getLinkedAnnotation(self, int: int) -> Annotation: ...
    def getNominalMagnification(self) -> float: ...
    def getWorkingDistance(self) -> ome.units.quantity.Length: ...
    @staticmethod
    def getWorkingDistanceUnitXsdDefault() -> java.lang.String: ...
    def link(self, reference: Reference, oMEModelObject: OMEModelObject) -> bool: ...
    def linkAnnotation(self, annotation: Annotation) -> bool: ...
    def setCalibratedMagnification(self, double: float) -> None: ...
    def setCorrection(self, correction: ome.xml.model.enums.Correction) -> None: ...
    def setID(self, string: java.lang.String | str) -> None: ...
    def setImmersion(self, immersion: ome.xml.model.enums.Immersion) -> None: ...
    def setInstrument(self, instrument: Instrument) -> None: ...
    def setIris(self, boolean: bool) -> None: ...
    def setLensNA(self, double: float) -> None: ...
    def setLinkedAnnotation(self, int: int, annotation: Annotation) -> Annotation: ...
    def setNominalMagnification(self, double: float) -> None: ...
    def setWorkingDistance(self, length: ome.units.quantity.Length) -> None: ...
    def sizeOfLinkedAnnotationList(self) -> int: ...
    def unlinkAnnotation(self, annotation: Annotation) -> bool: ...
    def update(self, element: org.w3c.dom.Element, oMEModel: OMEModel) -> None: ...
...
class Polygon(Shape):
    ...
    def link(self, reference: Reference, oMEModelObject: OMEModelObject) -> bool: ...
    def setPoints(self, string: java.lang.String | str) -> None: ...
    def update(self, element: org.w3c.dom.Element, oMEModel: OMEModel) -> None: ...
...
class Arc(LightSource):
    ...
    def getType(self) -> ome.xml.model.enums.ArcType: ...
    def link(self, reference: Reference, oMEModelObject: OMEModelObject) -> bool: ...
    def setType(self, arcType: ome.xml.model.enums.ArcType) -> None: ...
    def update(self, element: org.w3c.dom.Element, oMEModel: OMEModel) -> None: ...
...
class DetectorSettings(Settings):
    ...
    def getBinning(self) -> ome.xml.model.enums.Binning: ...
    def getDetector(self) -> Detector: ...
    def getGain(self) -> float: ...
    def getID(self) -> java.lang.String: ...
    def getIntegration(self) -> ome.xml.model.primitives.PositiveInteger: ...
    def getOffset(self) -> float: ...
    def getReadOutRate(self) -> ome.units.quantity.Frequency: ...
    @staticmethod
    ...
    def getZoom(self) -> float: ...
    def link(self, reference: Reference, oMEModelObject: OMEModelObject) -> bool: ...
    def setBinning(self, binning: ome.xml.model.enums.Binning) -> None: ...
    ...
    def setOffset(self, double: float) -> None: ...
    def setReadOutRate(self, frequency: ome.units.quantity.Frequency) -> None: ...
    def setVoltage(
        self, electricPotential: ome.units.quantity.ElectricPotential
    ) -> None: ...
    def setZoom(self, double: float) -> None: ...
...
class Filament(LightSource):
    ...
    def getType(self) -> ome.xml.model.enums.FilamentType: ...
    def link(self, reference: Reference, oMEModelObject: OMEModelObject) -> bool: ...
    def setType(self, filamentType: ome.xml.model.enums.FilamentType) -> None: ...
    def update(self, element: org.w3c.dom.Element, oMEModel: OMEModel) -> None: ...
...
class Laser(LightSource):
    ...
    def getFrequencyMultiplication(
        self,
    ) -> ome.xml.model.primitives.PositiveInteger: ...
    def getLaserMedium(self) -> ome.xml.model.enums.LaserMedium: ...
    def getLinkedPump(self) -> LightSource: ...
    def getPockelCell(self) -> bool: ...
    def getPulse(self) -> ome.xml.model.enums.Pulse: ...
    def getRepetitionRate(self) -> ome.units.quantity.Frequency: ...
    @staticmethod
    def getRepetitionRateUnitXsdDefault() -> java.lang.String: ...
    def getTuneable(self) -> bool: ...
    def getType(self) -> ome.xml.model.enums.LaserType: ...
    def getWavelength(self) -> ome.units.quantity.Length: ...
    @staticmethod
    ...
    def setLaserMedium(self, laserMedium: ome.xml.model.enums.LaserMedium) -> None: ...
    def setPockelCell(self, boolean: bool) -> None: ...
    def setPulse(self, pulse: ome.xml.model.enums.Pulse) -> None: ...
    def setRepetitionRate(self, frequency: ome.units.quantity.Frequency) -> None: ...
    def setTuneable(self, boolean: bool) -> None: ...
    def setType(self, laserType: ome.xml.model.enums.LaserType) -> None: ...
    def setWavelength(self, length: ome.units.quantity.Length) -> None: ...
...
class LightSourceSettings(Settings):
    ...
    def getAttenuation(self) -> ome.xml.model.primitives.PercentFraction: ...
    def getID(self) -> java.lang.String: ...
...
class TimestampAnnotation(BasicAnnotation):
    ...
    def getStructuredAnnotations(self) -> StructuredAnnotations: ...
    def getValue(self) -> ome.xml.model.primitives.Timestamp: ...
    def link(self, reference: Reference, oMEModelObject: OMEModelObject) -> bool: ...
    def setStructuredAnnotations(
        self, structuredAnnotations: StructuredAnnotations
    ) -> None: ...
    def setValue(self, timestamp: ome.xml.model.primitives.Timestamp) -> None: ...
    def update(self, element: org.w3c.dom.Element, oMEModel: OMEModel) -> None: ...
...
class __module_protocol__(Protocol):
    ...
    AbstractOMEModelObject: type[AbstractOMEModelObject]
    AffineTransform: type[AffineTransform]
    Annotation: type[Annotation]
    AnnotationRef: type[AnnotationRef]
    Arc: type[Arc]
    BasicAnnotation: type[BasicAnnotation]
    BinData: type[BinData]
    BinaryFile: type[BinaryFile]
    BinaryOnly: type[BinaryOnly]
    BooleanAnnotation: type[BooleanAnnotation]
    Channel: type[Channel]
    ChannelRef: type[ChannelRef]
    CommentAnnotation: type[CommentAnnotation]
    Dataset: type[Dataset]
    DatasetRef: type[DatasetRef]
    Detector: type[Detector]
    DetectorSettings: type[DetectorSettings]
    Dichroic: type[Dichroic]
    DichroicRef: type[DichroicRef]
    DoubleAnnotation: type[DoubleAnnotation]
    Ellipse: type[Ellipse]
    EmissionFilterRef: type[EmissionFilterRef]
    ExcitationFilterRef: type[ExcitationFilterRef]
    Experiment: type[Experiment]
    ExperimentRef: type[ExperimentRef]
    Experimenter: type[Experimenter]
    ExperimenterGroup: type[ExperimenterGroup]
    ExperimenterGroupRef: type[ExperimenterGroupRef]
    ExperimenterRef: type[ExperimenterRef]
    External: type[External]
    Filament: type[Filament]
    FileAnnotation: type[FileAnnotation]
    Filter: type[Filter]
    FilterRef: type[FilterRef]
    FilterSet: type[FilterSet]
    FilterSetRef: type[FilterSetRef]
    Folder: type[Folder]
    FolderRef: type[FolderRef]
    GenericExcitationSource: type[GenericExcitationSource]
    Image: type[Image]
    ImageRef: type[ImageRef]
    ImagingEnvironment: type[ImagingEnvironment]
    Instrument: type[Instrument]
    InstrumentRef: type[InstrumentRef]
    Label: type[Label]
    Laser: type[Laser]
    Leader: type[Leader]
    LightEmittingDiode: type[LightEmittingDiode]
    LightPath: type[LightPath]
    LightSource: type[LightSource]
    LightSourceSettings: type[LightSourceSettings]
    Line: type[Line]
    ListAnnotation: type[ListAnnotation]
    LongAnnotation: type[LongAnnotation]
    ManufacturerSpec: type[ManufacturerSpec]
    MapAnnotation: type[MapAnnotation]
    MapPair: type[MapPair]
    Mask: type[Mask]
    MetadataOnly: type[MetadataOnly]
    MicrobeamManipulation: type[MicrobeamManipulation]
    MicrobeamManipulationRef: type[MicrobeamManipulationRef]
    Microscope: type[Microscope]
    NumericAnnotation: type[NumericAnnotation]
    OME: type[OME]
    OMEModel: type[OMEModel]
    OMEModelImpl: type[OMEModelImpl]
    OMEModelObject: type[OMEModelObject]
    Objective: type[Objective]
    ObjectiveSettings: type[ObjectiveSettings]
    Pixels: type[Pixels]
    Plane: type[Plane]
    Plate: type[Plate]
    PlateAcquisition: type[PlateAcquisition]
    PlateRef: type[PlateRef]
    Point: type[Point]
    ...
    ReagentRef: type[ReagentRef]
    Rectangle: type[Rectangle]
    Reference: type[Reference]
    ReferenceList: type[ReferenceList]
    Rights: type[Rights]
    Screen: type[Screen]
    Settings: type[Settings]
    Shape: type[Shape]
    StageLabel: type[StageLabel]
    StructuredAnnotations: type[StructuredAnnotations]
    TagAnnotation: type[TagAnnotation]
    TermAnnotation: type[TermAnnotation]
    TextAnnotation: type[TextAnnotation]
    TiffData: type[TiffData]
    TimestampAnnotation: type[TimestampAnnotation]
    TransmittanceRange: type[TransmittanceRange]
    TypeAnnotation: type[TypeAnnotation]
    UUID: type[UUID]
    Union: type[Union]
    Well: type[Well]
    WellSample: type[WellSample]
    WellSampleRef: type[WellSampleRef]
    XMLAnnotation: type[XMLAnnotation]
    enums: ome.xml.model.enums.__module_protocol__
    primitives: ome.xml.model.primitives.__module_protocol__
